...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports", "vis-data/peer/umd/vis-data.js"], e)
    : e(
  ...
  var Xt = Lt.exports,
    ...
    fe = function (t) {
      return (
        se(ce, t) || (ce[t] = he && se(le, t) ? le[t] : ue("Symbol." + t)),
        ce[t]
      );
    },
    pe = B,
    ...
    me = function (t, e) {
      var i, o;
      if ("string" === e && At((i = t.toString)) && !Rt((o = Nt(i, t))))
        return o;
    ...
    ke = function (t, e) {
      ...
      if (o) {
        if (
          (void 0 === e && (e = "default"), (i = pe(o, t, e)), !ve(i) || ge(i))
        )
          return i;
  ...
  Bs(
    ...
    "String",
    function (t) {
      Ns(this, { type: zs, string: Ds(t), index: 0 });
    },
    function () {
      var t,
        e = As(this),
  ...
  var qa = function (t) {
      ...
      if (!u || (this === ja && Ba(u)))
        ...
        for (
          ...
          (c = r ? Ia(d, n, [h.value, f], !0) : h.value), Na(a, f, c);
      return (a.length = f), a;
    },
    Ua = function (t, e) {
      try {
  ...
  var md = it,
    ...
    jl = function (t, e) {
      var i = (Bl[t] = $d(El));
      return (
        wl(i, { type: ml, tag: t, description: e }),
        Ld || (i.description = e),
        i
      );
    },
    ...
    Wl = function (t) {
      ...
      return (
        ...
        (!(i || !Vd(this, e) || !Vd(Bl, e) || (Vd(this, yl) && this[yl][e])) ||
          i)
      );
    },
    Vl = function (t, e) {
  ...
  Hd ||
    ...
    Nd(
      { target: "Object", stat: !0, forced: !Hd },
  ...
  var ac = Oh,
    ...
    Nc = function (t, e, i) {
      var o = Cc(i, e - 1),
        n = Cc(i, e + 1);
      return (Oc(Dc, t) && !Oc(Ic, n)) || (Oc(Ic, t) && !Oc(Dc, o))
        ? "\\u" + Mc(Sc(t, 0), 16)
        : t;
    };
  Ec &&
  ...
  Mi(
    { target: "Array", proto: !0, forced: [].forEach !== Vf },
    { forEach: Vf }
  );
  ...
  var rv = zo("Array").filter,
    ...
    Dv =
      ...
      (Tv &&
        ...
        : Cv;
  Mi({ global: !0, forced: parseInt !== Dv }, { parseInt: Dv });
  var Iv = o(it.parseInt),
    Bv = Mi,
    Fv = Yi.indexOf,
    zv = Hf,
    Nv = E([].indexOf),
  ...
  var Gv = function (t, e, i) {
    ...
    $v = o(Gv),
    Zv = "function" == typeof Bun && Bun && "string" == typeof Bun.version,
    Qv = TypeError,
    Jv = r,
    tg = u,
    eg = T,
    ...
    dg = Mi,
    lg = r,
    cg = hg(lg.setInterval, !0);
  dg(
    { global: !0, bind: !0, forced: lg.setInterval !== cg },
    { setInterval: cg }
  );
  var ug = Mi,
    fg = r,
    pg = hg(fg.setTimeout, !0);
  ug(
    { global: !0, bind: !0, forced: fg.setTimeout !== pg },
    { setTimeout: pg }
  );
  var vg = o(it.setTimeout),
    gg = $t,
    yg = Ai,
    mg = Hi,
    bg = function (t) {
  ...
  Mi({ target: "Array", proto: !0 }, { fill: bg });
  var wg,
    kg = zo("Array").fill,
    _g = ht,
    xg = kg,
  ...
  function Ag(t, e) {
    for (
      var i, o, n = e[0].toUpperCase() + e.slice(1), r = 0;
      r < Ig.length;
  ...
  var Rg = Ag(Bg.style, "touchAction"),
    jg = void 0 !== Rg;
  var Lg = "compute",
    Hg = "auto",
    Wg = "manipulation",
    ...
    Xg = "ontouchstart" in Pg,
    Kg = void 0 !== Ag(Pg, "PointerEvent"),
    Gg =
  ...
  var vy = (function () {
    ...
    return (
      (e.set = function (t) {
        t === Lg && (t = this.compute()),
          jg &&
            ...
            Yg[t] &&
            (this.manager.element.style[Rg] = t),
      ...
      (e.compute = function () {
        var t = [];
        return (
          uy(this.manager.recognizers, function (e) {
  ...
  function yy(t) {
    var e = t.length;
    if (1 === e) return { x: Fg(t[0].clientX), y: Fg(t[0].clientY) };
    for (var i = 0, o = 0, n = 0; n < e; )
      (i += t[n].clientX), (o += t[n].clientY), n++;
    return { x: Fg(i / e), y: Fg(o / e) };
  }
  function my(t) {
  ...
  function xy(t, e) {
    var i = t.session,
      o = e.pointers,
      n = o.length;
    i.firstInput || (i.firstInput = my(e)),
      n > 1 && !i.firstMultiple
        ? (i.firstMultiple = my(e))
    ...
    (e.timeStamp = Ng()),
      ...
      (function (t, e) {
        var i = e.center,
          ...
          n = t.prevDelta || {},
          r = t.prevInput || {};
        (e.eventType !== Jg && r.eventType !== ty) ||
          ((n = t.prevDelta = { x: r.deltaX || 0, y: r.deltaY || 0 }),
          (o = t.offsetDelta = { x: i.x, y: i.y })),
          (e.deltaX = n.x + (i.x - o.x)),
          (e.deltaY = n.y + (i.y - o.y));
      })(i, e),
      (e.offsetDirection = ky(e.deltaX, e.deltaY));
    var d,
      l,
      c = _y(e.deltaTime, e.deltaX, e.deltaY);
    (e.overallVelocityX = c.x),
      (e.overallVelocityY = c.y),
      (e.overallVelocity = zg(c.x) > zg(c.y) ? c.x : c.y),
      (e.scale = s
        ? ((d = s.pointers), by((l = o)[0], l[1], cy) / by(d[0], d[1], cy))
        : 1),
      (e.rotation = s
        ? (function (t, e) {
    ...
    return (
      ...
      (e.init = function () {
        this.evEl && Cy(this.element, this.evEl, this.domHandler),
          ...
          this.evWin && Cy(Ty(this.element), this.evWin, this.domHandler);
      }),
      (e.destroy = function () {
        this.evEl && Sy(this.element, this.evEl, this.domHandler),
          this.evTarget && Sy(this.target, this.evTarget, this.domHandler),
          this.evWin && Sy(Ty(this.element), this.evWin, this.domHandler);
      }),
      t
    );
  })();
  ...
  var Dy = {
    ...
    Iy = { 2: $g, 3: "pen", 4: Zg, 5: "kinect" },
    By = "pointerdown",
    Fy = "pointermove pointerup pointercancel";
  Pg.MSPointerEvent &&
    !Pg.PointerEvent &&
    ((By = "MSPointerDown"),
    (Fy = "MSPointerMove MSPointerUp MSPointerCancel"));
  var zy = (function (t) {
    function e() {
      var i,
        o = e.prototype;
  ...
  var Ry = { touchstart: Jg, touchmove: 2, touchend: ty, touchcancel: ey },
    jy = (function (t) {
      function e() {
        var i;
        return (
  ...
  function Ly(t, e) {
    var i,
      ...
      n = Ny(t.touches),
      r = this.targetIds;
    if (e & (2 | Jg) && 1 === n.length)
      return (r[n[0].identifier] = !0), [n, n];
    var s = Ny(t.changedTouches),
      a = [],
      h = this.target;
    if (
    ...
    for (i = 0; i < s.length; )
      r[s[i].identifier] && a.push(s[i]),
        e & (ty | ey) && delete r[s[i].identifier],
        i++;
    return a.length ? [Ay(o.concat(a), "identifier", !0), a] : void 0;
  }
  var Hy = { mousedown: Jg, mousemove: 2, mouseup: ty },
    Wy = (function (t) {
      function e() {
        var i,
          o = e.prototype;
      ...
      return (
        ...
        (e.prototype.handler = function (t) {
          var e = Hy[t.type];
          e & Jg && 0 === t.button && (this.pressed = !0),
            2 & e && 1 !== t.which && (e = ty),
            this.pressed &&
              (e & ty && (this.pressed = !1),
              this.callback(this.manager, e, {
    ...
    return (function (t) {
      function e(e, i) {
        ...
        return (
          ...
          (o.touch = new jy(o.manager, o.handler)),
          (o.mouse = new Wy(o.manager, o.handler)),
          (o.primaryTouch = null),
          (o.lastTouches = []),
          o
        );
  ...
  var Jy = (function () {
      ...
      return (
        ...
        (e.recognizeWith = function (t) {
          ...
          return (
            e[(t = Zy(t, this)).id] || ((e[t.id] = t), t.recognizeWith(this)),
            this
          );
        }),
        (e.dropRecognizeWith = function (t) {
          return (
            Ky(t, "dropRecognizeWith", this) ||
              ((t = Zy(t, this)), delete this.simultaneous[t.id]),
            this
          );
        }),
        ...
        (e.recognize = function (t) {
          var e = Dg({}, t);
          if (!fy(this.options.enable, [this, e]))
    ...
    tm = (function (t) {
      ...
      return (
        ...
        (i.process = function (t) {
          ...
          if ((this.reset(), t.eventType & Jg && 0 === this.count))
            return this.failTimeout();
          if (n && r && o) {
            if (t.eventType !== ty) return this.failTimeout();
            var s = !this.pTime || t.timeStamp - this.pTime < i.interval,
              a = !this.pCenter || by(this.pCenter, t.center) < i.posThreshold;
            if (
    ...
    em = (function (t) {
      function e(e) {
        return (
          void 0 === e && (e = {}), t.call(this, Sg({ pointers: 1 }, e)) || this
        );
      }
      Tg(e, t);
      var i = e.prototype;
  ...
  var om = (function (t) {
      function e(e) {
        ...
        return (
          ...
          ((i =
            t.call(
              this,
              Sg({ event: "pan", threshold: 10, pointers: 1, direction: dy }, e)
            ) || this).pX = null),
          (i.pY = null),
          i
        );
    ...
    rm = (function (t) {
      function e(e) {
        return (
          void 0 === e && (e = {}),
          t.call(this, Sg({ event: "pinch", threshold: 0, pointers: 2 }, e)) ||
            this
        );
      }
      Tg(e, t);
    ...
    sm = (function (t) {
      function e(e) {
        return (
          void 0 === e && (e = {}),
          t.call(this, Sg({ event: "rotate", threshold: 0, pointers: 2 }, e)) ||
            this
        );
      }
      Tg(e, t);
      ...
      function e(e) {
        ...
        return (
          ...
          ((i =
            t.call(
              this,
              Sg({ event: "press", pointers: 1, time: 251, threshold: 9 }, e)
            ) || this)._timer = null),
          (i._input = null),
          i
        );
      ...
      return (
        ...
        (i.process = function (t) {
          var e = this,
            ...
            n = t.distance < i.threshold,
            r = t.deltaTime > i.time;
          if (((this._input = t), !n || !o || (t.eventType & (ty | ey) && !r)))
            this.reset();
    ...
    dm = [
      ...
      [rm, { enable: !1 }, ["rotate"]],
      [nm, { direction: ay }],
      [om, { direction: ay }, ["swipe"]],
      [tm],
      [tm, { event: "doubletap", taps: 2 }, ["tap"]],
      [am],
    ];
  function lm(t, e) {
    var i,
      o = t.element;
    o.style &&
      (uy(t.options.cssProps, function (n, r) {
        (i = Ag(o.style, r)),
          e
  ...
  var cm = (function () {
      function t(t, e) {
        ...
        (this.options = Dg({}, hm, e || {})),
          ...
          (this.input = new ((i = this).options.inputClass ||
            (Kg ? zy : Gg ? jy : Xg ? Xy : Wy))(i, Ey)),
          (this.touchAction = new vy(this, this.options.touchAction)),
          lm(this, !0),
          uy(
    ...
    um = { touchstart: Jg, touchmove: 2, touchend: ty, touchcancel: ey },
    fm = (function (t) {
      function e() {
        var i,
          o = e.prototype;
  ...
  function pm(t, e) {
    var i = Ny(t.touches),
      o = Ny(t.changedTouches);
    return e & (ty | ey) && (i = Ay(i.concat(o), "identifier", !0)), [i, o];
  }
  function vm(t, e, i) {
  ...
  var wm = (function () {
    var t = function (t, e) {
      return (
        void 0 === e && (e = {}), new cm(t, Sg({ recognizers: dm.concat() }, e))
      );
    };
    return (
      (t.VERSION = "2.0.17-rc"),
      ...
      (t.DIRECTION_DOWN = sy),
      (t.DIRECTION_LEFT = oy),
      (t.DIRECTION_RIGHT = ny),
      (t.DIRECTION_UP = ry),
      (t.DIRECTION_HORIZONTAL = ay),
      (t.DIRECTION_VERTICAL = hy),
      (t.DIRECTION_NONE = iy),
      (t.DIRECTION_DOWN = sy),
      (t.INPUT_START = Jg),
      (t.INPUT_MOVE = 2),
      ...
      (t.TouchInput = jy),
      (t.MouseInput = Wy),
      (t.PointerEventInput = zy),
      (t.TouchMouseInput = Xy),
      (t.SingleTouchInput = fm),
      (t.Recognizer = Jy),
      (t.AttrRecognizer = em),
      (t.Tap = tm),
      (t.Pan = om),
      ...
      (t.boolOrFn = fy),
      (t.hasParent = gy),
      (t.addEventListeners = Cy),
      (t.removeEventListeners = Sy),
      (t.defaults = Dg({}, hm, { preset: dm })),
      t
    );
  })();
  wm.defaults;
  ...
  $o(Cm.prototype),
    ...
    (Cm.prototype.destroy = function () {
      ...
      this.deactivate();
      var i,
        o = _m(hp((t = Pp((e = this._cleanupQueue)).call(e, 0))).call(t));
      try {
        for (o.s(); !(i = o.n()).done; ) {
          (0, i.value)();
        }
    ...
    (Cm.prototype.activate = function () {
      Cm.current && Cm.current.deactivate(),
        (Cm.current = this),
        (this.active = !0),
  ...
  var Sm = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    ...
    for (var n in i)
      if (Object.prototype.hasOwnProperty.call(i, n) && !Qp(t).call(t, n))
        if (i[n] && i[n].constructor === Object)
          void 0 === e[n] && (e[n] = {}),
            e[n].constructor === Object ? Rm(e[n], i[n]) : Fm(e, i, n, o);
        else if (Of(i[n])) {
          e[n] = [];
  ...
  function Wm(t) {
    ...
    switch (t.length) {
      ...
      case 7:
        return (e = Sm.exec(t))
          ? { r: Iv(e[1], 16), g: Iv(e[2], 16), b: Iv(e[3], 16) }
          : null;
      default:
        return null;
    }
        ...
        wu(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.opacityRange.onchange = function () {
                ...
                (this.applyButton.onclick = Wo((e = this._apply)).call(
                  e,
                  this
                )),
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.drag = {}),
                (this.pinch = {}),
                (this.hammer = new Om(this.colorPickerCanvas)),
                ...
                for (o = 0; o < 360; o++)
                  for (n = 0; n < this.r; n++)
                    (e = this.centerCoordinates.x + n * Math.sin(h * o)),
                      ...
                      (a = Xm(0.002777777777777778 * o, n * d, 1)),
                      (t.fillStyle =
                        "rgb(" + a.r + "," + a.g + "," + a.b + ")"),
  ...
  var nb,
            ...
            value: function () {
              ...
              if (void 0 !== this.popupDiv.html) {
                ...
                (this.popupDiv.html.style.left = e.left + "px"),
                  ...
                  (this.popupDiv.hideTimeout = vg(function () {
                    t.popupDiv.html.style.opacity = 0;
                  }, 1500)),
                  (this.popupDiv.deleteTimeout = vg(function () {
                    t._removePopup();
                  }, 1800));
              }
            },
          ...
          },
          {
            ...
            value: function () {
              ...
              this.optionsContainer.appendChild(
                ob("pre", "const options = " + $v(t, null, 2))
              );
            },
          },
          {
    ...
    ab = !1,
    hb = "background: #FFeeee; color: #dd0000",
    db = (function () {
      function t() {
        vh(this, t);
      }
              ...
              (n =
                void 0 !== r.indexMatch
                  ...
                  : ". Did you mean one of these: " +
                    t.print(zf(i)) +
                    t.printLocation(o, e)),
                console.error('%cUnknown option detected: "' + e + '"' + n, hb),
                (ab = !0);
            },
          },
          {
  ...
  var bb = { NULL: 0, DELIMITER: 1, IDENTIFIER: 2, UNKNOWN: 3 },
    wb = {
      "{": !0,
      "}": !0,
      "[": !0,
  ...
  function Db(t, e) {
    ...
    for (
      n || ((n = { id: e.id }), t.node && (n.attr = Mb(n.attr, t.node))),
        i = r.length - 1;
      i >= 0;
      i--
    ) {
  ...
  function Fb() {
    ...
    do {
      var t = !1;
      if ("#" === xb) {
        for (var e = _b - 1; " " === kb.charAt(e) || "\t" === kb.charAt(e); )
          e--;
      ...
      if (Tb(xb) || "-" === xb) {
        ...
        return (
          "false" === Eb
            ...
            : "true" === Eb
            ? (Eb = !0)
            : isNaN(Number(Eb)) || (Eb = Number(Eb)),
          void (Ob = bb.IDENTIFIER)
        );
      }
      if ('"' === xb) {
        for (Cb(); "" != xb && ('"' != xb || ('"' === xb && '"' === Sb())); )
  ...
  function Ab(t) {
    ...
    if (
      ...
      if (
        ...
        throw Lb("Angle bracket } expected");
      Fb(),
        delete e.node,
        delete e.edge,
        delete e.graph,
  ...
  function qb(t) {
    ...
    if (i.edges) {
      ...
      Qf((n = i.edges)).call(n, function (t) {
        ...
        ((a = i),
        (h = function (e, i) {
          var n = Bb(o, e.id, i.id, t.type, t.attr),
            s = r(n);
          o.edges.push(s);
        }),
        Of((s = e))
  ...
  var Xb = Object.freeze({ __proto__: null, parseGephi: Yb }),
    Kb = Object.freeze({
      __proto__: null,
      cn: {
  ...
  var Gb = (function () {
    ...
    nw =
      Jb(function () {
        ...
        ? function (t) {
            return (
              !!tw(t) && (!iw || "ArrayBuffer" !== ew(t)) && (!ow || ow(t))
            );
          }
        : ow,
    rw = !s(function () {
    ...
    mw = 0,
    bw = function (t) {
      cw(t, yw, { value: { objectID: "O" + mw++, weakData: {} } });
    },
    ww = (Zb.exports = {
      enable: function () {
  ...
  var kw = Zb.exports,
    ...
    ek = function (t, e, i) {
      ...
      if (
        ...
        var l = (o = e(function (e, i) {
            Jw(Uw(e, l), { type: t, collection: new a() }),
              Kw(i) || qw(i, e[s], { that: e, AS_ENTRIES: n });
          })).prototype,
          c = tk(t);
        Zw(
          [
    ...
    ok = function (t, e, i) {
      for (var o in e)
        i && i.unsafe && t[o] ? (t[o] = e[o]) : ik(t, o, e[o], i);
      return t;
    },
    nk = at,
    rk = vd,
      ...
      getConstructor: function (t, e, i, o) {
        var n = t(function (t, n) {
            uk(t, r),
              ...
              mk || (t.size = 0),
              fk(n) || pk(n, t[o], { that: t, AS_ENTRIES: i });
          }),
          r = n.prototype,
          s = kk(e),
          a = function (t, e, i) {
          ...
          lk(r, {
            ...
            forEach: function (t) {
              for (
                var e,
                  i = s(this),
                  o = ck(t, arguments.length > 1 ? arguments[1] : void 0);
                (e = e ? e.next : i.first);
  ...
  Mi({ target: "Number", stat: !0 }, { isFinite: Sk });
  var Tk = o(it.Number.isFinite),
    Mk = zd.some;
  Mi(
  ...
  var Pk = zo("Array").some,
    ...
    zk = o(Fk),
    Nk = o(it.Object.getOwnPropertySymbols),
    Ak = { exports: {} },
    Rk = Mi,
    jk = s,
    Lk = Q,
  ...
  Mi(
    { target: "Object", stat: !0, sham: !P },
    {
      getOwnPropertyDescriptors: function (t) {
        for (
          var e, i, o = Kk(t), n = Gk.f, r = Xk(o), s = {}, a = 0;
          r.length > a;

        )
          void 0 !== (i = n(o, (e = r[a++]))) && $k(s, e, i);
        return s;
      },
    }
  );
  var Zk = o(it.Object.getOwnPropertyDescriptors),
    Qk = { exports: {} },
    Jk = Mi,
    t_ = P,
    e_ = Kn.f;
  ...
  var a_ = r,
    ...
    g_ =
      ...
      (v_ &&
        ...
        : f_;
  Mi({ global: !0, forced: parseFloat !== g_ }, { parseFloat: g_ });
  var y_ = o(it.parseFloat),
    m_ = Mi,
    b_ = s,
    w_ = id.f;
  m_(
  ...
  var T_ = zo("Array").values,
    M_ = dn,
    P_ = Jt,
    D_ = ht,
    I_ = T_,
    B_ = Array.prototype,
    F_ = { DOMTokenList: !0, NodeList: !0 },
    z_ = function (t) {
      var e = t.values;
      return t === B_ || (D_(B_, t) && e === B_.values) || P_(F_, M_(t))
        ? I_
        : e;
    },
    N_ = o(z_),
          ...
          [
            {
              ...
              value: function (t) {
                if (
                  ...
                  C_(t.label) ? (this.labelDirty = !0) : (t.label = void 0),
            ...
            },
            {
              ...
              value: function (t, e) {
                this.setOptions(t, !0),
                  ...
                  Rm(this.fontOptions, this.constrain(e)),
                  (this.fontOptions.chooser = E_("label", e));
              },
            },
            {
              key: "adjustSizes",
    ...
    rx = ox || nx;
  Y_(
    { target: "Reflect", stat: !0, forced: rx, sham: rx },
    {
  ...
  var sx = o(it.Reflect.construct),
    ax = o(Uv);
  Mi({ target: "Object", stat: !0 }, { setPrototypeOf: cs });
  var hx = o(it.Object.setPrototypeOf),
    dx = o(Ho);
  function lx(t, e) {
    var i;
    return (
  ...
  function gx(t) {
    var e = (function () {
      ...
      try {
        return (
          Boolean.prototype.valueOf.call(sx(Boolean, [], function () {})), !0
        );
      } catch (t) {
        return !1;
      }
                ...
                t.fillText(this.options.icon.code, o, n)),
              {
                drawExternalLabel: function () {
                  if (void 0 !== d.options.label) {
                    ...
                    var e =
                      n + 0.5 * d.height + 0.5 * d.labelModule.size.height;
  ...
  function Sx(t) {
    for (var e = 1; e < arguments.length; e++) {
      ...
      e % 2
        ? Qf((i = Cx(Object(n), !0))).call(i, function (e) {
            s_(t, e, n[e]);
          })
        : Zk
        ? n_(t, Zk(n))
        : Qf((o = Cx(Object(n)))).call(o, function (e) {
            r_(t, e, Yk(n, e));
          });
    }
    return t;
        ...
        },
        {
          ...
          value: function (t, e, i, o, n, r) {
            ...
            if (
              ...
              void 0 !== r.opacity &&
                ((c = Vm(c, r.opacity)), (u = Vm(u, r.opacity))),
                (t.strokeStyle = c),
                (t.fillStyle = u),
                t.rect(
  ...
  function eE(t) {
    for (var e = 1; e < arguments.length; e++) {
      var i,
        ...
        n = null != arguments[e] ? arguments[e] : {};
      e % 2
        ? Qf((i = tE(Object(n), !0))).call(i, function (e) {
            s_(t, e, n[e]);
          })
        : Zk
        ? n_(t, Zk(n))
        : Qf((o = tE(Object(n)))).call(o, function (e) {
            r_(t, e, Yk(n, e));
          });
    }
    return t;
  ...
  var iE = (function () {
    function t(e, i, o, n, r, s) {
      vh(this, t),
        ...
        (this.selected = !1),
        (this.hover = !1),
        (this.labelModule = new W_(this.body, this.options, !1)),
        this.setOptions(e);
    }
    return (
      wu(
                ...
                t.checkMass(e, this.id),
                  void 0 !== e.x &&
                    (null === e.x
                      ...
                      : ((this.x = Iv(e.x)), (this.predefinedPosition = !0))),
                  void 0 !== e.y &&
                    (null === e.y
                      ? ((this.y = void 0), (this.predefinedPosition = !1))
                      : ((this.y = Iv(e.y)), (this.predefinedPosition = !0))),
                  void 0 !== e.size && (this.baseSize = e.size),
                  void 0 !== e.value && (e.value = y_(e.value)),
                  t.parseOptions(
                    this.options,
                    e,
                    !0,
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                (t.borderColor = Vm(t.borderColor, e)),
                  (t.color = Vm(t.color, e)),
                  (t.shadowColor = Vm(t.shadowColor, e));
              }
              return t;
            },
          },
            ...
            value: function (t) {
              ...
              return (
                this.labelModule.visible() &&
                  O_(this.labelModule.getSize(), t) &&
                  e.push({ nodeId: this.id, labelId: 0 }),
                O_(this.shape.boundingBox, t) && e.push({ nodeId: this.id }),
                e
              );
            },
          },
                ...
                ("boolean" == typeof i.fixed
                  ...
                  : (void 0 !== i.fixed.x &&
                    ...
                    void 0 !== i.fixed.y &&
                      ...
                      (e.fixed.y = i.fixed.y))),
                !0 === o && null === i.font && (e.font = Zm(n.font)),
                t.updateGroupOptions(e, i, r),
                void 0 !== i.scaling &&
                  Qm(e.scaling, i.scaling, "label", n.scaling);
            },
          },
          {
            key: "checkMass",
  ...
  var rE = (function () {
      function t(e, i, o, n) {
        ...
        if (
          ...
          (this.groups = o),
          (this.layoutEngine = n),
          (this.body.functions.createNode = Wo((r = this.create)).call(
            r,
            this
          )),
          (this.nodesListeners = {
        ...
        wu(t, [
          ...
          },
          {
            ...
            value: function (t) {
              if (void 0 !== t) {
                if (
                  (iE.parseOptions(this.options, t),
                  void 0 !== t.opacity &&
                    (Ok(t.opacity) ||
                    !Tk(t.opacity) ||
                    t.opacity < 0 ||
  ...
  var fE = o(it.Reflect.get),
    pE = o(Uk);
  function vE() {
    var t;
    "undefined" != typeof Reflect && fE
      ? (vE = dx((t = fE)).call(t))
      : (vE = function (t, e, i) {
          var o = (function (t, e) {
            for (
        ...
        wu(t, null, [
          {
            ...
            value: function (t, e) {
              var i = { x: -0.4, y: 0 };
              return _E.transform(i, e), Vo(t, i.x, i.y, 0.4 * e.length), !0;
            },
          },
        ]),
        t
  ...
  function AE(t) {
    for (var e = 1; e < arguments.length; e++) {
      var i,
        ...
        n = null != arguments[e] ? arguments[e] : {};
      e % 2
        ? Qf((i = NE(Object(n), !0))).call(i, function (e) {
            s_(t, e, n[e]);
          })
        : Zk
        ? n_(t, Zk(n))
        : Qf((o = NE(Object(n)))).call(o, function (e) {
            r_(t, e, Yk(n, e));
          });
    }
    return t;
          ...
          value: function (t, e) {
            if (!1 !== e.inheritsColor) {
              if ("both" === e.inheritsColor && this.from.id !== this.to.id) {
                ...
                return (
                  !1 === this.from.selected && !1 === this.to.selected
                    ? ((o = Vm(this.from.options.color.border, e.opacity)),
                      (n = Vm(this.to.options.color.border, e.opacity)))
              ...
              return "to" === e.inheritsColor
                ? Vm(this.to.options.color.border, e.opacity)
                : Vm(this.from.options.color.border, e.opacity);
            }
  ...
  function LE(t) {
    for (var e = 1; e < arguments.length; e++) {
      var i,
        ...
        n = null != arguments[e] ? arguments[e] : {};
      e % 2
        ? Qf((i = jE(Object(n), !0))).call(i, function (e) {
            s_(t, e, n[e]);
          })
        : Zk
        ? n_(t, Zk(n))
        : Qf((o = jE(Object(n)))).call(o, function (e) {
            r_(t, e, Yk(n, e));
          });
    }
    return t;
          ...
          value: function (t, e, i, o, n, r, s) {
            ...
            for (h = 1; h < 10; h++)
              (d = 0.1 * h),
                ...
                h > 0 &&
                  (u =
                    (a = this._getDistanceToLine(f, p, l, c, n, r)) < u
                      ? a
                      : u),
                (f = l),
                (p = c);
    ...
    JE = (function () {
      function t(e, i, o, n, r) {
        ...
        (this.options = Zm(n)),
          ...
          (this.connected = !1),
          (this.labelModule = new W_(this.body, this.options, !0)),
          this.setOptions(e);
      }
      return (
        wu(
                ...
                return (
                  void 0 !== this.edgeType &&
                    (((this.edgeType instanceof qE &&
                      !0 === t.enabled &&
                      "dynamic" === t.type) ||
                      (this.edgeType instanceof $E &&
                        !0 === t.enabled &&
                        "cubicBezier" === t.type) ||
                      (this.edgeType instanceof YE &&
                        !0 === t.enabled &&
                        "dynamic" !== t.type &&
                        "cubicBezier" !== t.type) ||
                      (this.edgeType instanceof QE && !1 === t.type.enabled)) &&
                      (i = !1),
                    !0 === i && (e = this.cleanup())),
                  !0 === i
                    ? !0 === t.enabled
                ...
                if (!e.hidden) {
                  ...
                  (this.edgeType.fromPoint = this.edgeType.from),
                    ...
                    e.middleArrow &&
                      ...
                      e.middleArrowSrc &&
                        (o.middle.image = this.imagelist.load(
                          e.middleArrowSrc
                        )),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (this.labelModule.visible()) {
                  ...
                  O_(this.labelModule.getSize(), t, i) &&
          ...
          [
            {
              ...
              value: function (t, e) {
                ...
                if (
                  ...
                  void 0 !== e.scaling && null !== e.scaling
                    ? (void 0 !== e.scaling.min &&
                      ...
                      Qm(t.scaling, e.scaling, "label", o.scaling))
                    : !0 === i &&
                      null === e.scaling &&
                  ...
                  if ("string" == typeof e.arrows) {
                    ...
                    Qm(t.arrows, e.arrows, "to", o.arrows),
                      Qm(t.arrows, e.arrows, "middle", o.arrows),
                      Qm(t.arrows, e.arrows, "from", o.arrows);
                  }
                ...
                !0 === i && null === e.font && (t.font = Zm(o.font)),
                  Object.prototype.hasOwnProperty.call(
                    e,
                    "selfReferenceSize"
                  ) &&
    ...
    tO = (function () {
      function t(e, i, o) {
        ...
        vh(this, t),
          ...
          (this.images = i),
          (this.groups = o),
          (this.body.functions.createEdge = Wo((n = this.create)).call(
            n,
            this
          )),
          (this.edgesListeners = {
          ...
          Rm(this.options, this.defaultOptions),
    ...
    eO = (function () {
      function t(e, i, o) {
        vh(this, t),
          ...
          this.barnesHutTree,
          this.setOptions(o),
          (this._rng = Em("BARNES HUT SOLVER"));
      }
      return (
        wu(t, [
          {
            ...
            value: function (t) {
              if (void 0 !== t)
                if (!1 === t)
                  ...
                  (this.physicsEnabled = !0),
                    Am(["stabilization"], this.options, t),
                    Qm(this.options, t, "stabilization"),
                  ...
                  e &&
                    (("number" != typeof e.x || Ok(e.x)) && (e.x = 0),
                    ("number" != typeof e.y || Ok(e.y)) && (e.y = 0)),
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                ...
                this.physicsTick(), n++;
              (i(), e())
                ? vg(Wo((o = this._stabilizationBatch)).call(o, this), 0)
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                (t.fillStyle = h),
                  zE.draw(t, { type: "arrow", point: d, angle: l, length: a }),
                  Cg(t).call(t);
              }
            },
          },
        ...
        wu(i, [
          {
            ...
            value: function (t) {
              ...
              delete this.containedNodes[t],
                ...
                (i.containedNodes = {}),
                Hm(i.containedEdges, function (t, i) {
                ...
                Hm(i.edges, function (t) {
                  Hm(e.edges, function (i) {
                    ...
                    -1 !== r &&
                      (Hm(t.clusteringEdgeReplacingIds, function (t) {
        ...
        wu(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var n = this.body.nodes[t];
              void 0 ===
                (e = this._checkOptions(e, n)).clusterNodeProperties.x &&
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var m = [], b = 0; b < o.edges.length; b++)
                m.push(o.edges[b]);
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (
                var i = this.getClusteredEdges(t), o = 0;
                o < i.length;
                o++
              ) {
      ...
      wu(t, [
        ...
        },
        {
          ...
          value: function (t) {
            var e = this;
            if (void 0 !== t) {
              Nm(["width", "height", "autoResize"], this.options, t);
            }
        ...
        },
        {
          ...
          value: function () {
            var t, e, i;
            Qf(
              (t = hp((e = Pp((i = this._cleanupCallbacks)).call(i, 0))).call(
                e
              ))
            ).call(t, function (t) {
              try {
        ...
        },
        {
          ...
          value: function () {
            ...
            void 0 !== this.hammer && this.hammer.destroy(),
              (this.drag = {}),
              (this.pinch = {}),
              (this.hammer = new ub(this.frame.canvas)),
              this.hammer.get("pinch").set({ enable: !0 }),
              this.hammer
                .get("pan")
                .set({ threshold: 5, direction: ub.DIRECTION_ALL }),
              ...
              (this.hammerFrame = new ub(this.frame)),
              OO(this.hammerFrame, function (e) {
      ...
      wu(t, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (0 === n || 0 === r)
              (o = 1), (i = mO.getRange(this.body.nodes, t.nodes));
            else if (!0 === e) {
              var s = 0;
              ...
              (i = mO.getRange(this.body.nodes, t.nodes)),
                (o =
        ...
        },
        {
          ...
          value: function (t) {
            if (void 0 !== t) {
              if (null != t.offset) {
                if (null != t.offset.x) {
                  if (((t.offset.x = +t.offset.x), !Tk(t.offset.x)))
                    throw new TypeError(
                      'The option "offset.x" has to be a finite number.'
                    );
                } else t.offset.x = 0;
                if (null != t.offset.y) {
                  if (((t.offset.y = +t.offset.y), !Tk(t.offset.y)))
                    throw new TypeError(
              ...
              if (null != t.position) {
                if (null != t.position.x) {
                  if (((t.position.x = +t.position.x), !Tk(t.position.x)))
                    throw new TypeError(
                      'The option "position.x" has to be a finite number.'
                    );
                } else t.position.x = 0;
                if (null != t.position.y) {
                  if (((t.position.y = +t.position.y), !Tk(t.position.y)))
                    throw new TypeError(
          ...
          value: function () {
            ...
            if (
              ...
              if (
                ...
                (this.viewFunction = Wo((i = this._lockedRedraw)).call(
                  i,
                  this
                )),
                  this.body.emitter.on("initRedraw", this.viewFunction);
            ...
            for (var o = 0; o < e.length; o++) {
              (this.navigationDOM[e[o]] = document.createElement("div")),
                ...
                this.navigationDOM.wrapper.appendChild(
                  this.navigationDOM[e[o]]
                );
              var n,
                r,
                s = new ub(this.navigationDOM[e[o]]);
  ...
  var IO = (function () {
    function t(e, i, o) {
      ...
      vh(this, t),
        ...
        (this.navigationHandler = new MO(e, i)),
        (this.body.eventListeners.onTap = Wo((n = this.onTap)).call(n, this)),
        (this.body.eventListeners.onTouch = Wo((r = this.onTouch)).call(
          r,
          this
        )),
        ...
        (this.body.eventListeners.onMouseWheel = Wo(
          (c = this.onMouseWheel)
        ).call(c, this)),
        (this.body.eventListeners.onPinch = Wo((u = this.onPinch)).call(
          u,
          this
        )),
          ...
          value: function (t) {
            if (void 0 !== t) {
              Am(
                ...
                Qm(this.options, t, "keyboard"),
                t.tooltip &&
                  (wo(this.options.tooltip, t.tooltip),
                  t.tooltip.color &&
                    (this.options.tooltip.color = Um(t.tooltip.color)));
            }
          ...
          value: function (t) {
            if (!this.drag.dragging) {
              ...
              if (
                ...
                var o,
                  n = PO(this.selectionHandler.getSelectedNodes());
                try {
                  for (n.s(); !(o = n.n()).done; ) {
                    var r = o.value,
                      s = {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            void 0 !== this.popupObj
              ? this.popupObj.id !== n &&
                (void 0 === this.popup &&
                  (this.popup = new fb(this.canvas.frame)),
  ...
  var QO,
    JO = {
      getConstructor: function (t, e, i, o) {
        var n = t(function (t, n) {
            AO(t, r),
              VO(t, { type: e, id: KO++, frozen: void 0 }),
              jO(n) || HO(n, t[o], { that: t, AS_ENTRIES: i });
          }),
          r = n.prototype,
          s = qO(e),
          a = function (t, e, i) {
    ...
    mC = {},
    bC = {},
    wC = !eC.ActiveXObject && "ActiveXObject" in eC,
    kC = function (t) {
      return function () {
        return t(this, arguments.length ? arguments[0] : void 0);
      };
      ...
      oC(xC, {
        delete: function (t) {
          if (aC(t) && !fC(t)) {
            var e = hC(this);
            return (
              e.frozen || (e.frozen = new QO()),
              OC(this, t) || e.frozen.delete(t)
            );
          }
          return OC(this, t);
        },
        has: function (t) {
          if (aC(t) && !fC(t)) {
            var e = hC(this);
            return (
              e.frozen || (e.frozen = new QO()), CC(this, t) || e.frozen.has(t)
            );
          }
          return CC(this, t);
        },
        get: function (t) {
          if (aC(t) && !fC(t)) {
            ...
            return (
              e.frozen || (e.frozen = new QO()),
              CC(this, t) ? SC(this, t) : e.frozen.get(t)
            );
          }
          return SC(this, t);
        },
        set: function (t, e) {
          if (aC(t) && !fC(t)) {
            var i = hC(this);
            i.frozen || (i.frozen = new QO()),
              CC(this, t) ? EC(this, t, e) : i.frozen.set(t, e);
          } else EC(this, t, e);
          return this;
        },
      });
      ...
      wu(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            zC(this, TC, FC(this, MC, "f"), "f"),
              zC(this, MC, new BO(FC(this, TC, "f")), "f");
            var e,
              i = NC(t.added);
            try {
              for (i.s(); !(e = i.n()).done; ) {
  ...
  var VC = (function () {
      function t(e, i) {
        ...
        vh(this, t),
          (this.body = e),
          (this.canvas = i),
          (this._selectionAccumulator = new LC()),
      ...
      return (
        wu(t, [
              ...
              return (
                !1 === i.hover &&
                  ...
                  i instanceof iE
                    ...
                    : ((o.edge = i.id),
                      this.body.emitter.emit("hoverEdge", o))),
                n
              );
            },
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var r in this.hoverObj.edges)
                Object.prototype.hasOwnProperty.call(this.hoverObj.edges, r) &&
                  (!0 === o
                    ...
                    : (void 0 === i ||
                        (i instanceof JE && i.id != r) ||
                        (i instanceof iE && !i.hover)) &&
              ...
              if (void 0 !== i) {
                ...
                (o ||
                  (i instanceof JE && 0 === s && 0 === a) ||
                  (i instanceof iE && 0 === s && 0 === a)) &&
          ...
          },
          {
            ...
            value: function () {
              var t;
              return If((t = this._selectionAccumulator.getNodes())).call(
                t,
                function (t) {
                  return t.id;
                }
          ...
          },
          {
            ...
            value: function () {
              var t;
              return If((t = this._selectionAccumulator.getEdges())).call(
                t,
                function (t) {
                  return t.id;
                }
    ...
    GC = YC,
    $C = dt.match(/firefox\/(\d+)/i),
    ZC = !!$C && +$C[1],
    QC = /MSIE|Trident/.test(dt),
    JC = dt.match(/AppleWebKit\/(\d+)\./),
    tS = !!JC && +JC[1],
    eS = Mi,
    iS = y,
    oS = It,
    ...
    kS = !hS(function () {
      ...
      if (!(cS && cS > 3)) {
        ...
        for (t = 65; t < 76; t++) {
          ...
          for (o = 0; o < 47; o++) vS.push({ k: e + o, v: i });
        }
        for (
          vS.sort(function (t, e) {
            return e.v - t.v;
          }),
            o = 0;
          o < vS.length;
          ...
          (e = vS[o].k.charAt(0)), n.charAt(n.length - 1) !== e && (n += e);
        return "DGBEFHACIJK" !== n;
      }
    });
  eS(
    { target: "Array", proto: !0, forced: mS || !bS || !wS || !kS },
    {
      sort: function (t) {
        void 0 !== t && oS(t);
        var e = nS(this);
  ...
  var _S = zo("Array").sort,
    ...
    FS = { left: BS(!1), right: BS(!0) },
    zS = "process" === k(r.process),
    NS = FS.left;
  Mi(
    {
      target: "Array",
      ...
      return (
        wu(t, [
            ...
            value: function (t, e) {
              if (void 0 !== t) {
                ...
                if (
                  ...
                  Qm(this.options, t, "hierarchical"),
                ...
                if (!0 === o)
                  return (
                    this.body.emitter.emit("refresh"), Rm(e, this.optionsBackup)
                  );
              }
              return e;
            },
          },
          {
            ...
            value: function (t) {
              (this.initialRandomSeed = t),
                (this._rng = Em(this.initialRandomSeed));
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              for (
                var t = mO.getRangeCore(this.body.nodes, this.body.nodeIndices),
                  e = mO.findCenter(t),
                  i = 0;
          ...
          },
          {
            ...
            value: function (t) {
              var e = this,
                i = [];
              return (
                Hm(t.edges, function (t) {
                  var o;
                  -1 !== Vv((o = e.body.edgeIndices)).call(o, t.id) &&
                    i.push(t);
                }),
                i
              );
          ...
          },
          {
            ...
            value: function () {
              ...
              this._crawlNetwork(function (e, i, o) {
                ...
                var r =
                  (mO.cloneOptions(e, "node"),
                  mO.cloneOptions(i, "node"),
                  void mO.cloneOptions(o, "edge"));
          ...
          },
          {
            ...
            value: function () {
              var t,
                e = this,
                i = WS((t = this.body.nodeIndices)).call(
                  t,
                  function (t, i) {
  ...
  var hT = (function () {
        ...
        wu(t, [
              ...
              void 0 !== e &&
                ...
                void 0 !== t &&
                  ("boolean" == typeof t
                    ...
                    : ((this.options.enabled = !0), Rm(this.options, t)),
          ...
          },
          {
            ...
            value: function () {
              var t,
                e,
                i = sT(Pp((t = this._domEventListenerCleanupQueue)).call(t, 0));
              try {
                for (i.s(); !(e = i.n()).done; ) {
                  (0, e.value)();
                }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.manipulationDiv.appendChild(i),
                this._bindElementEvents(
                  i,
                  Wo((e = this.editNode)).call(e, this)
                );
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (void 0 !== this.selectedControlNode) {
                ...
                if (void 0 !== r && void 0 !== this.selectedControlNode)
                  ...
                  o.updateEdgeType(), this.body.emitter.emit("restorePhysics");
                this.body.emitter.emit("_redraw");
              }
            },
          },
    ...
    vT = {
      borderWidth: { number: cT },
      borderWidthSelected: { number: cT, undefined: "undefined" },
      brokenImage: { string: dT, undefined: "undefined" },
      chosen: {
        label: { boolean: lT, function: "function" },
        node: { boolean: lT, function: "function" },
        __type__: { object: fT, boolean: lT },
      },
      color: {
        border: { string: dT },
      ...
      opacity: { number: cT, undefined: "undefined" },
      fixed: {
        x: { boolean: lT },
        y: { boolean: lT },
        __type__: { object: fT, boolean: lT },
      ...
      font: {
        ...
        face: { string: dT },
        background: { string: dT },
        strokeWidth: { number: cT },
        strokeColor: { string: dT },
        vadjust: { number: cT },
        multi: { boolean: lT, string: dT },
        bold: {
          color: { string: dT },
          size: { number: cT },
          face: { string: dT },
      ...
      group: { string: dT, number: cT, undefined: "undefined" },
      heightConstraint: {
        minimum: { number: cT },
        valign: { string: dT },
        __type__: { object: fT, boolean: lT, number: cT },
      },
      hidden: { boolean: lT },
      icon: {
        face: { string: dT },
        ...
        size: { number: cT },
        color: { string: dT },
        weight: { string: dT, number: cT },
        __type__: { object: fT },
      },
      id: { string: dT, number: cT },
      image: {
      ...
      imagePadding: {
        ...
        bottom: { number: cT },
        left: { number: cT },
        __type__: { object: fT, number: cT },
      },
      label: { string: dT, undefined: "undefined" },
      labelHighlightBold: { boolean: lT },
      level: { number: cT, undefined: "undefined" },
      margin: {
        top: { number: cT },
        right: { number: cT },
        bottom: { number: cT },
      ...
      scaling: {
        ...
        label: {
          ...
          min: { number: cT },
          max: { number: cT },
          maxVisible: { number: cT },
          drawThreshold: { number: cT },
          __type__: { object: fT, boolean: lT },
        },
      ...
      shapeProperties: {
        borderDashes: { boolean: lT, array: uT },
        borderRadius: { number: cT },
        interpolation: { boolean: lT },
        useImageSize: { boolean: lT },
        useBorderWithImage: { boolean: lT },
        coordinateOrigin: { string: ["center", "top-left"] },
        __type__: { object: fT },
      },
      size: { number: cT },
      title: { string: dT, dom: "dom", undefined: "undefined" },
      value: { number: cT, undefined: "undefined" },
      widthConstraint: {
        minimum: { number: cT },
        maximum: { number: cT },
        __type__: { object: fT, boolean: lT, number: cT },
    ...
    gT = {
      configure: {
        enabled: { boolean: lT },
        filter: { boolean: lT, string: dT, array: uT, function: "function" },
        container: { dom: "dom" },
        showButton: { boolean: lT },
        __type__: {
          object: fT,
          boolean: lT,
          string: dT,
      ...
      edges: {
        arrows: {
          to: {
            enabled: { boolean: lT },
            scaleFactor: { number: cT },
            type: { string: pT },
            imageHeight: { number: cT },
            imageWidth: { number: cT },
            src: { string: dT },
            __type__: { object: fT, boolean: lT },
          },
          middle: {
          ...
          __type__: { string: ["from", "to", "middle"], object: fT },
        },
        endPointOffset: {
          from: { number: cT },
          to: { number: cT },
        ...
        arrowStrikethrough: { boolean: lT },
        background: {
          enabled: { boolean: lT },
          color: { string: dT },
          size: { number: cT },
          dashes: { boolean: lT, array: uT },
          __type__: { object: fT, boolean: lT },
        },
        chosen: {
          label: { boolean: lT, function: "function" },
          edge: { boolean: lT, function: "function" },
          __type__: { object: fT, boolean: lT },
        },
        color: {
          color: { string: dT },
          highlight: { string: dT },
          hover: { string: dT },
          inherit: { string: ["from", "to", "both"], boolean: lT },
          opacity: { number: cT },
          __type__: { object: fT, string: dT },
        },
        dashes: { boolean: lT, array: uT },
        ...
        hidden: { boolean: lT },
        hoverWidth: { function: "function", number: cT },
        label: { string: dT, undefined: "undefined" },
        labelHighlightBold: { boolean: lT },
        length: { number: cT, undefined: "undefined" },
        physics: { boolean: lT },
        scaling: {
          min: { number: cT },
          max: { number: cT },
        ...
        selectionWidth: { function: "function", number: cT },
        selfReferenceSize: { number: cT },
        selfReference: {
          size: { number: cT },
          angle: { number: cT },
          renderBehindTheNode: { boolean: lT },
          __type__: { object: fT },
        },
        shadow: {
          enabled: { boolean: lT },
      ...
      groups: {
        useDefaultGroups: { boolean: lT },
        __any__: vT,
        __type__: { object: fT },
      },
      interaction: {
        dragNodes: { boolean: lT },
        dragView: { boolean: lT },
        hideEdgesOnDrag: { boolean: lT },
        hideEdgesOnZoom: { boolean: lT },
        hideNodesOnDrag: { boolean: lT },
        hover: { boolean: lT },
        keyboard: {
          enabled: { boolean: lT },
          speed: {
          ...
          bindToWindow: { boolean: lT },
          autoFocus: { boolean: lT },
          __type__: { object: fT, boolean: lT },
        },
        multiselect: { boolean: lT },
        navigationButtons: { boolean: lT },
        selectable: { boolean: lT },
        selectConnectedEdges: { boolean: lT },
        hoverConnectedEdges: { boolean: lT },
        tooltipDelay: { number: cT },
        zoomView: { boolean: lT },
        zoomSpeed: { number: cT },
        __type__: { object: fT },
      },
      layout: {
        randomSeed: { undefined: "undefined", number: cT, string: dT },
        improvedLayout: { boolean: lT },
        clusterThreshold: { number: cT },
        hierarchical: {
          enabled: { boolean: lT },
          levelSeparation: { number: cT },
          nodeSpacing: { number: cT },
          treeSpacing: { number: cT },
          blockShifting: { boolean: lT },
          edgeMinimization: { boolean: lT },
          parentCentralization: { boolean: lT },
      ...
      manipulation: {
        enabled: { boolean: lT },
        initiallyActive: { boolean: lT },
        addNode: { boolean: lT, function: "function" },
        addEdge: { boolean: lT, function: "function" },
        editNode: { function: "function" },
        editEdge: {
          editWithoutDrag: { function: "function" },
          __type__: { object: fT, boolean: lT, function: "function" },
        },
        deleteNode: { boolean: lT, function: "function" },
        deleteEdge: { boolean: lT, function: "function" },
        controlNodeStyle: vT,
        __type__: { object: fT, boolean: lT },
      },
      nodes: vT,
      physics: {
        ...
        barnesHut: {
          theta: { number: cT },
          gravitationalConstant: { number: cT },
          centralGravity: { number: cT },
          springLength: { number: cT },
          springConstant: { number: cT },
          damping: { number: cT },
          avoidOverlap: { number: cT },
          __type__: { object: fT },
        },
        forceAtlas2Based: {
          theta: { number: cT },
        ...
        maxVelocity: { number: cT },
        minVelocity: { number: cT },
        solver: {
          string: [
            "barnesHut",
            "repulsion",
        ...
        stabilization: {
          enabled: { boolean: lT },
          iterations: { number: cT },
          updateInterval: { number: cT },
          onlyDynamicEdges: { boolean: lT },
          fit: { boolean: lT },
          __type__: { object: fT, boolean: lT },
        },
        timestep: { number: cT },
        adaptiveTimestep: { boolean: lT },
        wind: {
          x: { number: cT },
          y: { number: cT },
          __type__: { object: fT },
      ...
      autoResize: { boolean: lT },
      clickToUse: { boolean: lT },
      locale: { string: dT },
      locales: { __any__: { any: "any" }, __type__: { object: fT } },
      height: { string: dT },
      width: { string: dT },
      __type__: { object: fT },
    },
    ...
    mT = function (t, e, i) {
      ...
      return !(
        !Qp(t).call(t, "physics") ||
        !Qp((o = yT.physics.solver)).call(o, e) ||
        i.physics.solver === e ||
        "wind" === e
      );
    },
              ...
              for (
                ...
                if (f !== t) {
                  var p = n[f].x,
                    ...
                    m =
                      1 /
                      Math.pow(Math.pow(h - p, 2) + Math.pow(d - v, 2), 1.5);
  ...
  function _T(t, e, i) {
    ...
    (this.options = {}),
      (this.defaultOptions = { locale: "en", locales: Kb, clickToUse: !1 }),
      wo(this.options, this.defaultOptions),
      (this.body = {
        container: t,
        nodes: {},
      ...
      this.bindEventListeners(),
      (this.images = new $b(function () {
        return a.body.emitter.emit("_requestRedraw");
      })),
      (this.groups = new Ek()),
      (this.canvas = new CO(this.body)),
      (this.selectionHandler = new VC(this.body, this.canvas)),
      (this.interactionHandler = new IO(
        this.body,
        this.canvas,
        this.selectionHandler
      )),
      (this.view = new SO(this.body, this.canvas)),
      (this.renderer = new _O(this.body, this.canvas)),
      (this.physics = new cO(this.body)),
      (this.layoutEngine = new rT(this.body)),
      (this.clustering = new kO(this.body)),
      (this.manipulation = new hT(
        this.body,
        this.canvas,
        this.selectionHandler,
        this.interactionHandler
      )),
      (this.nodesHandler = new rE(
        this.body,
        this.images,
        this.groups,
        this.layoutEngine
      )),
      (this.edgesHandler = new tO(this.body, this.images, this.groups)),
      (this.body.modules.kamadaKawai = new kT(this.body, 150, 0.05)),
  ...
  $o(_T.prototype),
    (_T.prototype.setOptions = function (t) {
      var e = this;
      if ((null === t && (t = void 0), void 0 !== t)) {
        ...
        if (
          (Nm(["locale", "locales", "clickToUse"], this.options, t),
          void 0 !== t.locale &&
          ...
          Rm(i.nodes, this.nodesHandler.options),
            Rm(i.edges, this.edgesHandler.options),
            Rm(i.layout, this.layoutEngine.options),
            Rm(i.interaction, this.selectionHandler.options),
            Rm(i.interaction, this.renderer.options),
            Rm(i.interaction, this.interactionHandler.options),
            Rm(i.manipulation, this.manipulation.options),
            Rm(i.physics, this.physics.options),
            Rm(i.global, this.canvas.options),
            Rm(i.global, this.options),
            this.configurator.setModuleOptions(i);
        }
        void 0 !== t.clickToUse
          ? !0 === t.clickToUse
            ? void 0 === this.activator &&
              ((this.activator = new lb(this.canvas.frame)),
  ...
  (t.Network = _T),
    (t.NetworkImages = $b),
    (t.networkDOTParser = Ub),
    (t.networkGephiParser = Xb),
    (t.networkOptions = bT),
    (t.parseDOTNetwork = xT),
    (t.parseGephiNetwork = Yb);
});
