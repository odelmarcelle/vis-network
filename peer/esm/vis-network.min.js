...
import {
  isDataViewLike as t,
  DataSet as e,
} from "vis-data/peer/esm/vis-data.js";
var i =
...
var n = function (t) {
  ...
  C = { all: O, IS_HTMLDDA: void 0 === O && void 0 !== O },
  S = C.all,
  T = C.IS_HTMLDDA
    ? function (t) {
...
var R,
  ...
  ut = lt.process,
  ft = lt.Deno,
  pt = (ut && ut.versions) || (ft && ft.version),
  vt = pt && pt.v8;
vt && (j = (R = vt.split("."))[0] > 0 && R[0] < 4 ? 1 : +(R[0] + R[1])),
  !j &&
    ct &&
    (!(R = ct.match(/Edge\/(\d+)/)) || R[1] >= 74) &&
    (R = ct.match(/Chrome\/(\d+)/)) &&
    (j = +R[1]);
var gt = j,
  yt = gt,
  ...
  Dt = function (t) {
    if (Mt(t)) return t;
    throw new It(Pt(t) + " is not a function");
  },
  Bt = Dt,
  Ft = Y,
  zt = function (t, e) {
...
var Xt = Lt.exports,
  ...
  fe = function (t) {
    return (
      se(ce, t) || (ce[t] = he && se(le, t) ? le[t] : ue("Symbol." + t)), ce[t]
    );
  },
  pe = B,
  ve = et,
  ...
  ke = function (t, e) {
    ...
    var i,
      o = ye(t, we);
    if (o) {
      if ((void 0 === e && (e = "default"), (i = pe(o, t, e)), !ve(i) || ge(i)))
        return i;
...
M.f = Pe
  ...
  : function (t, e) {
      ...
      if (Ne(t, e)) return Be(!Ie(De.f, t, e), t[e]);
    };
var je = s,
  Le = T,
  He = /#|\.prototype\./,
...
var vi = Qe,
  ...
  Mi = function (t, e) {
    var i,
      ...
      f = t.stat,
      p = t.proto,
      v = u ? mi : f ? mi[c] : (mi[c] || {}).prototype,
      g = u ? Ei : Ei[c] || Ci(Ei, c, {})[c],
      y = g.prototype;
    for (r in e)
      (o =
        !(i = xi(u ? r : c + (f ? "." : "#") + r, t.forced)) && v && Si(v, r)),
        (a = g[r]),
        o && (h = t.dontCallGetSet ? (l = _i(v, r)) && l.value : v[r]),
        (s = o && h ? h : e[r]),
        (o && typeof a == typeof s) ||
          ((d =
            t.bind && o
              ...
              ? wi(s)
              : s),
          (t.sham || (s && s.sham) || (a && a.sham)) && Ci(d, "sham", !0),
          Ci(g, r, d),
          p &&
            (Si(Ei, (n = c + "Prototype")) || Ci(Ei, n, {}),
            Ci(Ei[n], r, s),
            t.real && y && (i || !y[r]) && Ci(y, r, s)));
  },
  Pi = Math.ceil,
  Ii = Math.floor,
  Di =
...
var ro = P,
  ...
  mo =
    ...
    ho(function () {
      ...
      ? function (t, e) {
          for (
            var i = fo(t), o = arguments.length, n = 1, r = co.f, s = uo.f;
            o > n;
            ...
            for (
              var a,
                h = po(arguments[n++]),
                d = r ? yo(lo(h), r(h)) : lo(h),
                l = d.length,
                c = 0;
              l > c;

            )
              (a = d[c++]), (ro && !ao(s, h, a)) || (i[a] = h[a]);
          return i;
        }
      : vo,
  bo = mo;
Mi(
  { target: "Object", stat: !0, arity: 2, forced: Object.assign !== bo },
  { assign: bo }
);
var wo = o(it.Object.assign),
  ...
  Bo = Do;
Mi(
  { target: "Function", proto: !0, forced: Function.bind !== Bo },
  { bind: Bo }
);
var Fo = it,
  zo = function (t) {
...
var Ko = {
  ...
  hexagon: function (t, e, i, o) {
    ...
    t.moveTo(e + o, i);
    for (var r = 1; r < 6; r++)
      t.lineTo(e + o * Math.cos(n * r), i + o * Math.sin(n * r));
    t.closePath();
  },
  roundRect: qo,
  ...
  star: function (t, e, i, o) {
    ...
    for (var n = 0; n < 10; n++) {
      ...
      t.lineTo(
        e + r * Math.sin((2 * n * Math.PI) / 10),
        i - r * Math.cos((2 * n * Math.PI) / 10)
      );
    }
    t.closePath();
  },
...
var Qo,
  ...
  kn = { codeAt: wn(!1), charAt: wn(!0) },
  _n = T,
  xn = r.WeakMap,
  En = _n(xn) && /native code/.test(String(xn)),
  On = ne,
  Cn = Xt("keys"),
  Sn = function (t) {
...
if (Tn || Bn.state) {
  ...
  (zn[Ln] = !0),
    (Qo = function (t, e) {
      if (Dn(t, Ln)) throw new An(Nn);
      return (e.facade = t), In(t, Ln, e), e;
    }),
    (Jo = function (t) {
      return Dn(t, Ln) ? t[Ln] : {};
    }),
...
var Hn = {
    ...
    getterFor: function (t) {
      return function (e) {
        var i;
        if (!Pn(e) || (i = Jo(e)).type !== t)
          throw new An("Incompatible receiver, " + t + " required");
        return i;
      };
    },
  },
  ...
  Un = Wn && Object.getOwnPropertyDescriptor,
  Yn = Vn(qn, "name"),
  Xn = {
    EXISTS: Yn,
...
Kn.f =
  Gn && !$n
    ...
    : function (t, e) {
        Qn(t);
        for (var i, o = Jn(e), n = tr(e), r = n.length, s = 0; r > s; )
          Zn.f(t, (i = n[s++]), o[i]);
        return t;
      };
var er,
  ir = at("document", "documentElement"),
  or = oi,
  nr = Kn,
  rr = to,
  sr = Xi,
...
var gr,
  ...
  br =
    ...
    function (t, e) {
      ...
      return (
        null !== t
          ? ((ur[dr] = or(t)), (i = new ur()), (ur[dr] = null), (i[cr] = t))
          : (i = vr()),
        void 0 === e ? i : nr.f(i, e)
      );
    },
...
[].keys &&
  ("next" in (mr = [].keys())
    ? (yr = zr(zr(mr))) !== Object.prototype && (gr = yr)
    : (Rr = !0));
var jr =
  !Br(gr) ||
  Ir(function () {
...
var Lr = { IteratorPrototype: gr, BUGGY_SAFARI_ITERATORS: Rr },
  Hr = dn,
  Wr = en
    ? {}.toString
    : function () {
  ...
  Gr = function (t, e, i, o) {
    if (t) {
      ...
      Yr(n, Kr) || qr(n, Kr, { configurable: !0, value: e }),
        o && !Vr && Ur(n, "toString", Xr);
    }
  },
  $r = {},
  Zr = Lr.IteratorPrototype,
  Qr = br,
  Jr = L,
  ts = Gr,
  es = $r,
    ...
    ("__proto__" in {}
      ? (function () {
          var t,
            ...
            i = {};
          try {
            (t = hs(Object.prototype, "__proto__", "set"))(i, []),
  ...
  Ts = function (t, e, i, o, n, r, s) {
    ...
    var a,
      ...
      u = !1,
      f = t.prototype,
      p = f[xs] || f["@@iterator"] || (n && f[n]),
      v = (!_s && p) || l(n),
      g = ("Array" === e && f.entries) || p;
    if (
      (g &&
        (a = gs(g.call(new t()))) !== Object.prototype &&
        a.next &&
        (ys(a, c, !0, !0), (bs[c] = Ss)),
      ks &&
        n === Os &&
      ...
      if (((h = { values: l(Os), keys: r ? v : l(Es), entries: l(Cs) }), s))
        for (d in h) (_s || u || !(d in f)) && ms(f, d, h[d]);
      else us({ target: e, proto: !0, forced: _s || u }, h);
    return s && f[xs] !== v && ms(f, xs, v, { name: n }), (bs[e] = v), h;
  },
  Ms = function (t, e) {
...
Bs(
  ...
  "String",
  function (t) {
    Ns(this, { type: zs, string: Is(t), index: 0 });
  },
  function () {
    var t,
      e = As(this),
    ...
    return o >= i.length
      ? Fs(void 0, !0)
      : ((t = Ps(i, o)), (e.index += t.length), Fs(t, !1));
  }
);
var Rs = B,
  js = oi,
  ...
  Ks = T,
  Gs = Ut,
  $s = y(Function.toString);
Ks(Gs.inspectSource) ||
  (Gs.inspectSource = function (t) {
    return $s(t);
  });
var Zs = Gs.inspectSource,
  Qs = y,
  Js = s,
  ta = T,
  ea = dn,
...
var qa = function (t) {
    ...
    var s,
      ...
      f = 0;
    if (!u || (this === ja && Ba(u)))
      for (s = za(e), a = i ? new this(s) : ja(s); s > f; f++)
        (c = r ? n(e[f], f) : e[f]), Na(a, f, c);
    else
      for (
        l = (d = Aa(e, u)).next, a = i ? new this() : [];
        !(h = Pa(l, d)).done;
        f++
      )
        (c = r ? Da(d, n, [h.value, f], !0) : h.value), Na(a, f, c);
    return (a.length = f), a;
  },
  Ua = function (t, e) {
    try {
...
Za(
  ...
  "Array",
  function (t, e) {
    th(this, { type: Ja, target: Ka(t), index: 0, kind: e });
  },
  function () {
    var t = eh(this),
      e = t.target,
...
jh(
  { target: "Array", proto: !0, arity: 1, forced: !Zh || !Kh("concat") },
  {
    concat: function (t) {
      var e,
        i,
...
var md = it,
  ...
  jl = function (t, e) {
    var i = (Bl[t] = $d(El));
    return (
      wl(i, { type: ml, tag: t, description: e }), Ld || (i.description = e), i
    );
  },
  Ll = function (t, e, i) {
    t === _l && Ll(Fl, e, i), Ud(t);
    ...
    return (
      ...
      Vd(Bl, o)
        ? (i.enumerable
            ? (Vd(t, yl) && t[yl][o] && (t[yl][o] = !1),
              (i = $d(i, { enumerable: Gd(0, !1) })))
            : (Vd(t, yl) || Ml(t, yl, Gd(1, {})), (t[yl][o] = !0)),
          Rl(t, o, i))
        : Ml(t, o, i)
    );
  },
  ...
  Wl = function (t) {
    var e = Xd(t),
      i = Rd(Il, this, e);
    return (
      !(this === _l && Vd(Bl, e) && !Vd(Fl, e)) &&
      (!(i || !Vd(this, e) || !Vd(Bl, e) || (Vd(this, yl) && this[yl][e])) || i)
    );
  },
  Vl = function (t, e) {
    var i = Yd(t),
    ...
    if (i !== _l || !Vd(Bl, o) || Vd(Fl, o)) {
      var n = Tl(i, o);
      return (
        !n || !Vd(Bl, o) || (Vd(i, yl) && i[yl][o]) || (n.enumerable = !0), n
      );
    }
  },
  ql = function (t) {
...
Hd ||
  (rl(
    (El = (xl = function () {
      ...
      var t =
        ...
        i = function (t) {
          this === _l && Rd(i, Fl, t),
            Vd(this, yl) && Vd(this[yl], e) && (this[yl][e] = !1);
          var o = Gd(1, t);
          try {
            Rl(this, e, o);
          } catch (t) {
      ...
      return Ld && Nl && Rl(_l, e, { configurable: !0, set: i }), jl(e, t);
    })[bl]),
    "toString",
    function () {
      return kl(this).tag;
  ...
  Nd(
    { global: !0, constructor: !0, wrap: !0, forced: !Hd, sham: !Hd },
    { Symbol: xl }
  ),
  gl(Zd(zl), function (t) {
    ul(t);
  ...
  Nd(
    { target: "Object", stat: !0, forced: !Hd, sham: !Ld },
    {
      create: function (t, e) {
  ...
  Nd({ target: "Object", stat: !0, forced: !Hd }, { getOwnPropertyNames: ql }),
  fl(),
  pl(xl, ml),
  (hl[yl] = !0);
var Yl = wt && !!Symbol.for && !!Symbol.keyFor,
  Xl = Mi,
  Kl = at,
  Gl = Jt,
  $l = un,
  Zl = Xt,
  Ql = Yl,
  Jl = Zl("string-to-symbol-registry"),
  tc = Zl("symbol-to-string-registry");
Xl(
...
var ec = Mi,
  ...
  nc = Tt,
  rc = Yl,
  sc = Xt("symbol-to-string-registry");
ec(
  { target: "Symbol", stat: !0, forced: !rc },
  {
    keyFor: function (t) {
...
var ac = Oh,
  ...
  Nc = function (t, e, i) {
    var o = Cc(i, e - 1),
      n = Cc(i, e + 1);
    return (Oc(Ic, t) && !Oc(Dc, n)) || (Oc(Dc, t) && !Oc(Ic, o))
      ? "\\u" + Mc(Sc(t, 0), 16)
      : t;
  };
Ec &&
  uc(
    { target: "JSON", stat: !0, arity: 3, forced: Bc || Fc },
    {
      stringify: function (t, e, i) {
        var o = wc(arguments),
          n = pc(Bc ? zc : Ec, null, o);
...
void 0 === Yc[Uc] && qc(Yc, Uc, { value: null }),
  _d("asyncDispose"),
  _d("dispose"),
  _d("metadata");
var Xc = Wc,
...
Mi({ target: "Symbol", stat: !0 }, { isRegisteredSymbol: Qc });
for (
  var Jc = Xt,
    tu = at,
    eu = y,
    ...
    ou = fe,
    nu = tu("Symbol"),
    ru = nu.isWellKnownSymbol,
    su = tu("Object", "getOwnPropertyNames"),
    au = eu(nu.prototype.valueOf),
    hu = Jc("wks"),
    du = 0,
    lu = su(nu),
    cu = lu.length;
...
var fu = function (t) {
  if (ru && ru(t)) return !0;
  try {
    for (var e = au(t), i = 0, o = su(hu), n = o.length; i < n; i++)
      if (hu[o[i]] == e) return !0;
  } catch (t) {}
  return !1;
};
Mi({ target: "Symbol", stat: !0, forced: !0 }, { isWellKnownSymbol: fu }),
  _d("matcher"),
  _d("observable"),
  Mi(
...
function gu(t) {
  return (
    (gu =
      "function" == typeof pu && "symbol" == typeof vu
        ? function (t) {
            return typeof t;
          }
        : function (t) {
...
function wu(t, e, i) {
  return (
    e && bu(t.prototype, e),
    i && bu(t, i),
    xh(t, "prototype", { writable: !1 }),
    t
  );
}
Mi({ target: "Array", stat: !0 }, { isArray: Oh });
var ku = it.Array.isArray,
  _u = o(ku);
var xu = P,
  Eu = Oh,
  Ou = TypeError,
  ...
  Su =
    ...
    !(function () {
      ...
      ? function (t, e) {
          if (Eu(t) && !Cu(t, "length").writable)
            throw new Ou("Cannot set read only .length");
          return (t.length = e);
        }
      : function (t, e) {
          return (t.length = e);
  ...
  { target: "Array", proto: !0, forced: !Ku },
  {
    slice: function (t, e) {
      ...
      if (
        ...
        return Xu(r, a, h);
      for (
        o = new (void 0 === i ? $u : i)(Zu(h - a, 0)), n = 0;
        a < h;
        a++, n++
      )
        a in r && Uu(o, n, r[a]);
        ...
        try {
          if (((r = (i = i.call(t)).next), 0 === e)) {
            ...
            for (
              ;
              !(h = (o = r.call(i)).done) &&
              (Au(a).call(a, o.value), a.length !== e);
              h = !0
            );
        } catch (t) {
          (d = !0), (n = t);
...
function lf(t) {
  return (
    ...
    (function (t) {
      if ((void 0 !== pu && null != fh(t)) || null != t["@@iterator"])
        return sf(t);
    })(t) ||
    hf(t) ||
    (function () {
...
var cf = o(Wc),
  ...
  Cf = zd.map;
Mi(
  { target: "Array", proto: !0, forced: !Rh("map") },
  {
    map: function (t) {
...
var zf = o(it.Object.keys),
  Nf = Mi,
  Af = Date,
  Rf = y(Af.prototype.getTime);
Nf(
  { target: "Date", stat: !0 },
  {
    now: function () {
...
Mi({ target: "Array", proto: !0, forced: [].forEach !== Vf }, { forEach: Vf });
var qf = zo("Array").forEach,
  Uf = dn,
  Yf = Jt,
  Xf = ht,
  Kf = qf,
  ...
  Zf = function (t) {
    var e = t.forEach;
    return t === Gf || (Xf(Gf, t) && e === Gf.forEach) || Yf($f, Uf(t))
      ? Kf
      : e;
  },
  Qf = o(Zf),
  ...
  ip = [1, 2];
Jf(
  { target: "Array", proto: !0, forced: String(ip) === String(ip.reverse()) },
  {
    reverse: function () {
...
var op = zo("Array").reverse,
  ...
  cp = function (t, e) {
    if (!delete t[e])
      throw new lp("Cannot delete property " + dp(e) + " of " + dp(t));
  },
  up = Mi,
  fp = $t,
  pp = Ai,
  ...
  Ep = Math.min;
up(
  { target: "Array", proto: !0, forced: !_p },
  {
    splice: function (t, e) {
      var i,
        o,
      ...
      for (
        ...
        (s = l + r) in h && wp(n, r, h[s]);
      if (((n.length = o), i < o)) {
        for (r = l; r < d - o; r++)
          (a = r + i), (s = r + o) in h ? (h[a] = h[s]) : kp(h, a);
        for (r = d; r > d - o + i; r--) kp(h, r - 1);
      } else if (i > o)
        for (r = d - o; r > l; r--)
          (a = r + i - 1), (s = r + o - 1) in h ? (h[a] = h[s]) : kp(h, a);
      for (r = 0; r < i; r++) h[r + l] = arguments[r + 2];
      return yp(h, d - o + i), n;
    },
  }
);
var Op = zo("Array").splice,
  Cp = ht,
  Sp = Op,
  Tp = Array.prototype,
  Mp = function (t) {
...
var Dp = zo("Array").includes,
  ...
  qp = y("".indexOf);
jp(
  { target: "String", proto: !0, forced: !Vp("includes") },
  {
    includes: function (t) {
      return !!~qp(
        Wp(Hp(this)),
...
var Up = zo("String").includes,
  ...
  Zp = function (t) {
    var e = t.includes;
    return t === Gp || (Yp(Gp, t) && e === Gp.includes)
      ? Xp
      : "string" == typeof t || t === $p || (Yp($p, t) && e === $p.includes)
      ? Kp
      : e;
  },
  Qp = o(Zp),
...
var iv = it.Object.getPrototypeOf,
  ov = o(iv),
  nv = zd.filter;
Mi(
  { target: "Array", proto: !0, forced: !Rh("filter") },
  {
    filter: function (t) {
...
var rv = zo("Array").filter,
  ...
  bv = { start: mv(1), end: mv(2), trim: mv(3) },
  wv = r,
  kv = s,
  _v = y,
  xv = un,
  ...
  Iv =
    ...
    (Tv &&
      ...
      : Cv;
Mi({ global: !0, forced: parseInt !== Iv }, { parseInt: Iv });
var Dv = o(it.parseInt),
  Bv = Mi,
  Fv = Yi.indexOf,
  zv = Hf,
  Nv = E([].indexOf),
  Av = !!Nv && 1 / Nv([1], 1, -0) < 0;
Bv(
  { target: "Array", proto: !0, forced: Av || !zv("indexOf") },
  {
    indexOf: function (t) {
...
var Rv = zo("Array").indexOf,
  ...
  Vv = o(Wv);
Mi({ target: "Object", stat: !0, sham: !P }, { create: br });
var qv = it.Object,
  Uv = function (t, e) {
...
var Gv = o(function (t, e, i) {
    return Kv(Xv.JSON.stringify, null, arguments);
  }),
  $v = "function" == typeof Bun && Bun && "string" == typeof Bun.version,
  Zv = TypeError,
  Qv = r,
  Jv = u,
  tg = T,
  ...
  og = ko,
  ng = function (t, e) {
    if (t < e) throw new Zv("Not enough arguments");
    return t;
  },
  rg = Qv.Function,
  sg =
  ...
  hg = Mi,
  dg = r,
  lg = ag(dg.setInterval, !0);
hg(
  { global: !0, bind: !0, forced: dg.setInterval !== lg },
  { setInterval: lg }
);
var cg = Mi,
  ug = r,
  fg = ag(ug.setTimeout, !0);
cg({ global: !0, bind: !0, forced: ug.setTimeout !== fg }, { setTimeout: fg });
var pg = o(it.setTimeout),
  vg = $t,
  gg = Ai,
  yg = Hi,
  mg = function (t) {
    for (
      var e = vg(this),
        i = yg(e),
        o = arguments.length,
        n = gg(o > 1 ? arguments[1] : void 0, i),
        r = o > 2 ? arguments[2] : void 0,
        s = void 0 === r ? i : gg(r, i);
      s > n;
...
Mi({ target: "Array", proto: !0 }, { fill: mg });
var bg,
  wg = zo("Array").fill,
  kg = ht,
  _g = wg,
  ...
  Eg = function (t) {
    var e = t.fill;
    return t === xg || (kg(xg, t) && e === xg.fill) ? _g : e;
  },
  Og = o(Eg);
...
Mg = "undefined" == typeof window ? {} : window;
var Ag = Ng(Dg.style, "touchAction"),
  Rg = void 0 !== Ag;
var jg = "compute",
  Lg = "auto",
  Hg = "manipulation",
  ...
  Ug = (function () {
    if (!Rg) return !1;
    var t = {},
      e = Mg.CSS && Mg.CSS.supports;
    return (
      ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach(
        function (i) {
          return (t[i] = !e || Mg.CSS.supports("touch-action", i));
        }
      ),
      t
    );
  })(),
  Yg = "ontouchstart" in Mg,
  Xg = void 0 !== Ng(Mg, "PointerEvent"),
  Kg = Yg && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
  Gg = "touch",
  $g = "mouse",
  Zg = 25,
  Qg = 1,
...
var py = (function () {
  ...
  return (
    (e.set = function (t) {
      t === jg && (t = this.compute()),
        Rg &&
          ...
          Ug[t] &&
          (this.manager.element.style[Ag] = t),
    ...
    (e.compute = function () {
      var t = [];
      return (
        cy(this.manager.recognizers, function (e) {
          uy(e.options.enable, [e]) && (t = t.concat(e.getTouchAction()));
        }),
        (function (t) {
          if (fy(t, Wg)) return Wg;
          var e = fy(t, Vg),
            i = fy(t, qg);
          return e && i ? Wg : e || i ? (e ? Vg : qg) : fy(t, Hg) ? Hg : Lg;
        })(t.join(" "))
      );
    }),
...
function gy(t) {
  var e = t.length;
  if (1 === e) return { x: Bg(t[0].clientX), y: Bg(t[0].clientY) };
  for (var i = 0, o = 0, n = 0; n < e; )
    (i += t[n].clientX), (o += t[n].clientY), n++;
  return { x: Bg(i / e), y: Bg(o / e) };
}
function yy(t) {
  for (var e = [], i = 0; i < t.pointers.length; )
    (e[i] = {
      clientX: Bg(t.pointers[i].clientX),
      clientY: Bg(t.pointers[i].clientY),
    }),
      i++;
  return {
    timeStamp: zg(),
...
function wy(t, e) {
  return t === e ? ey : Fg(t) >= Fg(e) ? (t < 0 ? iy : oy) : e < 0 ? ny : ry;
}
function ky(t, e, i) {
...
function _y(t, e) {
  var i = t.session,
    o = e.pointers,
    n = o.length;
  i.firstInput || (i.firstInput = yy(e)),
    n > 1 && !i.firstMultiple
      ? (i.firstMultiple = yy(e))
  ...
  var d,
    l,
    c = ky(e.deltaTime, e.deltaX, e.deltaY);
  (e.overallVelocityX = c.x),
    (e.overallVelocityY = c.y),
    (e.overallVelocity = Fg(c.x) > Fg(c.y) ? c.x : c.y),
    (e.scale = s
      ? ((d = s.pointers), my((l = o)[0], l[1], ly) / my(d[0], d[1], ly))
      : 1),
    (e.rotation = s
      ? (function (t, e) {
          return by(e[1], e[0], ly) + by(t[1], t[0], ly);
        })(s.pointers, o)
      : 0),
    ...
    (function (t, e) {
      ...
      if (e.eventType !== ty && (a > Zg || void 0 === s.velocity)) {
        var h = e.deltaX - s.deltaX,
          d = e.deltaY - s.deltaY,
          l = ky(a, h, d);
        (o = l.x),
          (n = l.y),
          (i = Fg(l.x) > Fg(l.y) ? l.x : l.y),
          (r = wy(h, d)),
          (t.lastInterval = e);
      } else
        (i = s.velocity),
...
var Ty = (function () {
  function t(t, e) {
    ...
    (this.manager = t),
      ...
      (this.domHandler = function (e) {
        uy(t.options.enable, [t]) && i.handler(e);
      }),
      this.init();
  }
  var e = t.prototype;
  return (
    (e.handler = function () {}),
    (e.init = function () {
      this.evEl && Oy(this.element, this.evEl, this.domHandler),
        this.evTarget && Oy(this.target, this.evTarget, this.domHandler),
        this.evWin && Oy(Sy(this.element), this.evWin, this.domHandler);
    }),
    (e.destroy = function () {
      this.evEl && Cy(this.element, this.evEl, this.domHandler),
        this.evTarget && Cy(this.target, this.evTarget, this.domHandler),
        this.evWin && Cy(Sy(this.element), this.evWin, this.domHandler);
    }),
    t
  );
})();
...
var Py = {
  ...
  Iy = { 2: Gg, 3: "pen", 4: $g, 5: "kinect" },
  Dy = "pointerdown",
  By = "pointermove pointerup pointercancel";
Mg.MSPointerEvent &&
  !Mg.PointerEvent &&
  ((Dy = "MSPointerDown"), (By = "MSPointerMove MSPointerUp MSPointerCancel"));
var Fy = (function (t) {
  function e() {
    var i,
      o = e.prototype;
  ...
  return (
    ...
    (e.prototype.handler = function (t) {
      var e = this.store,
        ...
        n = Py[o],
        r = Iy[t.pointerType] || t.pointerType,
        s = r === Gg,
        a = My(e, t.pointerId, "pointerId");
      n & Qg && (0 === t.button || s)
...
var Ay = { touchstart: Qg, touchmove: 2, touchend: Jg, touchcancel: ty },
  Ry = (function (t) {
    function e() {
      var i;
      return (
...
function jy(t, e) {
  var i,
    ...
    n = zy(t.touches),
    r = this.targetIds;
  if (e & (2 | Qg) && 1 === n.length) return (r[n[0].identifier] = !0), [n, n];
  var s = zy(t.changedTouches),
    a = [],
    h = this.target;
  if (
    ((o = n.filter(function (t) {
      return vy(t.target, h);
    })),
    e === Qg)
  )
  ...
  for (i = 0; i < s.length; )
    r[s[i].identifier] && a.push(s[i]),
      e & (Jg | ty) && delete r[s[i].identifier],
      i++;
  return a.length ? [Ny(o.concat(a), "identifier", !0), a] : void 0;
}
var Ly = { mousedown: Qg, mousemove: 2, mouseup: Jg },
  Hy = (function (t) {
    function e() {
      var i,
        o = e.prototype;
    ...
    return (
      ...
      (e.prototype.handler = function (t) {
        var e = Ly[t.type];
        e & Qg && 0 === t.button && (this.pressed = !0),
          2 & e && 1 !== t.which && (e = Jg),
          this.pressed &&
            (e & Jg && (this.pressed = !1),
            this.callback(this.manager, e, {
...
function qy(t, e) {
  t & Qg
    ? ((this.primaryTouch = e.changedPointers[0].identifier), Vy.call(this, e))
    : t & (Jg | ty) && Vy.call(this, e);
}
function Uy(t) {
  for (
      ...
      return (
        ((o = t.call(this, e, i) || this).handler = function (t, e, i) {
          ...
          if (
            ...
            if (n) qy.call(Tg(Tg(o)), e, i);
            else if (r && Uy.call(Tg(Tg(o)), i)) return;
            o.callback(t, e, i);
          }
        }),
        (o.touch = new Ry(o.manager, o.handler)),
        (o.mouse = new Hy(o.manager, o.handler)),
        (o.primaryTouch = null),
        (o.lastTouches = []),
        o
      );
...
function Xy(t, e, i) {
  return !!Array.isArray(t) && (cy(t, i[e], i), !0);
}
var Ky = 32,
  Gy = 1;
function $y(t, e) {
...
var Qy = (function () {
    ...
    return (
      ...
      (e.recognizeWith = function (t) {
        if (Xy(t, "recognizeWith", this)) return this;
        var e = this.simultaneous;
        return (
          e[(t = $y(t, this)).id] || ((e[t.id] = t), t.recognizeWith(this)),
          this
        );
      }),
      (e.dropRecognizeWith = function (t) {
        return (
          Xy(t, "dropRecognizeWith", this) ||
            ((t = $y(t, this)), delete this.simultaneous[t.id]),
          this
        );
      }),
      (e.requireFailure = function (t) {
        if (Xy(t, "requireFailure", this)) return this;
      ...
      (e.dropRequireFailure = function (t) {
        if (Xy(t, "dropRequireFailure", this)) return this;
        t = $y(t, this);
        var e = My(this.requireFail, t);
      ...
      (e.recognize = function (t) {
        var e = Pg({}, t);
        if (!uy(this.options.enable, [this, e]))
  ...
  Jy = (function (t) {
    ...
    return (
      ...
      (i.process = function (t) {
        ...
        if ((this.reset(), t.eventType & Qg && 0 === this.count))
          return this.failTimeout();
        if (n && r && o) {
          if (t.eventType !== Jg) return this.failTimeout();
          var s = !this.pTime || t.timeStamp - this.pTime < i.interval,
            a = !this.pCenter || my(this.pCenter, t.center) < i.posThreshold;
          if (
  ...
  tm = (function (t) {
    function e(e) {
      return (
        void 0 === e && (e = {}), t.call(this, Cg({ pointers: 1 }, e)) || this
      );
    }
    Sg(e, t);
    var i = e.prototype;
...
var im = (function (t) {
    function e(e) {
      ...
      return (
        ...
        ((i =
          t.call(
            this,
            Cg({ event: "pan", threshold: 10, pointers: 1, direction: hy }, e)
          ) || this).pX = null),
        (i.pY = null),
        i
      );
    ...
    return (
      (i.getTouchAction = function () {
        var t = this.options.direction,
          e = [];
        return t & sy && e.push(qg), t & ay && e.push(Vg), e;
      }),
      ...
      (i.attrTest = function (t) {
        return (
          tm.prototype.attrTest.call(this, t) &&
          (2 & this.state || (!(2 & this.state) && this.directionTest(t)))
        );
      }),
      (i.emit = function (e) {
        (this.pX = e.deltaX), (this.pY = e.deltaY);
        var i = em(e.direction);
  ...
  om = (function (t) {
    ...
    return (
      (i.getTouchAction = function () {
        return im.prototype.getTouchAction.call(this);
      }),
  ...
  nm = (function (t) {
    function e(e) {
      return (
        void 0 === e && (e = {}),
        t.call(this, Cg({ event: "pinch", threshold: 0, pointers: 2 }, e)) ||
          this
      );
    }
    Sg(e, t);
  ...
  rm = (function (t) {
    function e(e) {
      return (
        void 0 === e && (e = {}),
        t.call(this, Cg({ event: "rotate", threshold: 0, pointers: 2 }, e)) ||
          this
      );
    }
    Sg(e, t);
    ...
    function e(e) {
      ...
      return (
        ...
        ((i =
          t.call(
            this,
            Cg({ event: "press", pointers: 1, time: 251, threshold: 9 }, e)
          ) || this)._timer = null),
        (i._input = null),
        i
      );
    ...
    return (
      ...
      (i.process = function (t) {
        var e = this,
          ...
          n = t.distance < i.threshold,
          r = t.deltaTime > i.time;
        if (((this._input = t), !n || !o || (t.eventType & (Jg | ty) && !r)))
          this.reset();
        else if (t.eventType & Qg)
          this.reset(),
            (this._timer = setTimeout(function () {
              (e.state = 8), e.tryEmit();
            }, i.time));
        else if (t.eventType & Jg) return 8;
        return Ky;
      }),
      (i.reset = function () {
        clearTimeout(this._timer);
  ...
  hm = [
    ...
    [nm, { enable: !1 }, ["rotate"]],
    [om, { direction: sy }],
    [im, { direction: sy }, ["swipe"]],
    [Jy],
    [Jy, { event: "doubletap", taps: 2 }, ["tap"]],
    [sm],
  ];
function dm(t, e) {
  var i,
    o = t.element;
  o.style &&
    (cy(t.options.cssProps, function (n, r) {
      (i = Ng(o.style, r)),
        e
...
var lm = (function () {
    function t(t, e) {
      ...
      (this.options = Pg({}, am, e || {})),
        ...
        (this.input = new ((i = this).options.inputClass ||
          (Xg ? Fy : Kg ? Ry : Yg ? Yy : Hy))(i, xy)),
        (this.touchAction = new py(this, this.options.touchAction)),
        dm(this, !0),
        cy(
    ...
    return (
      ...
      (e.get = function (t) {
        if (t instanceof Qy) return t;
        for (var e = this.recognizers, i = 0; i < e.length; i++)
          if (e[i].options.event === t) return e[i];
        return null;
      }),
      (e.add = function (t) {
        if (Xy(t, "add", this)) return this;
      ...
      (e.remove = function (t) {
        if (Xy(t, "remove", this)) return this;
        var e = this.get(t);
        if (t) {
      ...
      (e.off = function (t, e) {
        ...
        return (
          cy(Ey(t), function (t) {
            e ? i[t] && i[t].splice(My(i[t], e), 1) : delete i[t];
          }),
          this
        );
      }),
  ...
  cm = { touchstart: Qg, touchmove: 2, touchend: Jg, touchcancel: ty },
  um = (function (t) {
    function e() {
      var i,
        o = e.prototype;
    ...
    return (
      ...
      (e.prototype.handler = function (t) {
        var e = cm[t.type];
        if ((e === Qg && (this.started = !0), this.started)) {
...
function fm(t, e) {
  var i = zy(t.touches),
    o = zy(t.changedTouches);
  return e & (Jg | ty) && (i = Ny(i.concat(o), "identifier", !0)), [i, o];
}
function pm(t, e, i) {
...
var bm = (function () {
  var t = function (t, e) {
    return (
      void 0 === e && (e = {}), new lm(t, Cg({ recognizers: hm.concat() }, e))
    );
  };
  return (
    (t.VERSION = "2.0.17-rc"),
    ...
    (t.DIRECTION_UP = ny),
    (t.DIRECTION_HORIZONTAL = sy),
    (t.DIRECTION_VERTICAL = ay),
    (t.DIRECTION_NONE = ey),
    (t.DIRECTION_DOWN = ry),
    (t.INPUT_START = Qg),
    (t.INPUT_MOVE = 2),
    ...
    (t.TouchInput = Ry),
    (t.MouseInput = Hy),
    (t.PointerEventInput = Fy),
    (t.TouchMouseInput = Yy),
    (t.SingleTouchInput = um),
    (t.Recognizer = Qy),
    (t.AttrRecognizer = tm),
    (t.Tap = Jy),
    (t.Pan = im),
    ...
    (t.boolOrFn = uy),
    (t.hasParent = vy),
    (t.addEventListeners = Oy),
    (t.removeEventListeners = Cy),
    (t.defaults = Pg({}, am, { preset: hm })),
    t
  );
})();
bm.defaults;
        ...
        for (
          ...
          (e -= t(n < 0 || arguments.length <= n ? void 0 : arguments[n])) <
            ...
            (i -= t(n < 0 || arguments.length <= n ? void 0 : arguments[n])) <
              0 && (i += 1),
            (o -= t(n < 0 || arguments.length <= n ? void 0 : arguments[n])) <
              0 && (o += 1);
        return [e, i, o];
      })(t),
      i = df(e, 3),
...
function Om(t) {
  ...
  var o = Em(this._dom.overlay);
  o.on("tap", Wo((e = this._onTapOverlay)).call(e, this)),
    this._cleanupQueue.push(function () {
      o.destroy();
    });
  var n = [
...
$o(Om.prototype),
  ...
  (Om.prototype.destroy = function () {
    ...
    this.deactivate();
    var i,
      o = km(hp((t = Pp((e = this._cleanupQueue)).call(e, 0))).call(t));
    try {
      for (o.s(); !(i = o.n()).done; ) {
        (0, i.value)();
      }
  ...
  (Om.prototype.activate = function () {
    Om.current && Om.current.deactivate(),
      (Om.current = this),
      (this.active = !0),
  ...
  (Om.prototype.deactivate = function () {
    (this.active = !1),
  ...
  (Om.prototype._onTapOverlay = function (t) {
    this.activate(), t.srcEvent.stopPropagation();
  });
var Cm = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
  Sm = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
  Tm =
...
function Fm(t, e) {
  ...
  for (var o in t)
    if (void 0 !== e[o])
      if (null === e[o] || "object" !== gu(e[o])) Bm(t, e, o, i);
      else {
        var n = t[o],
          r = e[o];
        Dm(n) && Dm(r) && Fm(n, r, i);
  ...
  for (var n = 0; n < t.length; n++) {
    ...
    if (Object.prototype.hasOwnProperty.call(i, r))
      if (i[r] && i[r].constructor === Object)
        void 0 === e[r] && (e[r] = {}),
          e[r].constructor === Object ? Am(e[r], i[r], !1, o) : Bm(e, i, r, o);
      else {
        if (Of(i[r]))
...
function Nm(t, e, i) {
  ...
  if (Of(i)) throw new TypeError("Arrays are not supported by deepExtend");
  for (var n in i)
    if (Object.prototype.hasOwnProperty.call(i, n) && !Qp(t).call(t, n))
      if (i[n] && i[n].constructor === Object)
        void 0 === e[n] && (e[n] = {}),
          e[n].constructor === Object ? Am(e[n], i[n]) : Bm(e, i, n, o);
      else if (Of(i[n])) {
        e[n] = [];
...
function Am(t, e) {
  ...
  for (var n in e)
    if (Object.prototype.hasOwnProperty.call(e, n) || !0 === i)
      if (
        "object" === gu(e[n]) &&
        null !== e[n] &&
        ov(e[n]) === Object.prototype
      )
        void 0 === t[n]
          ? (t[n] = Am({}, e[n], i))
          : "object" === gu(t[n]) &&
            null !== t[n] &&
            ov(t[n]) === Object.prototype
          ? Am(t[n], e[n], i)
          : Bm(t, e, n, o);
      else if (Of(e[n])) {
        var r;
...
function Hm(t) {
  ...
  switch (t.length) {
    ...
    case 7:
      return (e = Cm.exec(t))
        ? { r: Dv(e[1], 16), g: Dv(e[2], 16), b: Dv(e[3], 16) }
        : null;
    default:
      return null;
  }
...
function Vm(t, e, i) {
  ...
  return (
    "#" +
    mf((o = ((1 << 24) + (t << 16) + (e << 8) + i).toString(16))).call(o, 1)
  );
}
function qm(t, e) {
  if (Im(t)) {
    ...
    if (!0 === Km(i)) {
      ...
      return {
        background: i,
        border: h,
        highlight: { background: d, border: h },
        hover: { background: d, border: h },
      };
    }
    return {
      background: i,
...
function Zm(t, e, i) {
  ...
  if (void 0 !== s) {
    ...
    if (r(s)) {
      var d = !0;
      void 0 !== s.enabled ? (d = s.enabled) : void 0 !== h && (d = a.enabled),
        (function (t, e, i) {
          r(t[i]) || (t[i] = {});
          var o = e[i],
            n = t[i];
      ...
      wu(t, [
          ...
          value: function () {
            ...
            !0 ===
              (!(arguments.length > 0 && void 0 !== arguments[0]) ||
                arguments[0]) && (this.previousColor = wo({}, this.color)),
        ...
        },
        {
          ...
          value: function (t) {
            !0 ===
              (!(arguments.length > 1 && void 0 !== arguments[1]) ||
                arguments[1]) && (this.initialColor = wo({}, t)),
              (this.color = t);
            var e = Um(t.r, t.g, t.b),
              i = 2 * Math.PI,
              o = this.r * e.s,
              n = this.centerCoordinates.x + o * Math.sin(i * e.h),
              r = this.centerCoordinates.y + o * Math.cos(i * e.h);
        ...
        },
        {
          key: "_setBrightness",
          value: function (t) {
            var e = Um(this.color.r, this.color.g, this.color.b);
            e.v = t / 100;
            var i = Ym(e.h, e.s, e.v);
        ...
        },
        {
          ...
          value: function () {
            ...
            (this.opacityRange.onchange = function () {
              ...
              (this.cancelButton.onclick = Wo((t = this._hide)).call(
                t,
                this,
                !1
              )),
              ...
              (this.applyButton.onclick = Wo((e = this._apply)).call(e, this)),
              (this.saveButton = document.createElement("div")),
              (this.saveButton.className = "vis-button vis-save"),
              (this.saveButton.innerText = "save"),
              (this.saveButton.onclick = Wo((i = this._save)).call(i, this)),
              (this.loadButton = document.createElement("div")),
              (this.loadButton.className = "vis-button vis-load"),
              (this.loadButton.innerText = "load last"),
              (this.loadButton.onclick = Wo((o = this._loadLast)).call(
                o,
                this
              )),
        ...
        },
        {
          ...
          value: function () {
            ...
            (this.drag = {}),
              (this.pinch = {}),
              (this.hammer = new Em(this.colorPickerCanvas)),
        ...
        },
        {
          ...
          value: function () {
            if (!1 === this.generated) {
              ...
              for (o = 0; o < 360; o++)
                for (n = 0; n < this.r; n++)
                  (e = this.centerCoordinates.x + n * Math.sin(h * o)),
                    (i = this.centerCoordinates.y + n * Math.cos(h * o)),
                    (a = Ym(0.002777777777777778 * o, n * d, 1)),
        ...
        },
        {
          ...
          value: function (t) {
            var e = this.colorPickerDiv.getBoundingClientRect(),
              ...
              a = o - n,
              h = Math.atan2(s, a),
              d = 0.98 * Math.min(Math.sqrt(s * s + a * a), r),
              l = Math.cos(h) * d + n,
              c = Math.sin(h) * d + r;
            (this.colorPickerSelector.style.top =
            ...
            u = u < 0 ? u + 1 : u;
            var f = d / this.r,
              p = Um(this.color.r, this.color.g, this.color.b);
            (p.h = u), (p.s = f);
            var v = Ym(p.h, p.s, p.v);
            (v.a = this.color.a),
              (this.color = v),
              (this.initialColorDiv.style.backgroundColor =
                "rgba(" +
...
function ib() {
  ...
  return o.appendChild(ib.apply(void 0, lf(mf(e).call(e, 1)))), o;
}
var ob,
  nb = (function () {
    function t(e, i, o) {
            ...
            if (void 0 !== t) {
              ...
              if ("string" == typeof t) this.options.filter = t;
                ...
                void 0 !== t.container &&
                  ...
                  void 0 !== lv(t) && (this.options.filter = lv(t)),
                  void 0 !== t.showButton &&
            ...
            for (var o in this.configureOptions)
              Object.prototype.hasOwnProperty.call(this.configureOptions, o) &&
                ...
                "function" == typeof t
                  ? (i =
                      (i = t(o, [])) ||
                      this._handleObject(this.configureOptions[o], [o], !0))
                  : (!0 !== t && -1 === Vv(t).call(t, o)) || (i = !0),
                !1 !== i &&
          ...
          value: function () {
            ...
            if (void 0 !== this.popupDiv.html) {
              ...
              (this.popupDiv.html.style.left = e.left + "px"),
                ...
                (this.popupDiv.hideTimeout = pg(function () {
                  t.popupDiv.html.style.opacity = 0;
                }, 1500)),
                (this.popupDiv.deleteTimeout = pg(function () {
                  t._removePopup();
                }, 1800));
            }
          },
        ...
        },
        {
          ...
          value: function () {
            ...
            this.optionsContainer.appendChild(
              ib("pre", "const options = " + Gv(t, null, 2))
            );
          },
        },
        {
          ...
          value: function (t) {
            if ((void 0 === t && (t = !0), !0 === t)) {
              ...
              if ("flip" == this.overflowMethod) {
                ...
                (s = this.y - e) + e + this.padding > o &&
                  (s = o - e - this.padding),
                  s < this.padding && (s = this.padding),
                  (r = this.x) + i + this.padding > n &&
                    (r = n - i - this.padding),
  ...
  sb = !1,
  ab = "background: #FFeeee; color: #dd0000",
  hb = (function () {
    function t() {
      vh(this, t);
    }
      ...
      wu(t, null, [
        {
          ...
          value: function (e, i, o) {
            (sb = !1), (ob = i);
            var n = i;
            return void 0 !== o && (n = i[o]), t.parse(e, n, []), sb;
          },
        },
        {
          key: "parse",
          value: function (e, i, o) {
            for (var n in e)
              Object.prototype.hasOwnProperty.call(e, n) && t.check(n, e, i, o);
          },
        },
        {
          key: "check",
        ...
        },
        {
          ...
          value: function (e, i, o, n, r, s) {
            var a = function (i) {
                console.error("%c" + i + t.printLocation(s, e), ab);
              },
              h = t.getType(i[e]),
              d = r[h];
            void 0 !== d
              ? "array" === t.getType(d) && -1 === Vv(d).call(d, i[e])
                ? (a(
            ...
            (n =
              void 0 !== r.indexMatch
                ...
                : ". Did you mean one of these: " +
                  t.print(zf(i)) +
                  t.printLocation(o, e)),
              console.error('%cUnknown option detected: "' + e + '"' + n, ab),
              (sb = !0);
          },
        },
        {
          ...
          value: function (e, i, o) {
            ...
            for (var c in i) {
              ...
              if (void 0 !== i[c].__type__ && !0 === r) {
                var f = t.findInOptions(e, i[c], Rm(o, c));
                s > f.distance &&
                  ((a = f.closestMatch),
                  (h = f.path),
                  (s = f.distance),
                ...
                var p;
                -1 !== Vv((p = c.toLowerCase())).call(p, d) && (l = c),
                  s > (u = t.levenshteinDistance(e, c)) &&
                    ((a = c), (h = mf((n = o)).call(n)), (s = u));
              }
            }
  ...
  return (
    ...
    (function () {
      ...
      (kb = 0),
        void (_b = wb.charAt(0)),
        Bb(),
        "strict" === xb && ((t.strict = !0), Bb());
      ("graph" !== xb && "digraph" !== xb) || ((t.type = xb), Bb());
      Eb === mb.IDENTIFIER && ((t.id = xb), Bb());
      if ("{" != xb) throw jb("Angle bracket { expected");
      if ((Bb(), Fb(t), "}" != xb)) throw jb("Angle bracket } expected");
      if ((Bb(), "" !== xb)) throw jb("End of file expected");
      return Bb(), delete t.node, delete t.edge, delete t.graph, t;
    })()
  );
}
var gb = {
  ...
  yb = Yv(gb);
(yb.color = "color.color"), (yb.style = "dashes");
var mb = { NULL: 0, DELIMITER: 1, IDENTIFIER: 2, UNKNOWN: 3 },
  bb = {
    "{": !0,
    "}": !0,
    "[": !0,
...
function Pb(t, e) {
  for (var i, o, n = null, r = [t], s = t; s.parent; )
    r.push(s.parent), (s = s.parent);
  if (s.nodes)
    for (i = 0, o = s.nodes.length; i < o; i++)
      if (e.id === s.nodes[i].id) {
        n = s.nodes[i];
        break;
      }
  for (
    n || ((n = { id: e.id }), t.node && (n.attr = Tb(n.attr, t.node))),
      i = r.length - 1;
    i >= 0;
    i--
  ) {
    var a,
      h = r[i];
    h.nodes || (h.nodes = []),
      -1 === Vv((a = h.nodes)).call(a, n) && h.nodes.push(n);
  }
  e.attr && (n.attr = Tb(n.attr, e.attr));
}
function Ib(t, e) {
...
function Db(t, e, i, o, n) {
  var r = { from: e, to: i, type: o };
  return (
    t.edge && (r.attr = Tb({}, t.edge)),
    (r.attr = Tb(r.attr || {}, n)),
    null != n &&
      n.hasOwnProperty("arrows") &&
      null != n.arrows &&
      ((r.arrows = { to: { enabled: !0, type: n.arrows.type } }),
      (n.arrows = null)),
    r
  );
}
function Bb() {
  ...
  do {
    var t = !1;
    if ("#" === _b) {
      for (var e = kb - 1; " " === wb.charAt(e) || "\t" === wb.charAt(e); ) e--;
      if ("\n" === wb.charAt(e) || "" === wb.charAt(e)) {
        for (; "" != _b && "\n" != _b; ) Ob();
        t = !0;
      }
    }
  ...
  if ("" !== _b) {
    var i = _b + Cb();
    if (bb[i]) return (Eb = mb.DELIMITER), (xb = i), Ob(), void Ob();
    if (bb[_b]) return (Eb = mb.DELIMITER), (xb = _b), void Ob();
    if (Sb(_b) || "-" === _b) {
      for (xb += _b, Ob(); Sb(_b); ) (xb += _b), Ob();
      return (
        "false" === xb
          ? (xb = !1)
          : "true" === xb
          ? (xb = !0)
          : isNaN(Number(xb)) || (xb = Number(xb)),
        void (Eb = mb.IDENTIFIER)
      );
    }
    if ('"' === _b) {
      for (Ob(); "" != _b && ('"' != _b || ('"' === _b && '"' === Cb())); )
        '"' === _b
          ...
          : (xb += _b),
          Ob();
      if ('"' != _b) throw jb('End of string " expected');
      return Ob(), void (Eb = mb.IDENTIFIER);
    }
    for (Eb = mb.UNKNOWN; "" != _b; ) (xb += _b), Ob();
    throw new SyntaxError('Syntax error in part "' + Lb(xb, 30) + '"');
  }
  Eb = mb.DELIMITER;
}
function Fb(t) {
  for (; "" !== xb && "}" != xb; ) zb(t), ";" === xb && Bb();
}
function zb(t) {
  var e = Nb(t);
  if (e) Ab(t, e);
    ...
    var i = (function (t) {
      if ("node" === xb) return Bb(), (t.node = Rb()), "node";
      if ("edge" === xb) return Bb(), (t.edge = Rb()), "edge";
      if ("graph" === xb) return Bb(), (t.graph = Rb()), "graph";
      return null;
    })(t);
    if (!i) {
      if (Eb != mb.IDENTIFIER) throw jb("Identifier expected");
      var o = xb;
      if ((Bb(), "=" === xb)) {
        if ((Bb(), Eb != mb.IDENTIFIER)) throw jb("Identifier expected");
        (t[o] = xb), Bb();
      } else
        !(function (t, e) {
          var i = { id: e },
...
function Nb(t) {
  ...
  if (
    ...
    if (
      ...
      throw jb("Angle bracket } expected");
    Bb(),
      delete e.node,
      delete e.edge,
      delete e.graph,
...
function Ab(t, e) {
  for (; "->" === xb || "--" === xb; ) {
    ...
    if (n) i = n;
      ...
      if (Eb != mb.IDENTIFIER) throw jb("Identifier or subgraph expected");
      Pb(t, { id: (i = xb) }), Bb();
    }
    Ib(t, Db(t, e, i, o, Rb())), (e = i);
  }
}
function Rb() {
  for (
    ...
    for (Bb(), i = {}; "" !== xb && "]" != xb; ) {
      if (Eb != mb.IDENTIFIER) throw jb("Attribute name expected");
      var a = xb;
      if ((Bb(), "=" != xb)) throw jb("Equal sign = expected");
      if ((Bb(), Eb != mb.IDENTIFIER)) throw jb("Attribute value expected");
      var h = xb;
      "style" === a && (h = o[h]),
        "arrowhead" === a &&
          ((a = "arrows"), (h = { to: { enabled: !0, type: n[h] } })),
        "arrowtail" === a &&
          ((a = "arrows"), (h = { from: { enabled: !0, type: n[h] } })),
        r.push({ attr: i, name: a, value: h }),
        s.push(a),
        Bb(),
        "," == xb && Bb();
    }
    if ("]" != xb) throw jb("Bracket ] expected");
    Bb();
  }
  if (Qp(s).call(s, "dir")) {
    var d = { arrows: {} };
    for (t = 0; t < r.length; t++)
      if ("arrows" === r[t].name)
        if (null != r[t].value.to) d.arrows.to = t;
          ...
          if (null == r[t].value.from) throw jb("Invalid value of arrows");
          d.arrows.from = t;
        }
    ...
    if ("both" === u)
      d.arrows.to && d.arrows.from
        ? ((c = r[d.arrows.to].value.to.type),
          ...
          (r[d.arrows.to] = {
            ...
            value: {
              to: { enabled: !0, type: c },
              from: { enabled: !0, type: l },
            },
          }),
          Pp(r).call(r, d.arrows.from, 1))
        : d.arrows.to
        ? ((c = r[d.arrows.to].value.to.type),
          (l = "arrow"),
          (r[d.arrows.to] = {
      ...
      d.arrows.to && d.arrows.from
        ...
        (r[d.arrows.from] = {
          ...
          name: r[d.arrows.from].name,
          value: {
            from: { enabled: !0, type: r[d.arrows.from].value.from.type },
          },
        });
    else if ("none" === u) {
      var f;
      ...
      if ("forward" !== u) throw jb('Invalid dir type "' + u + '"');
      (d.arrows.to && d.arrows.from) || d.arrows.to
        ...
        (r[d.arrows.to] = {
          attr: r[d.arrows.to].attr,
          name: r[d.arrows.to].name,
          value: { to: { enabled: !0, type: r[d.arrows.to].value.to.type } },
        });
    }
    Pp(r).call(r, d.dir, 1);
  }
  ...
  for (e = r.length, t = 0; t < e; t++) Mb(r[t].attr, r[t].name, r[t].value);
  return i;
}
function jb(t) {
  return new SyntaxError(t + ', got "' + Lb(xb, 30) + '" (char ' + kb + ")");
}
function Lb(t, e) {
...
function Wb(t, e) {
  ...
  for (var o in t)
    if (t.hasOwnProperty(o)) {
      var n = e[o];
      Of(n)
        ? Qf(n).call(n, function (e) {
            Hb(i, e, t[o]);
          })
        : Hb(i, "string" == typeof n ? n : o, t[o]);
    }
  return i;
}
function Vb(t) {
  ...
  i.nodes &&
    Qf((e = i.nodes)).call(e, function (t) {
      var e = { id: t.id, label: String(t.label || t.id) };
      Tb(e, Wb(t.attr, gb)), e.image && (e.shape = "image"), o.nodes.push(e);
    });
  if (i.edges) {
    var n,
      r = function (t) {
    ...
    Qf((n = i.edges)).call(n, function (t) {
      ...
      t.from instanceof Object && t.from.edges) &&
        Qf((n = t.from.edges)).call(n, function (t) {
          var e = r(t);
          o.edges.push(e);
        });
      ((a = i),
      (h = function (e, i) {
        var n = Db(o, e.id, i.id, t.type, t.attr),
          s = r(n);
        o.edges.push(s);
      }),
      Of((s = e))
        ? Qf(s).call(s, function (t) {
            Of(a)
              ? Qf(a).call(a, function (e) {
                  h(t, e);
                })
              : h(t, a);
          })
        : Of(a)
        ? Qf(a).call(a, function (t) {
            h(s, t);
          })
        : h(s, a),
      t.to instanceof Object && t.to.edges) &&
        Qf((d = t.to.edges)).call(d, function (t) {
          var e = r(t);
          o.edges.push(e);
        });
    });
...
var qb = Object.freeze({ __proto__: null, DOTToGraph: Vb, parseDOT: vb });
function Ub(t, e) {
  var i,
  ...
  return {
    nodes: Df((i = t.nodes)).call(i, function (t) {
      var e = { id: t.id, fixed: o.nodes.fixed && null != t.x && null != t.y };
      return (
        null != t.attributes && (e.attributes = t.attributes),
        null != t.label && (e.label = t.label),
...
var Yb = Object.freeze({ __proto__: null, parseGephi: Ub }),
  Xb = Object.freeze({
    __proto__: null,
    cn: {
...
var Kb = (function () {
  ...
  ow =
    Qb(function () {
      ...
      ? function (t) {
          return !!Jb(t) && (!ew || "ArrayBuffer" !== tw(t)) && (!iw || iw(t));
        }
      : iw,
  nw = !s(function () {
  ...
  yw = 0,
  mw = function (t) {
    lw(t, gw, { value: { objectID: "O" + yw++, weakData: {} } });
  },
  bw = ($b.exports = {
    enable: function () {
      (bw.enable = function () {}), (vw = !0);
      var t = cw.f,
        e = sw([].splice),
        i = {};
      (i[gw] = 1),
        t(i).length &&
          ((cw.f = function (i) {
            for (var o = t(i), n = 0, r = o.length; n < r; n++)
              if (o[n] === gw) {
                e(o, n, 1);
                break;
              }
    ...
    getWeakData: function (t, e) {
      ...
      return t[gw].weakData;
    },
    onFreeze: function (t) {
      return pw && vw && fw(t) && !dw(t, gw) && mw(t), t;
    },
  });
aw[gw] = !0;
var ww = $b.exports,
  ...
  Fw = function (t, e, i) {
    var o,
      ...
      v = kw(e, l),
      g = function (t) {
        return o && Pw(o, "normal", t), new Dw(!0, t);
      },
      y = function (t) {
        return c
          ? (xw(t), p ? v(t[0], t[1], g) : v(t[0], t[1]))
          : p
          ? v(t, g)
          : v(t);
      };
    if (u) o = t.iterator;
      ...
      if (!(n = Mw(t))) throw new Iw(Ew(t) + " is not iterable");
      if (Ow(n)) {
        for (r = 0, s = Cw(t); s > r; r++)
          if ((a = y(t[r])) && Sw(Bw, a)) return a;
        return new Dw(!1);
      }
      o = Tw(t, n);
    }
    for (h = u ? t.next : o.next; !(d = _w(h, o)).done; ) {
      try {
        a = y(d.value);
      } catch (t) {
        Pw(o, "throw", t);
      }
      if ("object" == typeof a && a && Sw(Bw, a)) return a;
    }
    return new Dw(!1);
  },
  zw = ht,
  ...
  Aw = function (t, e) {
    if (zw(e, t)) return t;
    throw new Nw("Incorrect invocation");
  },
  Rw = Mi,
  jw = r,
  Lw = ww,
  ...
  tk = function (t, e, i) {
    ...
    if (
      ...
      var l = (o = e(function (e, i) {
          Qw(qw(e, l), { type: t, collection: new a() }),
            Xw(i) || Vw(i, e[s], { that: e, AS_ENTRIES: n });
        })).prototype,
        c = Jw(t);
      $w(
        [
        ...
        function (t) {
          ...
          !(t in h) ||
            ...
            Ww(l, t, function (i, o) {
              ...
              if (!e && r && !Yw(i)) return "get" === t && void 0;
              var s = n[t](0 === i ? 0 : i, o);
              return e ? this : s;
            });
        }
    ...
    } else (o = i.getConstructor(e, t, n, s)), Lw.enable();
    return (
      Kw(o, t, !1, !0),
      (d[t] = o),
      Rw({ global: !0, forced: !0 }, d),
      r || i.setStrong(o, t, n),
      o
    );
  },
  ek = Pr,
  ik = function (t, e, i) {
    for (var o in e) i && i.unsafe && t[o] ? (t[o] = e[o]) : ek(t, o, e[o], i);
    return t;
  },
  ok = at,
  nk = vd,
  ...
  kk = {
    getConstructor: function (t, e, i, o) {
      var n = t(function (t, n) {
          ck(t, r),
            ...
            yk || (t.size = 0),
            uk(n) || fk(n, t[o], { that: t, AS_ENTRIES: i });
        }),
        r = n.prototype,
        s = wk(e),
        a = function (t, e, i) {
        ...
        dk(r, {
          clear: function () {
            for (var t = s(this), e = t.index, i = t.first; i; )
              (i.removed = !0),
                ...
                delete e[i.index],
                (i = i.next);
            (t.first = t.last = void 0), yk ? (t.size = 0) : (this.size = 0);
          },
          delete: function (t) {
            var e = this,
              i = s(e),
          ...
          forEach: function (t) {
            for (
              var e,
                i = s(this),
                o = lk(t, arguments.length > 1 ? arguments[1] : void 0);
              (e = e ? e.next : i.first);
    ...
    setStrong: function (t, e, i) {
      ...
      pk(
        ...
        e,
        function (t, e) {
          bk(this, { type: o, target: t, state: n(t), kind: e, last: void 0 });
        },
        function () {
    ...
    return (
      wu(t, [
        ...
        },
        {
          key: "clear",
          value: function () {
            (this._groups = new _k()), (this._groupNames = []);
          },
        },
        {
          key: "get",
...
var Ek = o(it.Number.isNaN),
  Ok = r.isFinite,
  Ck =
    Number.isFinite ||
    function (t) {
      return "number" == typeof t && Ok(t);
    };
Mi({ target: "Number", stat: !0 }, { isFinite: Ck });
var Sk = o(it.Number.isFinite),
  Tk = zd.some;
Mi(
  { target: "Array", proto: !0, forced: !Hf("some") },
  {
    some: function (t) {
...
var Mk = zo("Array").some,
  Pk = ht,
  Ik = Mk,
  Dk = Array.prototype,
  Bk = function (t) {
    var e = t.some;
    return t === Dk || (Pk(Dk, t) && e === Dk.some) ? Ik : e;
  },
  Fk = o(Bk),
  zk = o(it.Object.getOwnPropertySymbols),
  Nk = { exports: {} },
  Ak = Mi,
  Rk = s,
  jk = Q,
...
var Wk = it.Object,
  Vk = (Nk.exports = function (t, e) {
    return Wk.getOwnPropertyDescriptor(t, e);
  });
Wk.getOwnPropertyDescriptor.sham && (Vk.sham = !0);
var qk = Nk.exports,
  Uk = o(qk),
  Yk = Ef,
  Xk = Q,
  ...
  Gk = va;
Mi(
  { target: "Object", stat: !0, sham: !P },
  {
    getOwnPropertyDescriptors: function (t) {
      for (
        var e, i, o = Xk(t), n = Kk.f, r = Yk(o), s = {}, a = 0;
        r.length > a;

      )
        void 0 !== (i = n(o, (e = r[a++]))) && Gk(s, e, i);
      return s;
    },
  }
);
var $k = o(it.Object.getOwnPropertyDescriptors),
  Zk = { exports: {} },
  Qk = Mi,
  Jk = P,
  t_ = Kn.f;
Qk(
  {
    target: "Object",
    stat: !0,
    forced: Object.defineProperties !== t_,
    sham: !Jk,
  },
  { defineProperties: t_ }
);
var e_ = it.Object,
  i_ = (Zk.exports = function (t, e) {
    return e_.defineProperties(t, e);
  });
e_.defineProperties.sham && (i_.sham = !0);
var o_ = o(Zk.exports),
  n_ = o(_h);
function r_(t, e, i) {
  return (
    (e = mu(e)) in t
      ? xh(t, e, { value: i, enumerable: !0, configurable: !0, writable: !0 })
      : (t[e] = i),
    t
  );
}
  ...
  v_ =
    ...
    (p_ &&
      ...
      ? function (t) {
          var e = d_(h_(t)),
            i = u_(e);
          return 0 === i && "-" === c_(e, 0) ? -0 : i;
        }
      : u_;
Mi({ global: !0, forced: parseFloat !== v_ }, { parseFloat: v_ });
var g_ = o(it.parseFloat),
  y_ = Mi,
  m_ = s,
  b_ = id.f;
y_(
...
var w_ = it.Object,
  k_ = function (t) {
    return w_.getOwnPropertyNames(t);
  },
  __ = o(k_);
function x_(t, e) {
...
function C_(t, e, i, o) {
  ...
  if ("function" == typeof o.distanceToBorder) {
    ...
    o.shape.width > o.shape.height
      ? ((n = o.x + 0.5 * o.shape.width), (r = o.y - i))
      : ((n = o.x + i), (r = o.y - 0.5 * o.shape.height));
  return { x: n, y: r };
}
var S_ = zo("Array").values,
  T_ = dn,
  M_ = Jt,
  P_ = ht,
  I_ = S_,
  D_ = Array.prototype,
  B_ = { DOMTokenList: !0, NodeList: !0 },
  F_ = function (t) {
    var e = t.values;
    return t === D_ || (P_(D_, t) && e === D_.values) || M_(B_, T_(t)) ? I_ : e;
  },
  z_ = o(F_),
  N_ = (function () {
    function t(e) {
        ...
        },
        {
          ...
          value: function (t) {
            var e =
                !(arguments.length > 1 && void 0 !== arguments[1]) ||
                arguments[1],
              i = df(this.prepareRegExp(t), 2),
              o = i[0],
              n = i[1],
              r = o.test(this.text.substr(this.position, n));
  ...
  j_ = (function () {
    function t(e, i, o, n) {
      ...
      vh(this, t),
        ...
        (this.selected = o),
        (this.hover = n);
      this.lines = new N_(function (t, i) {
      ...
      wu(t, [
        {
          ...
          value: function (t) {
            ...
            if (e.multi)
              ...
              for (var u = 0; u < o; u++) this.splitStringIntoLines(i[u]);
                ...
                n = function (t) {
                  return (
                    ...
                    (i.position < e.text.length + 1 &&
                      ...
                      / \t/.test(t) ? (i.spacing = !0) : (i.add(t), (o = !1))),
                    !0)
                  );
                };
        ...
        },
        {
          ...
          value: function (t) {
            for (
              var e = 0;
              e < t.length && !this.overMaxWidth(mf(t).call(t, 0, e));
        ...
        },
        {
          ...
          value: function (t) {
            ...
            for (
              var o = (t = (t = t.replace(/^( +)/g, "$1\r")).replace(
                /([^\r][^ ]*)( +)/g,
                "$1\r$2\r"
              )).split("\r");
              o.length > 0;
              ...
              if (0 === n) {
                ...
                this.lines.newLine(mf(r).call(r, 0, s), e),
                  (o[0] = mf(r).call(r, s));
              } else {
                var a = n;
                " " === o[n - 1] ? n-- : " " === o[a] && a++;
        ...
        [
          {
            ...
            value: function (t) {
              if (
                ...
                O_(t.label) ? (this.labelDirty = !0) : (t.label = void 0),
          ...
          },
          {
            ...
            value: function (t) {
              var e = {
                ...
                i = Jm(t, "widthConstraint");
              if ("number" == typeof i)
                (e.maxWdt = Number(i)), (e.minWdt = Number(i));
              else if ("object" === gu(i)) {
                var o = Jm(t, ["widthConstraint", "maximum"]);
                "number" == typeof o && (e.maxWdt = Number(o));
                var n = Jm(t, ["widthConstraint", "minimum"]);
                "number" == typeof n && (e.minWdt = Number(n));
              }
              var r = Jm(t, "heightConstraint");
              if ("number" == typeof r) e.minHgt = Number(r);
              else if ("object" === gu(r)) {
                var s = Jm(t, ["heightConstraint", "minimum"]);
                "number" == typeof s && (e.minHgt = Number(s));
                var a = Jm(t, ["heightConstraint", "valign"]);
                "string" == typeof a &&
          ...
          },
          {
            ...
            value: function (t, e) {
              this.setOptions(t, !0),
                ...
                Am(this.fontOptions, this.constrain(e)),
                (this.fontOptions.chooser = x_("label", e));
            },
          },
          {
            key: "adjustSizes",
            ...
            value: function (e, i, o) {
              for (var n, r = 0; r < e.length; ++r) {
                ...
                if (Object.prototype.hasOwnProperty.call(s, i)) {
                  ...
                  var a = {};
                  if (
                    (t.parseFontString(a, n) && (n = a),
                    Object.prototype.hasOwnProperty.call(n, o))
                  )
                    return n[o];
                }
              }
              if (Object.prototype.hasOwnProperty.call(this.fontOptions, o))
                return this.fontOptions[o];
              throw new Error(
                "Did not find value for multi-font for property: '" + o + "'"
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              for (
                var o = function () {
                    var t = L_[n],
                      o = e.fontOptions[t];
                    Lm(e.getFontOptions(i, t), function (t, e) {
                      o[e] = t;
                    }),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var o =
                ...
                r = df(this._setAlignment(t, e, i, o), 2);
              (e = r[0]),
                (i = r[1]),
                (t.textAlign = "left"),
                (e -= this.size.width / 2),
              ...
              for (var s = 0; s < this.lineCount; s++) {
                ...
                if (a && a.blocks) {
                  ...
                  for (var d = 0; d < a.blocks.length; d++) {
                    var l = a.blocks[d];
                    t.font = l.font;
                    var c = df(this._getColor(l.color, n, l.strokeColor), 2),
                      u = c[0],
                      f = c[1];
                    l.strokeWidth > 0 &&
                      ((t.lineWidth = l.strokeWidth),
                      (t.strokeStyle = f),
                      (t.lineJoin = "round")),
                      (t.fillStyle = u),
                      l.strokeWidth > 0 &&
                        t.strokeText(l.text, e + h, i + l.vadjust),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              this._processLabel(t, e, i),
                ...
                (this.size.yLine =
                  n + 0.5 * (1 - this.lineCount) * this.fontOptions.size),
                "hanging" === r &&
          ...
          },
          {
            ...
            value: function (t, e, i, o) {
              return new j_(t, this, e, i).process(o);
            },
          },
          {
            key: "_processLabel",
  ...
  K_ = function (t) {
    if (W_(t)) return t;
    throw new q_(V_(t) + " is not a constructor");
  },
  G_ = oi,
  $_ = et,
  Z_ = br,
  Q_ = s,
  J_ = at("Reflect", "construct"),
  tx = Object.prototype,
  ex = [].push,
  ix = Q_(function () {
    function t() {}
    return !(J_(function () {}, [], t) instanceof t);
  }),
  ox = !Q_(function () {
    J_(function () {});
  }),
  nx = ix || ox;
U_(
  { target: "Reflect", stat: !0, forced: nx, sham: nx },
  {
    construct: function (t, e) {
      K_(t), G_(e);
      var i = arguments.length < 3 ? t : K_(arguments[2]);
      if (ox && !ix) return J_(t, e, i);
      if (t === i) {
        switch (e.length) {
          case 0:
            return new t();
        ...
        var o = [null];
        return Y_(ex, o, e), new (Y_(X_, t, o))();
      }
      var n = i.prototype,
        r = Z_($_(n) ? n : tx),
        s = Y_(t, r, e);
...
var rx = o(it.Reflect.construct),
  sx = o(Uv);
Mi({ target: "Object", stat: !0 }, { setPrototypeOf: cs });
var ax = o(it.Object.setPrototypeOf),
  hx = o(Ho);
function dx(t, e) {
  var i;
  return (
...
function vx(t) {
  var e = (function () {
    if ("undefined" == typeof Reflect || !rx) return !1;
    if (rx.sham) return !1;
    if ("function" == typeof Proxy) return !0;
    try {
      return (
        Boolean.prototype.valueOf.call(rx(Boolean, [], function () {})), !0
      );
    } catch (t) {
      return !1;
    }
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r) {
          this.resize(t, o, n),
            ...
            qo(t, this.left, this.top, this.width, this.height, r.borderRadius),
    ...
    wu(i, [
      {
        ...
        value: function (t) {
          ...
          if (this.needsRefresh(e, i)) {
            ...
            var s = 2 * o.size;
            (this.width =
              null !== (n = this.customSizeWidth) && void 0 !== n ? n : s),
              (this.height =
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r, s, a) {
          ...
          return (
            ...
            ((h = e),
            Object.prototype.hasOwnProperty.call(Ko, h)
              ? Ko[h]
              : function (t) {
                  for (
...
function Ox(t, e) {
  ...
  if (zk) {
    var o = zk(t);
    e &&
      (o = lv(o).call(o, function (e) {
        return Uk(t, e).enumerable;
      })),
      i.push.apply(i, o);
  }
  return i;
...
function Cx(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Qf((i = Ox(Object(n), !0))).call(i, function (e) {
          r_(t, e, n[e]);
        })
      : $k
      ? o_(t, $k(n))
      : Qf((o = Ox(Object(n)))).call(o, function (e) {
          n_(t, e, Uk(n, e));
        });
  }
  return t;
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r) {
          this.resize(t, o, n),
            ...
            this.initContextForDraw(t, r),
            Uo(t, this.left, this.top, this.width, this.height),
            this.performFill(t, r),
            this.updateBoundingBox(e, i, t, o, n),
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r) {
          ...
          if (
            ...
            void 0 !== r.opacity &&
              ((c = Wm(c, r.opacity)), (u = Wm(u, r.opacity))),
              (t.strokeStyle = c),
              (t.fillStyle = u),
              t.rect(
...
function tE(t) {
  for (var e = 1; e < arguments.length; e++) {
    var i,
      ...
      n = null != arguments[e] ? arguments[e] : {};
    e % 2
      ? Qf((i = Jx(Object(n), !0))).call(i, function (e) {
          r_(t, e, n[e]);
        })
      : $k
      ? o_(t, $k(n))
      : Qf((o = Jx(Object(n)))).call(o, function (e) {
          n_(t, e, Uk(n, e));
        });
  }
  return t;
...
var eE = (function () {
  function t(e, i, o, n, r, s) {
    vh(this, t),
      ...
      (this.selected = !1),
      (this.hover = !1),
      (this.labelModule = new H_(this.body, this.options, !1)),
      this.setOptions(e);
  }
  return (
    wu(
              ...
              t.checkMass(e, this.id),
                void 0 !== e.x &&
                  (null === e.x
                    ...
                    : ((this.x = Dv(e.x)), (this.predefinedPosition = !0))),
                void 0 !== e.y &&
                  (null === e.y
                    ? ((this.y = void 0), (this.predefinedPosition = !1))
                    : ((this.y = Dv(e.y)), (this.predefinedPosition = !0))),
                void 0 !== e.size && (this.baseSize = e.size),
                void 0 !== e.value && (e.value = g_(e.value)),
                t.parseOptions(
                  this.options,
                  e,
                  !0,
        ...
        },
        {
          ...
          value: function () {
            ...
            if (
              ...
              (t.borderColor = Wm(t.borderColor, e)),
                (t.color = Wm(t.color, e)),
                (t.shadowColor = Wm(t.shadowColor, e));
            }
            return t;
          },
        },
          ...
          value: function (t) {
            ...
            return (
              this.labelModule.visible() &&
                E_(this.labelModule.getSize(), t) &&
                e.push({ nodeId: this.id, labelId: 0 }),
              E_(this.shape.boundingBox, t) && e.push({ nodeId: this.id }),
              e
            );
          },
        },
              ...
              if ("number" == typeof r || ("string" == typeof r && "" != r)) {
                ...
                void 0 !== s.opacity &&
                  ...
                  (t.checkOpacity(s.opacity) ||
                    ...
                    (s.opacity = void 0)));
                var a = lv((n = __(i))).call(n, function (t) {
                  return null != i[t];
                });
                a.push("font"), Nm(a, e, s), (e.color = qm(e.color));
              }
            }
          },
        },
        {
          ...
          value: function (e, i) {
            ...
            if (
              ...
              var s = qm(i.color);
              Fm(e.color, s);
            } else !0 === o && null === i.color && (e.color = $m(n.color));
            void 0 !== i.fixed &&
              null !== i.fixed &&
              ("boolean" == typeof i.fixed
                ...
                : (void 0 !== i.fixed.x &&
                  ...
                  void 0 !== i.fixed.y &&
                    ...
                    (e.fixed.y = i.fixed.y))),
              !0 === o && null === i.font && (e.font = $m(n.font)),
              t.updateGroupOptions(e, i, r),
              void 0 !== i.scaling &&
                Zm(e.scaling, i.scaling, "label", n.scaling);
          },
        },
        {
          key: "checkMass",
...
var nE = (function () {
    function i(t, e, o, n) {
      ...
      if (
        ...
        (this.groups = o),
        (this.layoutEngine = n),
        (this.body.functions.createNode = Wo((r = this.create)).call(r, this)),
        (this.nodesListeners = {
          add: function (t, e) {
            s.add(e.items);
          },
      ...
      (this.options = $m(this.defaultOptions)), this.bindEventListeners();
    }
    return (
      wu(i, [
        {
          ...
          value: function () {
            ...
            this.body.emitter.on(
              "refreshNodes",
              Wo((t = this.refresh)).call(t, this)
            ),
              this.body.emitter.on(
                "refresh",
                Wo((e = this.refresh)).call(e, this)
              ),
              this.body.emitter.on("destroy", function () {
                Lm(i.nodesListeners, function (t, e) {
        ...
        },
        {
          ...
          value: function (t) {
            if (void 0 !== t) {
              if (
                (eE.parseOptions(this.options, t),
                void 0 !== t.opacity &&
                  (Ek(t.opacity) ||
                  !Sk(t.opacity) ||
                  t.opacity < 0 ||
              ...
              if (
                ...
                for (var i = 0, o = zf(this.body.nodes); i < o.length; i++) {
                  var n = o[i];
        ...
        },
        {
          ...
          value: function (i) {
            var o =
              ...
              n = this.body.data.nodes;
            if (t("id", i)) this.body.data.nodes = i;
            else if (Of(i))
              (this.body.data.nodes = new e()), this.body.data.nodes.add(i);
            else {
              if (i) throw new TypeError("Array or DataSet expected");
              this.body.data.nodes = new e();
            }
            if (
              (n &&
                Lm(this.nodesListeners, function (t, e) {
                  n.off(e, t);
                }),
              (this.body.nodes = {}),
        ...
        },
        {
          ...
          value: function (t, e, i) {
            for (var o = this.body.nodes, n = !1, r = 0; r < t.length; r++) {
              ...
              void 0 !== a
                ? a.setOptions(h) && (n = !0)
                : ((n = !0), (a = this.create(h)), (o[s] = a));
            }
            n ||
              void 0 === i ||
              (n = Fk(e).call(e, function (t, e) {
                var o = i[e];
        ...
        },
        {
          ...
          value: function () {
            ...
            Lm(this.body.nodes, function (i, o) {
        ...
        },
        {
          ...
          value: function (t) {
            var e = [];
            if (void 0 !== this.body.nodes[t])
              for (var i = this.body.nodes[t], o = 0; o < i.edges.length; o++)
                e.push(i.edges[o].id);
            else
              console.error(
  ...
  hE = oi,
  dE = function (t) {
    return void 0 !== t && (rE(t, "value") || rE(t, "writable"));
  },
  lE = M,
  cE = Tr;
Mi(
...
var uE = o(it.Reflect.get),
  fE = o(qk);
function pE() {
  var t;
  "undefined" != typeof Reflect && uE
    ? (pE = hx((t = uE)).call(t))
    : (pE = function (t, e, i) {
        var o = (function (t, e) {
          for (
            ;
            !Object.prototype.hasOwnProperty.call(t, e) && null !== (t = fx(t));
...
vE(
  {
    ...
    stat: !0,
    arity: 2,
    forced: !!gE && gE(1 / 0, NaN) !== 1 / 0,
  },
  {
    hypot: function (t, e) {
      for (var i, o, n = 0, r = 0, s = arguments.length, a = 0; r < s; )
        a < (i = yE(arguments[r++]))
          ? ((n = n * (o = a / i) * o + 1), (a = i))
          : (n += i > 0 ? (o = i / a) * o : i);
      return a === 1 / 0 ? 1 / 0 : a * mE(n);
    },
  }
);
var bE = o(it.Math.hypot);
function wE(t) {
  var e = (function () {
    if ("undefined" == typeof Reflect || !rx) return !1;
    if (rx.sham) return !1;
      ...
      wu(i, null, [
        {
          ...
          value: function (t, e) {
            ...
            return kE.transform(i, e), kE.drawPath(t, i), !0;
          },
        },
      ]),
      i
      ...
      wu(t, null, [
        {
          ...
          value: function (t, e) {
            ...
            return (
              t.beginPath(),
              t.arc(i.x, i.y, 0.4 * e.length, n, r, !1),
              t.stroke(),
              !0
            );
          },
      ...
      wu(t, null, [
        {
          ...
          value: function (t, e) {
            var i = { x: -0.4, y: 0 };
            return kE.transform(i, e), Vo(t, i.x, i.y, 0.4 * e.length), !0;
          },
        },
      ]),
      t
...
function NE(t) {
  for (var e = 1; e < arguments.length; e++) {
    var i,
      ...
      n = null != arguments[e] ? arguments[e] : {};
    e % 2
      ? Qf((i = zE(Object(n), !0))).call(i, function (e) {
          r_(t, e, n[e]);
        })
      : $k
      ? o_(t, $k(n))
      : Qf((o = zE(Object(n)))).call(o, function (e) {
          n_(t, e, Uk(n, e));
        });
  }
  return t;
  ...
  return (
    wu(t, [
      ...
      },
      {
        ...
        value: function (t, e, i, o) {
          ...
          (t.strokeStyle = this.getColor(t, e)),
            (t.lineWidth = e.width),
            !1 !== e.dashes
              ? this._drawDashedLine(t, e, n)
              : this._drawLine(t, e, n);
        },
      },
      {
        key: "_drawLine",
        value: function (t, e, i, o, n) {
          if (this.from != this.to) this._line(t, e, i, o, n);
            ...
            var r = df(this._getCircleData(t), 3),
              s = r[0],
              a = r[1],
              h = r[2];
      ...
      },
      {
        ...
        value: function (t, e, i, o, n) {
          t.lineCap = "round";
          var r = Of(e.dashes) ? e.dashes : [5, 5];
          if (void 0 !== t.setLineDash) {
            if (
              (t.save(),
              t.setLineDash(r),
              ...
              var s = df(this._getCircleData(t), 3),
                a = s[0],
                h = s[1],
                d = s[2];
            ...
            if (this.from != this.to)
              Xo(t, this.from.x, this.from.y, this.to.x, this.to.y, r);
            else {
              var l = df(this._getCircleData(t), 3),
                c = l[0],
                u = l[1],
                f = l[2];
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var e,
            i = df(mf((e = this._getCircleData(t))).call(e, 0, 2), 2),
            o = i[0],
            n = i[1];
          return {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          var i = C_(t, this.options.selfReference.angle, e, this.from);
          return [i.x, i.y, e];
        },
      },
      {
        ...
        value: function (t, e) {
          if (!1 !== e.inheritsColor) {
            if ("both" === e.inheritsColor && this.from.id !== this.to.id) {
              ...
              return (
                !1 === this.from.selected && !1 === this.to.selected
                  ? ((o = Wm(this.from.options.color.border, e.opacity)),
                    (n = Wm(this.to.options.color.border, e.opacity)))
            ...
            return "to" === e.inheritsColor
              ? Wm(this.to.options.color.border, e.opacity)
              : Wm(this.from.options.color.border, e.opacity);
          }
          return Wm(e.color, e.opacity);
        },
      },
      {
        key: "_circle",
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r) {
          if (this.from != this.to)
            return this._getDistanceToEdge(t, e, i, o, n, r);
          var s = df(this._getCircleData(void 0), 3),
            a = s[0],
            h = s[1],
            d = s[2],
            l = a - n,
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r) {
          ...
          "from" === e
            ...
            : ((h = this.to),
              (d = this.from),
              (l = r.middleArrowScale < 0),
              (c = Math.abs(r.middleArrowScale)),
              (u = r.middleArrowType));
          var p = 15 * c + 3 * f;
          if (h != d) {
            var v = p / bE(h.x - d.x, h.y - d.y);
            if ("middle" !== e)
            ...
            var k = df(this._getCircleData(t), 3),
              _ = k[0],
              x = k[1],
              E = k[2];
            if ("from" === e) {
              ...
              (a = this._pointOnCircle(_, x, E, I)),
                (s = -2 * I * Math.PI + 1.5 * Math.PI + 0.1 * Math.PI);
            }
          }
          return {
            point: a,
...
function jE(t) {
  for (var e = 1; e < arguments.length; e++) {
    var i,
      ...
      n = null != arguments[e] ? arguments[e] : {};
    e % 2
      ? Qf((i = RE(Object(n), !0))).call(i, function (e) {
          r_(t, e, n[e]);
        })
      : $k
      ? o_(t, $k(n))
      : Qf((o = RE(Object(n)))).call(o, function (e) {
          n_(t, e, Uk(n, e));
        });
  }
  return t;
        ...
        value: function (t, e, i, o, n, r, s) {
          ...
          for (h = 1; h < 10; h++)
            (d = 0.1 * h),
              ...
              h > 0 &&
                (u =
                  (a = this._getDistanceToLine(f, p, l, c, n, r)) < u ? a : u),
              (f = l),
              (p = c);
          return u;
        },
    ...
    wu(i, [
      {
        key: "setOptions",
        value: function (t) {
          pE(fx(i.prototype), "setOptions", this).call(this, t);
          var e = !1;
        ...
        value: function (t) {
          var e =
            arguments.length > 1 && void 0 !== arguments[1]
              ...
              : this.via;
          if (this.from === this.to) {
            var i = df(this._getCircleData(), 3),
              o = i[0],
              n = i[1],
              r = i[2],
              s = 2 * Math.PI * (1 - t);
            return { x: o + r * Math.sin(s), y: n + r - r * (1 - Math.cos(s)) };
          }
          return {
            x:
        ...
        value: function () {
          ...
          if ("discrete" === o || "diagonalCross" === o) {
            ...
            return (
              "discrete" === o &&
                (n <= r
                  ? (h = n < i * r ? this.from.x : h)
                  : (d = r < i * n ? this.from.y : d)),
              { x: h, y: d }
            );
          }
          if ("straightCross" === o) {
            ...
            return (
              n <= r
                ? ((l = 0), this.from.y < this.to.y && (c = -c))
                : (this.from.x < this.to.x && (l = -l), (c = 0)),
              { x: this.to.x + l, y: this.to.y + c }
            );
          }
          if ("horizontal" === o) {
            var u = (1 - i) * n;
          ...
          if ("curvedCW" === o) {
            ...
            var p = Math.sqrt(n * n + r * r),
              v = Math.PI,
              g = (Math.atan2(r, n) + (0.5 * i + 0.5) * v) % (2 * v);
            return {
          ...
          if ("curvedCCW" === o) {
            ...
            var y = Math.sqrt(n * n + r * r),
              m = Math.PI,
              b = (Math.atan2(r, n) + (0.5 * -i + 0.5) * m) % (2 * m);
            return {
    ...
    wu(i, [
      {
        ...
        value: function (t, e, i, o, n, r, s, a) {
          for (
            var h = 1e9, d = t, l = e, c = [0, 0, 0, 0], u = 1;
            u < 10;
            u++
          ) {
            var f = 0.1 * u;
  ...
  QE = (function () {
    function t(e, i, o, n, r) {
      ...
      (this.options = $m(n)),
        ...
        (this.connected = !1),
        (this.labelModule = new H_(this.body, this.options, !0)),
        this.setOptions(e);
    }
    return (
      wu(
            ...
            value: function () {
              ...
              return (
                void 0 !== this.edgeType &&
                  (((this.edgeType instanceof VE &&
                    !0 === t.enabled &&
                    "dynamic" === t.type) ||
                    (this.edgeType instanceof GE &&
                      !0 === t.enabled &&
                      "cubicBezier" === t.type) ||
                    (this.edgeType instanceof UE &&
                      !0 === t.enabled &&
                      "dynamic" !== t.type &&
                      "cubicBezier" !== t.type) ||
                    (this.edgeType instanceof ZE && !1 === t.type.enabled)) &&
                    (i = !1),
                  !0 === i && (e = this.cleanup())),
                !0 === i
                  ? !0 === t.enabled
                    ? "dynamic" === t.type
                      ? ((e = !0),
                        (this.edgeType = new VE(
                          this.options,
                          this.body,
                          this.labelModule
                        )))
                      : "cubicBezier" === t.type
                      ? (this.edgeType = new GE(
                          this.options,
                          this.body,
                          this.labelModule
                        ))
                      : (this.edgeType = new UE(
                          this.options,
                          this.body,
                          this.labelModule
                        ))
                    : (this.edgeType = new ZE(
                        this.options,
                        this.body,
                        this.labelModule
                      ))
              ...
              if (void 0 !== this.options.value) {
                ...
                if (!0 === this.options.scaling.label.enabled) {
                  ...
                  this.options.font.size =
                    this.options.scaling.label.min + o * r;
                }
            ...
            value: function (t) {
              ...
              if (!e.hidden) {
                ...
                (this.edgeType.fromPoint = this.edgeType.from),
                  ...
                  e.fromArrow &&
                    ((o.from = this.edgeType.getArrowData(
                      t,
                      "from",
                      i,
                      this.selected,
                    ...
                    !1 === e.arrowStrikethrough &&
                      (this.edgeType.fromPoint = o.from.core),
                    e.fromArrowSrc &&
                      (o.from.image = this.imagelist.load(e.fromArrowSrc)),
                    e.fromArrowImageWidth &&
                      (o.from.imageWidth = e.fromArrowImageWidth),
                    e.fromArrowImageHeight &&
                      (o.from.imageHeight = e.fromArrowImageHeight)),
                  e.toArrow &&
                    ((o.to = this.edgeType.getArrowData(
                      t,
                      "to",
                      i,
                      this.selected,
                    ...
                    !1 === e.arrowStrikethrough &&
                      (this.edgeType.toPoint = o.to.core),
                    e.toArrowSrc &&
                      (o.to.image = this.imagelist.load(e.toArrowSrc)),
                    e.toArrowImageWidth &&
                      (o.to.imageWidth = e.toArrowImageWidth),
                    e.toArrowImageHeight &&
                      (o.to.imageHeight = e.toArrowImageHeight)),
                  e.middleArrow &&
                    ((o.middle = this.edgeType.getArrowData(
                      t,
                      "middle",
                      i,
                      this.selected,
                    ...
                    e.middleArrowSrc &&
                      (o.middle.image = this.imagelist.load(e.middleArrowSrc)),
                    e.middleArrowImageWidth &&
                      (o.middle.imageWidth = e.middleArrowImageWidth),
                    e.middleArrowImageHeight &&
                      (o.middle.imageHeight = e.middleArrowImageHeight)),
                  e.fromArrow &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (this.labelModule.visible()) {
                ...
                E_(this.labelModule.getSize(), t, i) &&
                  e.push({ edgeId: this.id, labelId: 0 });
              }
              var o = { left: t.x, top: t.y };
              return (
                this.isOverlappingWith(o) && e.push({ edgeId: this.id }), e
              );
            },
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                void 0 !== e.endPointOffset &&
                  ...
                  (Sk(e.endPointOffset.from)
                    ? (t.endPointOffset.from = e.endPointOffset.from)
                    : ((t.endPointOffset.from =
                        void 0 !== o.endPointOffset.from
                          ? o.endPointOffset.from
                          : 0),
                      console.error(
                ...
                void 0 !== e.endPointOffset &&
                  ...
                  (Sk(e.endPointOffset.to)
                    ? (t.endPointOffset.to = e.endPointOffset.to)
                    : ((t.endPointOffset.to =
                        void 0 !== o.endPointOffset.to
                          ? o.endPointOffset.to
                          : 0),
                      console.error(
                ...
                O_(e.label)
                  ? (t.label = e.label)
                  : O_(t.label) || (t.label = void 0),
                Zm(t, e, "smooth", o),
                Zm(t, e, "shadow", o),
                Zm(t, e, "background", o),
                void 0 !== e.dashes && null !== e.dashes
                  ? (t.dashes = e.dashes)
                  : !0 === i && null === e.dashes && (t.dashes = Yv(o.dashes)),
                void 0 !== e.scaling && null !== e.scaling
                  ? (void 0 !== e.scaling.min &&
                    ...
                    Zm(t.scaling, e.scaling, "label", o.scaling))
                  : !0 === i &&
                    null === e.scaling &&
                    (t.scaling = Yv(o.scaling)),
                void 0 !== e.arrows && null !== e.arrows)
              )
                if ("string" == typeof e.arrows) {
                  var r = e.arrows.toLowerCase();
                  (t.arrows.to.enabled = -1 != Vv(r).call(r, "to")),
                    (t.arrows.middle.enabled = -1 != Vv(r).call(r, "middle")),
                    (t.arrows.from.enabled = -1 != Vv(r).call(r, "from"));
                } else {
                  if ("object" !== gu(e.arrows))
                    throw new Error(
                      "The arrow newOptions can only be an object or a string. Refer to the documentation. You used:" +
                        Gv(e.arrows)
                    );
                  Zm(t.arrows, e.arrows, "to", o.arrows),
                    Zm(t.arrows, e.arrows, "middle", o.arrows),
                    Zm(t.arrows, e.arrows, "from", o.arrows);
                }
              ...
              if (void 0 !== e.color && null !== e.color) {
                ...
                if (Im(a))
                  ...
                  var d = !1;
                  void 0 !== s.color && ((a.color = s.color), (d = !0)),
                    void 0 !== s.highlight &&
                      ((a.highlight = s.highlight), (d = !0)),
                    void 0 !== s.hover && ((a.hover = s.hover), (d = !0)),
              ...
              } else !0 === i && null === e.color && (t.color = $m(o.color));
              !0 === i && null === e.font && (t.font = $m(o.font)),
  ...
  JE = (function () {
    function i(t, e, o) {
      ...
      vh(this, i),
        ...
        (this.images = e),
        (this.groups = o),
        (this.body.functions.createEdge = Wo((n = this.create)).call(n, this)),
        (this.edgesListeners = {
          add: function (t, e) {
            r.add(e.items);
          },
        ...
        Am(this.options, this.defaultOptions),
      ...
      wu(i, [
        {
          ...
          value: function () {
            ...
            this.body.emitter.on("_forceDisableDynamicCurves", function (t) {
              ...
              var o = !1;
              for (var n in i.body.edges)
                if (Object.prototype.hasOwnProperty.call(i.body.edges, n)) {
              ...
              this.body.emitter.on("destroy", function () {
                Lm(i.edgesListeners, function (t, e) {
        ...
        },
        {
          ...
          value: function (t) {
            if (void 0 !== t) {
              QE.parseOptions(this.options, t, !0, this.defaultOptions, !0);
              var e = !1;
              if (void 0 !== t.smooth)
              ...
              if (void 0 !== t.font)
                for (var o in this.body.edges)
                  Object.prototype.hasOwnProperty.call(this.body.edges, o) &&
                    this.body.edges[o].updateLabelModule();
        ...
        },
        {
          ...
          value: function (i) {
            var o = this,
              n =
                arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
              r = this.body.data.edges;
            if (t("id", i)) this.body.data.edges = i;
            else if (Of(i))
              (this.body.data.edges = new e()), this.body.data.edges.add(i);
            else {
              if (i) throw new TypeError("Array or DataSet expected");
              this.body.data.edges = new e();
            }
            if (
              (r &&
                Lm(this.edgesListeners, function (t, e) {
                  r.off(e, t);
                }),
              (this.body.edges = {}),
              ...
              Lm(this.edgesListeners, function (t, e) {
                o.body.data.edges.on(e, t);
              });
              var s = this.body.data.edges.getIds();
              this.add(s, !0);
            }
            this.body.emitter.emit("_adjustEdgesForHierarchicalLayout"),
              !1 === n && this.body.emitter.emit("_dataChanged");
          },
        },
        {
          key: "add",
        ...
        },
        {
          ...
          value: function (t) {
            for (
              var e = this.body.edges, i = this.body.data.edges, o = !1, n = 0;
              n < t.length;
              n++
            ) {
              var r = t[n],
                ...
                a = e[r];
              void 0 !== a
                ? (a.disconnect(), (o = a.setOptions(s) || o), a.connect())
                : ((this.body.edges[r] = this.create(s)), (o = !0));
            }
            !0 === o
              ? (this.body.emitter.emit("_adjustEdgesForHierarchicalLayout"),
                this.body.emitter.emit("_dataChanged"))
        ...
        },
        {
          ...
          value: function () {
            var t = this;
            Lm(this.body.edges, function (e, i) {
        ...
        },
        {
          ...
          value: function () {
            var t = this,
              e = [];
            Lm(this.body.edges, function (i, o) {
  ...
  tO = (function () {
    function t(e, i, o) {
      vh(this, t),
        ...
        this.barnesHutTree,
        this.setOptions(o),
        (this._rng = xm("BARNES HUT SOLVER"));
    }
    return (
      wu(t, [
        {
            ...
            if (
              ...
              for (var r = 0; r < o; r++)
                (t = e[i[r]]).options.mass > 0 &&
                  this._getForceContributions(n.root, t);
            }
          },
        },
        {
          ...
          value: function (t, e, i, o, n) {
            0 === t && (e = t = 0.1),
              this.overlapAvoidanceFactor < 1 &&
                o.shape.radius &&
                (t = Math.max(
                  0.1 + this.overlapAvoidanceFactor * o.shape.radius,
                  t - o.shape.radius
                ));
            var r =
                (this.options.gravitationalConstant * n.mass * o.options.mass) /
                Math.pow(t, 3),
              s = e * r,
              a = i * r;
        ...
        },
        {
          ...
          value: function () {
            for (
              ...
              for (var r = t[e[n]], s = n + 1; s < e.length; s++) {
                var a = t[e[s]];
                if (r.level === a.level) {
                  var h =
                      o +
      ...
      wu(t, [
              ...
              !0 === (i = a[s[h]]).connected &&
                ...
                (void 0 !== i.edgeType.via
                  ? ((t =
                    ...
                    (n = i.edgeType.via),
                    (r = i.from),
                    this._calculateSpringForce(o, n, 0.5 * t, e),
                    this._calculateSpringForce(n, r, 0.5 * t, e))
                  : ((t =
                      void 0 === i.options.length
        ...
        },
        {
          ...
          value: function (t, e, i, o) {
            var n = t.x - e.x,
              r = t.y - e.y,
              s = Math.max(Math.sqrt(n * n + r * r), 0.01),
              a = (o * (i - s)) / s,
              h = n * a,
              d = r * a;
          ...
          value: function () {
            ...
            for (var y = 0; y < u.length; y++)
              !0 === (e = l[u[y]]).connected &&
                ...
                (i = e.from.x - e.to.x),
                (o = e.from.y - e.to.y),
                (a = 0 === (a = Math.sqrt(i * i + o * o)) ? 0.01 : a),
                (n = i * (s = (this.options.springConstant * (t - a)) / a)),
                (r = o * s),
                e.to.level != e.from.level
                  ? (void 0 !== p[e.toId] &&
                      ((p[e.toId].springFx -= n), (p[e.toId].springFy -= r)),
                    void 0 !== p[e.fromId] &&
                      ((p[e.fromId].springFx += n),
                      (p[e.fromId].springFy += r)))
                  : (void 0 !== p[e.toId] &&
                      ((p[e.toId].x -= c * n), (p[e.toId].y -= c * r)),
                    void 0 !== p[e.fromId] &&
                      ((p[e.fromId].x += c * n), (p[e.fromId].y += c * r))));
            s = 1;
      ...
      wu(t, [
          ...
          value: function (t) {
            if (void 0 !== t)
              if (!1 === t)
                ...
                (this.physicsEnabled = !0),
                  Nm(["stabilization"], this.options, t),
                  Zm(this.options, t, "stabilization"),
                ...
                e &&
                  (("number" != typeof e.x || Ek(e.x)) && (e.x = 0),
                  ("number" != typeof e.y || Ek(e.y)) && (e.y = 0)),
          ...
          value: function () {
            ...
            "forceAtlas2Based" === this.options.solver
              ? ((t = this.options.forceAtlas2Based),
                (this.nodesSolver = new aO(this.body, this.physicsBody, t)),
                (this.edgesSolver = new oO(this.body, this.physicsBody, t)),
                (this.gravitySolver = new dO(this.body, this.physicsBody, t)))
              : "repulsion" === this.options.solver
              ? ((t = this.options.repulsion),
                (this.nodesSolver = new eO(this.body, this.physicsBody, t)),
                (this.edgesSolver = new oO(this.body, this.physicsBody, t)),
                (this.gravitySolver = new rO(this.body, this.physicsBody, t)))
              : "hierarchicalRepulsion" === this.options.solver
              ? ((t = this.options.hierarchicalRepulsion),
                (this.nodesSolver = new iO(this.body, this.physicsBody, t)),
                (this.edgesSolver = new nO(this.body, this.physicsBody, t)),
                (this.gravitySolver = new rO(this.body, this.physicsBody, t)))
              : ((t = this.options.barnesHut),
                (this.nodesSolver = new tO(this.body, this.physicsBody, t)),
                (this.edgesSolver = new oO(this.body, this.physicsBody, t)),
                (this.gravitySolver = new rO(this.body, this.physicsBody, t))),
              (this.modelOptions = t);
          },
            ...
            !0 === this.physicsEnabled && !0 === this.options.enabled
              ? ((this.stabilized = !1),
                ...
                void 0 === this.viewFunction &&
                  ((this.viewFunction = Wo((t = this.simulationStep)).call(
                    t,
                    this
                  )),
        ...
        },
        {
          ...
          value: function () {
            var t = jf();
            this.physicsTick(),
              (jf() - t < 0.4 * this.simulationInterval ||
          ...
          value: function () {
            ...
            for (var o in e)
              Object.prototype.hasOwnProperty.call(e, o) &&
                ...
                this.physicsBody.physicsEdgeIndices.push(e[o].id);
            for (
              var n = 0;
              n < this.physicsBody.physicsNodeIndices.length;
              n++
            ) {
        ...
        },
        {
          ...
          value: function () {
            ...
            for (var n in this.referenceState)
              if (
                Object.prototype.hasOwnProperty.call(this.referenceState, n) &&
                void 0 !== i[n] &&
                ((t = i[n].x - o[n].positions.x),
        ...
        },
        {
          ...
          value: function () {
            for (
              var t = this.physicsBody.physicsNodeIndices, e = 0, i = 0, o = 0;
              o < t.length;
              o++
            ) {
              var n = t[o],
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              ...
              !1 === e.options.fixed.x
                ? ((o.x = this.calculateComponentVelocity(
                    o.x,
                    i.x,
                    e.options.mass
                  )),
                ...
                : ((i.x = 0), (o.x = 0)),
              !1 === e.options.fixed.y
                ? ((o.y = this.calculateComponentVelocity(
                    o.y,
                    i.y,
                    e.options.mass
                  )),
        ...
        },
        {
          ...
          value: function () {
            ...
            for (
              var o, n = 0;
              e() && n < this.options.stabilization.updateInterval;

            )
              this.physicsTick(), n++;
            (i(), e())
              ? pg(Wo((o = this._stabilizationBatch)).call(o, this), 0)
        ...
        },
        {
          ...
          value: function (t) {
            for (
              ...
              (t.fillStyle = h),
                FE.draw(t, { type: "arrow", point: d, angle: l, length: a }),
                Og(t).call(t);
            }
          },
        },
...
const pO = [];
for (let t = 0; t < 256; ++t) pO.push((t + 256).toString(16).slice(1));
var vO = {
  randomUUID:
    "undefined" != typeof crypto &&
    crypto.randomUUID &&
...
function gO(t, e, i) {
  if (vO.randomUUID && !e && !t) return vO.randomUUID();
  const o = (t = t || {}).random || (t.rng || fO)();
      ...
      wu(i, [
        {
          ...
          value: function (t) {
            ...
            delete this.containedNodes[t],
              Lm(i.edges, function (t) {
                delete e.containedEdges[t.id];
              }),
              Lm(i.containedNodes, function (t, i) {
                e.containedNodes[i] = t;
              }),
              (i.containedNodes = {}),
              Lm(i.containedEdges, function (t, i) {
                e.containedEdges[i] = t;
              }),
              (i.containedEdges = {}),
              Lm(i.edges, function (t) {
                Lm(e.edges, function (i) {
                  var o,
                    n,
                    r = Vv((o = i.clusteringEdgeReplacingIds)).call(o, t.id);
                  -1 !== r &&
                    (Lm(t.clusteringEdgeReplacingIds, function (t) {
      ...
      wu(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            var o = {},
              n = {};
            Lm(this.body.nodes, function (i, r) {
              i.options &&
                !0 === e.joinCondition(i.options) &&
                ((o[r] = i),
                Lm(i.edges, function (e) {
            ...
            for (
              var n,
                ...
                d = function () {
                  var o = {},
                    d = {},
                    c = i.body.nodeIndices[l],
                    u = i.body.nodes[c];
                  if (void 0 === h[c]) {
                    (s = 0), (r = []);
                    for (var f = 0; f < u.edges.length; f++)
                      (n = u.edges[f]),
                        void 0 === i.clusteredEdges[n.id] &&
                          (n.toId !== n.fromId && s++, r.push(n));
                    if (s === t) {
                      for (
                        var p = function (t) {
                            if (
                      ...
                      if (zf(o).length > 0 && zf(d).length > 0 && !0 === v) {
                        ...
                        if (void 0 !== m) {
                          for (var b in o)
                            void 0 === m.nodes[b] && (m.nodes[b] = o[b]);
                          for (var w in d)
                            void 0 === m.edges[w] && (m.edges[w] = d[w]);
                        } else a.push({ nodes: o, edges: d });
                      }
                    }
                  }
                },
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            for (var d = 0; d < n.edges.length; d++) {
              ...
              if (void 0 === this.clusteredEdges[l.id]) {
                ...
                if (void 0 === this.clusteredNodes[c])
                  if (c !== a)
                    if (void 0 === e.joinCondition)
                      (s[l.id] = l), (r[c] = this.body.nodes[c]);
                    else {
                      var u = yO.cloneOptions(this.body.nodes[c]);
            ...
            var f = Df((i = zf(r))).call(i, function (t) {
              return r[t].id;
            });
            for (var p in r)
              if (Object.prototype.hasOwnProperty.call(r, p))
                for (var v = r[p], g = 0; g < v.edges.length; g++) {
                  var y = v.edges[g];
                  Vv(f).call(f, this._getConnectedId(y, v.id)) > -1 &&
                    (s[y.id] = y);
                }
          ...
          value: function (t, e, i, o) {
            ...
            for (
              ...
              var y = c[g],
                ...
                b = v(y);
              null === b
                ? ((b = this._createClusteredEdge(y.fromId, y.toId, m, o)),
                  p.push(b))
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            if (
              ...
              var a = Am({}, i.clusterNodeProperties);
              if (void 0 !== i.processProperties) {
                ...
                for (var u in e)
                  if (
                    ...
                    var f = yO.cloneOptions(e[u], "edge");
                    c.push(f);
                  }
              ...
              void 0 === a.x &&
                ...
                void 0 === a.y &&
                  ...
                  (a.y = v.y)),
                (a.id = p);
              var g = this.body.functions.createNode(a, bO);
              (g.containedNodes = t),
                (g.containedEdges = e),
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (
              !0 !== o.isCluster ||
              void 0 === o.containedNodes ||
              void 0 === o.containedEdges
            )
            ...
            if (
              ...
              for (var p in a)
                if (Object.prototype.hasOwnProperty.call(a, p)) {
                  ...
                  void 0 !== f[p] &&
                    ((v.x = void 0 === f[p].x ? o.x : f[p].x),
                    (v.y = void 0 === f[p].y ? o.y : f[p].y));
                }
            } else
              Lm(a, function (t) {
                !1 === t.options.fixed.x && (t.x = o.x),
        ...
        },
        {
          ...
          value: function (t) {
            for (
              var e, i = [], o = 0;
              void 0 !== this.clusteredNodes[t] && o < 100;
        ...
        },
        {
          ...
          value: function () {
            ...
            Lm(this.clusteredEdges, function (t) {
              var i = e.body.edges[t];
              (void 0 !== i && i.endPointsValid()) || (o[t] = t);
            }),
              n(function (t) {
                Lm(t.containedEdges, function (t, e) {
                  t.endPointsValid() || o[e] || (o[e] = e);
                });
              }),
              Lm(this.body.edges, function (t, i) {
                var n = !0,
              ...
              n(function (t) {
                Lm(o, function (i) {
                  delete t.containedEdges[i],
                    Lm(t.edges, function (n, r) {
                      n.id !== i
                        ? (n.clusteringEdgeReplacingIds = e._filter(
                            n.clusteringEdgeReplacingIds,
                            function (t) {
                              return !o[t];
                            }
                          ))
              ...
              Lm(zf(this.body.edges), function (t) {
                var i = e.body.edges[t],
                  o =
                ...
                if (o !== e._isClusteredEdge(i.id))
                  if (o) {
                    ...
                    void 0 !== n &&
                      e._clusterEdges(e.body.nodes[i.fromId], i, n);
            ...
            for (
              var s = !1,
                ...
                h = function () {
                  var t = [];
                  n(function (e) {
                    var i = zf(e.containedNodes).length,
      ...
      wu(t, [
        {
          ...
          value: function () {
            ...
            this.body.emitter.on("dragStart", function () {
              ...
              this.body.emitter.on(
                "_requestRedraw",
                Wo((t = this._requestRedraw)).call(t, this)
              ),
            ...
            if ("undefined" != typeof window) {
              ...
              return (
                !0 === this.requiresTimeout
                  ? (i = pg(t, e))
                  : o.requestAnimationFrame && (i = o.requestAnimationFrame(t)),
                i
              );
            }
          },
          ...
          value: function () {
            ...
            !0 === this.renderingActive &&
              ...
              (this.renderTimer = this._requestNextFrame(
                Wo((t = this._renderStep)).call(t, this),
        ...
        },
        {
          ...
          value: function () {
            ...
            if (!0 === this.allowRedraw) {
              ...
              if (
                (i.clearRect(0, 0, o, n), 0 === this.canvas.frame.clientWidth)
              )
                return;
              if (
                (i.save(),
        ...
        },
        {
          ...
          value: function () {
            ...
            for (var o in i)
              Object.prototype.hasOwnProperty.call(i, o) &&
                ((e = i[o]).resize(t), e.updateBoundingBox(t, e.selected));
            t.restore();
          },
        },
        {
          ...
          value: function (t) {
            for (
              var e,
                ...
                l = { top: h.y, left: h.x, bottom: d.y, right: d.x },
                c = [],
                u = 0;
              u < r.length;
              u++
            )
              if ((e = n[r[u]]).hover) a.push(r[u]);
        ...
        },
        {
          ...
          value: function (t) {
            for (
              var e = this.body.edges, i = this.body.edgeIndices, o = 0;
              o < i.length;
              o++
            ) {
              var n = e[i[o]];
          ...
          value: function () {
            if ("undefined" != typeof window) {
              ...
              (this.requiresTimeout = !1),
                (-1 != Vv(t).call(t, "msie 9.0") ||
                  (-1 != Vv(t).call(t, "safari") &&
                    Vv(t).call(t, "chrome") <= -1)) &&
                  (this.requiresTimeout = !0);
    ...
    wu(t, [
      ...
      },
      {
        ...
        value: function (t) {
          var e = this;
          if (void 0 !== t) {
            zm(["width", "height", "autoResize"], this.options, t);
          }
      ...
      },
      {
        ...
        value: function () {
          var t, e, i;
          Qf(
            (t = hp((e = Pp((i = this._cleanupCallbacks)).call(i, 0))).call(e))
          ).call(t, function (t) {
            try {
              t();
            } catch (t) {
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if ("string" == typeof t) {
            if (-1 !== Vv(t).call(t, "%") || -1 !== Vv(t).call(t, "px"))
              return t;
      ...
      },
      {
        ...
        value: function () {
          ...
          void 0 !== this.hammer && this.hammer.destroy(),
            (this.drag = {}),
            (this.pinch = {}),
            (this.hammer = new cb(this.frame.canvas)),
            this.hammer.get("pinch").set({ enable: !0 }),
            this.hammer
              .get("pan")
              .set({ threshold: 5, direction: cb.DIRECTION_ALL }),
            xO(this.hammer, function (e) {
            ...
            (this.hammerFrame = new cb(this.frame)),
            EO(this.hammerFrame, function (e) {
...
var CO = (function () {
  function t(e, i) {
    ...
    vh(this, t),
      ...
      (this.touchTime = 0),
      (this.viewFunction = void 0),
      this.body.emitter.on("fit", Wo((o = this.fit)).call(o, this)),
      this.body.emitter.on("animationFinished", function () {
        r.body.emitter.emit("_stopRendering");
      }),
      this.body.emitter.on(
        "unlockNode",
        Wo((n = this.releaseNode)).call(n, this)
      );
  }
  return (
    wu(t, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (0 === n || 0 === r)
            (o = 1), (i = yO.getRange(this.body.nodes, t.nodes));
          else if (!0 === e) {
            var s = 0;
            ...
            (i = yO.getRange(this.body.nodes, t.nodes)),
              (o =
                12.662 / (this.body.nodeIndices.length + 7.4147) + 0.0964822),
              (o *= Math.min(n / 600, r / 600));
          } else {
            this.body.emitter.emit("_resizeNodes"),
              (i = yO.getRange(this.body.nodes, t.nodes));
            var h = n / (1.1 * Math.abs(i.maxX - i.minX)),
              d = r / (1.1 * Math.abs(i.maxY - i.minY));
            o = h <= d ? h : d;
          }
          o > t.maxZoomLevel
            ? (o = t.maxZoomLevel)
            : o < t.minZoomLevel && (o = t.minZoomLevel);
          var l = {
            position: yO.findCenter(i),
            scale: o,
      ...
      },
      {
        ...
        value: function (t) {
          if (void 0 !== t) {
            if (null != t.offset) {
              if (null != t.offset.x) {
                if (((t.offset.x = +t.offset.x), !Sk(t.offset.x)))
                  throw new TypeError(
                    'The option "offset.x" has to be a finite number.'
                  );
              } else t.offset.x = 0;
              if (null != t.offset.y) {
                if (((t.offset.y = +t.offset.y), !Sk(t.offset.y)))
                  throw new TypeError(
            ...
            if (null != t.position) {
              if (null != t.position.x) {
                if (((t.position.x = +t.position.x), !Sk(t.position.x)))
                  throw new TypeError(
                    'The option "position.x" has to be a finite number.'
                  );
              } else t.position.x = 0;
              if (null != t.position.y) {
                if (((t.position.y = +t.position.y), !Sk(t.position.y)))
                  throw new TypeError(
          ...
          if (void 0 !== t) {
            ...
            if (
              ...
              if (null != this.lockedOnNodeId)
                (this.viewFunction = Wo((e = this._lockedRedraw)).call(
                  e,
                  this
                )),
                  this.body.emitter.on("initRedraw", this.viewFunction);
              ...
              (this.animationSpeed =
                ...
                (this.animationEasingFunction = t.animation.easingFunction),
                (this.viewFunction = Wo((i = this._transitionRedraw)).call(
                  i,
                  this
                )),
                this.body.emitter.on("initRedraw", this.viewFunction),
      ...
      },
      {
        ...
        value: function () {
          ...
          var e = Qm[this.animationEasingFunction](this.easingTime);
          if (
            ((this.body.view.scale =
            ...
            if (
              ...
              (this.viewFunction = Wo((i = this._lockedRedraw)).call(i, this)),
                this.body.emitter.on("initRedraw", this.viewFunction);
  ...
  var a = function (t) {
    ...
    d = function (t, e) {
      if (void 0 !== r[e][t.keyCode]) {
        for (var o = r[e][t.keyCode], n = 0; n < o.length; n++)
          (void 0 === o[n].shift ||
  ...
  return (
    ...
    (n.bindAll = function (t, e) {
      for (var i in (void 0 === e && (e = "keydown"), s))
        s.hasOwnProperty(i) && n.bind(i, t, e);
    }),
    (n.getKey = function (t) {
      for (var e in s)
      ...
      if (void 0 !== e) {
        ...
        if (void 0 !== n)
          for (var a = 0; a < n.length; a++)
            (n[a].fn == e && n[a].shift == s[t].shift) ||
              o.push(r[i][s[t].code][a]);
        r[i][s[t].code] = o;
      } else r[i][s[t].code] = [];
    }),
    (n.reset = function () {
      ...
      },
      {
        ...
        value: function () {
          ...
          for (var o = 0; o < e.length; o++) {
            ...
            var n,
              r,
              s = new cb(this.navigationDOM[e[o]]);
            if ("_fit" === i[o]) xO(s, Wo((n = this._fit)).call(n, this));
            else xO(s, Wo((r = this.bindToRedraw)).call(r, this, i[o]));
            this.navigationHammers.push(s);
          }
          var a = new cb(this.canvas.frame);
          EO(a, function () {
            t._stopMovement();
          }),
      ...
      },
      {
        ...
        value: function (t) {
          ...
          void 0 === this.boundFunctions[t] &&
            ((this.boundFunctions[t] = Wo((e = this[t])).call(e, this)),
        ...
        value: function () {
          ...
          !0 === this.options.keyboard.enabled) &&
            (!0 === this.options.keyboard.bindToWindow
              ? (this.keycharm = SO({ container: window, preventDefault: !0 }))
              : (this.keycharm = SO({
...
var IO = (function () {
  function t(e, i, o) {
    ...
    vh(this, t),
      ...
      (this.navigationHandler = new TO(e, i)),
      (this.body.eventListeners.onTap = Wo((n = this.onTap)).call(n, this)),
      (this.body.eventListeners.onTouch = Wo((r = this.onTouch)).call(r, this)),
      (this.body.eventListeners.onDoubleTap = Wo((s = this.onDoubleTap)).call(
        s,
        this
      )),
      (this.body.eventListeners.onHold = Wo((a = this.onHold)).call(a, this)),
      (this.body.eventListeners.onDragStart = Wo((h = this.onDragStart)).call(
        h,
        this
      )),
      (this.body.eventListeners.onDrag = Wo((d = this.onDrag)).call(d, this)),
      (this.body.eventListeners.onDragEnd = Wo((l = this.onDragEnd)).call(
        l,
        this
      )),
      (this.body.eventListeners.onMouseWheel = Wo((c = this.onMouseWheel)).call(
        c,
        this
      )),
      (this.body.eventListeners.onPinch = Wo((u = this.onPinch)).call(u, this)),
      (this.body.eventListeners.onMouseMove = Wo((f = this.onMouseMove)).call(
        f,
        this
      )),
      (this.body.eventListeners.onRelease = Wo((p = this.onRelease)).call(
        p,
        this
      )),
      (this.body.eventListeners.onContext = Wo((v = this.onContext)).call(
        v,
        this
      )),
      (this.touchTime = 0),
      ...
      (this.body.functions.getPointer = Wo((g = this.getPointer)).call(
        g,
        this
      )),
      (this.options = {}),
        ...
        value: function (t) {
          if (void 0 !== t) {
            Nm(
              ...
              Zm(this.options, t, "keyboard"),
              t.tooltip &&
                (wo(this.options.tooltip, t.tooltip),
                t.tooltip.color &&
                  (this.options.tooltip.color = qm(t.tooltip.color)));
          }
      ...
      },
      {
        ...
        value: function (t) {
          return {
            x:
              t.x -
              ((e = this.canvas.frame.canvas), e.getBoundingClientRect().left),
            y: t.y - jm(this.canvas.frame.canvas),
          };
          var e;
        },
      },
        ...
        value: function (t) {
          if (!this.drag.dragging) {
            ...
            if (
              ...
              (this.drag.selection = []),
              (this.drag.translation = wo({}, this.body.view.translation)),
              ...
              var o,
                n = MO(this.selectionHandler.getSelectedNodes());
              try {
                for (n.s(); !(o = n.n()).done; ) {
                  var r = o.value,
                    s = {
              ...
              Qf(o).call(o, function (t) {
                ...
                !1 === t.xFixed &&
                  (i.x = e.canvas._XconvertDOMtoCanvas(
                    e.canvas._XconvertCanvasToDOM(t.x) + n
                  )),
                  !1 === t.yFixed &&
        ...
        value: function (t) {
          ...
          if (void 0 === this.popupObj) {
            for (
              ...
              !0 === (a = d[h[c]]).isOverlappingWith(o) &&
                ((r = !0), void 0 !== a.getTitle() && l.push(h[c]));
          ...
          void 0 !== this.popupObj
            ? this.popupObj.id !== n &&
              (void 0 === this.popup &&
                (this.popup = new ub(this.canvas.frame)),
        ...
        value: function (t) {
          ...
          if ("node" === this.popup.popupTargetType) {
            ...
            void 0 === this.selectionHandler.getNodeAt(t) &&
              ...
              (i =
                this.body.edges[this.popup.popupTargetId].isOverlappingWith(e));
          !1 === i &&
            ((this.popupObj = void 0),
            this.popup.hide(),
...
var DO = o(it.Set),
  ...
  $O = function (t, e) {
    return qO(t.entries, function (t) {
      return t[0] === e;
    });
  };
GO.prototype = {
  ...
  delete: function (t) {
    var e = UO(this.entries, function (e) {
      return e[0] === t;
    });
    return ~e && YO(this.entries, e, 1), !!~e;
  },
};
var ZO,
  QO = {
    getConstructor: function (t, e, i, o) {
      var n = t(function (t, n) {
          NO(t, r),
            WO(t, { type: e, id: XO++, frozen: void 0 }),
            RO(n) || LO(n, t[o], { that: t, AS_ENTRIES: i });
        }),
        r = n.prototype,
        s = VO(e),
        a = function (t, e, i) {
          var o = s(t),
            n = zO(AO(e), !0);
          return !0 === n ? KO(o).set(e, i) : (n[o.id] = i), t;
        };
      return (
        FO(r, {
          delete: function (t) {
            ...
            return !0 === i
              ? KO(e).delete(t)
              : i && HO(i, e.id) && delete i[e.id];
          },
          has: function (t) {
            var e = s(this);
            if (!jO(t)) return !1;
            var i = zO(t);
            return !0 === i ? KO(e).has(t) : i && HO(i, e.id);
          },
        }),
        FO(
          r,
          i
            ? {
                get: function (t) {
                  ...
                  if (jO(t)) {
                    var i = zO(t);
                    return !0 === i ? KO(e).get(t) : i ? i[e.id] : void 0;
                  }
                },
                set: function (t, e) {
                  return a(this, t, e);
  ...
  yC = {},
  mC = {},
  bC = !tC.ActiveXObject && "ActiveXObject" in tC,
  wC = function (t) {
    return function () {
      return t(this, arguments.length ? arguments[0] : void 0);
    };
...
if (dC)
  if (bC) {
    (ZO = rC.getConstructor(wC, "WeakMap", !0)), oC.enable();
    var EC = eC(_C.delete),
      OC = eC(_C.has),
      CC = eC(_C.get);
    iC(_C, {
      delete: function (t) {
        if (sC(t) && !uC(t)) {
          var e = aC(this);
          return (
            e.frozen || (e.frozen = new ZO()), EC(this, t) || e.frozen.delete(t)
          );
        }
        return EC(this, t);
      },
      has: function (t) {
        if (sC(t) && !uC(t)) {
          var e = aC(this);
          return (
            e.frozen || (e.frozen = new ZO()), OC(this, t) || e.frozen.has(t)
          );
        }
        return OC(this, t);
      },
      get: function (t) {
        if (sC(t) && !uC(t)) {
          var e = aC(this);
          return (
            e.frozen || (e.frozen = new ZO()),
            OC(this, t) ? CC(this, t) : e.frozen.get(t)
          );
        }
        return CC(this, t);
      },
      set: function (t, e) {
        if (sC(t) && !uC(t)) {
          var i = aC(this);
          i.frozen || (i.frozen = new ZO()),
            OC(this, t) ? xC(this, t, e) : i.frozen.set(t, e);
        } else xC(this, t, e);
        return this;
      },
    });
    ...
    JO &&
      hC(function () {
        var t = vC([]);
        return xC(new kC(), t, 1), !fC(t);
      }) &&
      iC(_C, {
        set: function (t, e) {
          var i;
          return (
            cC(t) && (fC(t) ? (i = yC) : pC(t) && (i = mC)),
            xC(this, t, e),
            i === yC && vC(t),
            i === mC && gC(t),
            this
...
var RC = (function () {
  function t() {
    vh(this, t), SC.set(this, new DO()), TC.set(this, new DO());
  }
  return (
    wu(t, [
      {
      ...
      },
      {
        ...
        value: function () {
          return {
            added: lf(AC(BC(this, SC, "f"), BC(this, TC, "f"))),
            deleted: lf(AC(BC(this, TC, "f"), BC(this, SC, "f"))),
            previous: lf(new DO(BC(this, SC, "f"))),
            current: lf(new DO(BC(this, TC, "f"))),
          };
        },
      },
      {
        ...
        value: function () {
          ...
          FC(this, SC, BC(this, TC, "f"), "f"),
            FC(this, TC, new DO(BC(this, SC, "f")), "f");
          var e,
            i = zC(t.added);
          try {
            for (i.s(); !(e = i.n()).done; ) {
    ...
    wu(t, [
      {
        key: "sizeNodes",
        get: function () {
          return BC(this, MC, "f").size;
        },
      },
      {
        key: "sizeEdges",
        get: function () {
          return BC(this, PC, "f").size;
        },
      },
      {
        key: "getNodes",
        value: function () {
          return BC(this, MC, "f").getSelection();
        },
      },
      {
        key: "getEdges",
        value: function () {
          return BC(this, PC, "f").getSelection();
        },
      },
      {
        key: "addNodes",
        value: function () {
          var t;
          (t = BC(this, MC, "f")).add.apply(t, arguments);
        },
      },
      {
        key: "addEdges",
        value: function () {
          var t;
          (t = BC(this, PC, "f")).add.apply(t, arguments);
        },
      },
      {
        key: "deleteNodes",
        value: function (t) {
          BC(this, MC, "f").delete(t);
        },
      },
      {
        key: "deleteEdges",
        value: function (t) {
          BC(this, PC, "f").delete(t);
        },
      },
      {
        key: "clear",
        value: function () {
          BC(this, MC, "f").clear(), BC(this, PC, "f").clear();
        },
      },
      {
        key: "commit",
        value: function () {
          for (
            var t,
              e,
              i = {
                nodes: BC(this, MC, "f").commit(),
                edges: BC(this, PC, "f").commit(),
              },
              o = arguments.length,
              n = new Array(o),
              r = 0;
            ...
            n[r] = arguments[r];
          return (
            (t = BC(this, IC, "f")).call.apply(
              t,
              yf((e = [this, i])).call(e, n)
            ),
            i
          );
        },
...
var WC = (function () {
    function t(e, i) {
      ...
      vh(this, t),
        (this.body = e),
        (this.canvas = i),
        (this._selectionAccumulator = new jC()),
    ...
    return (
      wu(t, [
          ...
          value: function (t) {
            ...
            if (void 0 !== t) {
              if (t instanceof eE) {
                var i;
                if (!0 === e)
                  (i = this._selectionAccumulator).addEdges.apply(
                    i,
                    lf(t.edges)
                  );
        ...
        },
        {
          ...
          value: function (t, e) {
            for (
              var i = this.body.edges, o = 0;
              o < this.body.edgeIndices.length;
              o++
            ) {
            ...
            for (var r in this.hoverObj.edges)
              Object.prototype.hasOwnProperty.call(this.hoverObj.edges, r) &&
                (!0 === o
                  ...
                  : (void 0 === i ||
                      (i instanceof QE && i.id != r) ||
                      (i instanceof eE && !i.hover)) &&
                    (this.emitBlurEvent(t, e, this.hoverObj.edges[r]),
                    delete this.hoverObj.edges[r],
                    (o = !0)));
            if (void 0 !== i) {
              var s = zf(this.hoverObj.edges).length,
                a = zf(this.hoverObj.nodes).length;
              (o ||
                (i instanceof QE && 0 === s && 0 === a) ||
                (i instanceof eE && 0 === s && 0 === a)) &&
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            o.edges.deleted.length > 0 &&
              (this.generateClickEvent("deselectEdge", e, t, n), (i = !0)),
              o.nodes.deleted.length > 0 &&
                (this.generateClickEvent("deselectNode", e, t, n), (i = !0)),
              o.nodes.added.length > 0 &&
                (this.generateClickEvent("selectNode", e, t), (i = !0)),
              o.edges.added.length > 0 &&
        ...
        },
        {
          ...
          value: function () {
            var t;
            return Df((t = this._selectionAccumulator.getNodes())).call(
              t,
              function (t) {
                return t.id;
              }
        ...
        },
        {
          ...
          value: function () {
            var t;
            return Df((t = this._selectionAccumulator.getEdges())).call(
              t,
              function (t) {
                return t.id;
              }
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              ((e.unselectAll || void 0 === e.unselectAll) &&
                this.unselectAll(),
              t.nodes)
            ) {
              var i,
              ...
              try {
                for (o.s(); !(i = o.n()).done; ) {
                  var n = i.value,
                    r = this.body.nodes[n];
                  if (!r)
                    throw new RangeError('Node with id "' + n + '" not found');
  ...
  UC = function (t, e) {
    var i = t.length,
      o = qC(i / 2);
    return i < 8 ? YC(t, e) : XC(t, UC(VC(t, 0, o), e), UC(VC(t, o), e), e);
  },
  YC = function (t, e) {
  ...
  XC = function (t, e, i, o) {
    for (var n = e.length, r = i.length, s = 0, a = 0; s < n || a < r; )
      t[s + a] =
        s < n && a < r
          ? o(e[s], i[a]) <= 0
            ? e[s++]
  ...
  KC = UC,
  GC = dt.match(/firefox\/(\d+)/i),
  $C = !!GC && +GC[1],
  ZC = /MSIE|Trident/.test(dt),
  QC = dt.match(/AppleWebKit\/(\d+)\./),
  JC = !!QC && +QC[1],
  tS = Mi,
  eS = y,
  iS = Dt,
  ...
  wS = !aS(function () {
    ...
    if (!(lS && lS > 3)) {
      ...
      for (t = 65; t < 76; t++) {
        ...
        for (o = 0; o < 47; o++) pS.push({ k: e + o, v: i });
      }
      for (
        pS.sort(function (t, e) {
          return e.v - t.v;
        }),
          o = 0;
        o < pS.length;
        ...
        (e = pS[o].k.charAt(0)), n.charAt(n.length - 1) !== e && (n += e);
      return "DGBEFHACIJK" !== n;
    }
  });
tS(
  { target: "Array", proto: !0, forced: yS || !mS || !bS || !wS },
  {
    sort: function (t) {
      void 0 !== t && iS(t);
      var e = oS(this);
      if (wS) return void 0 === t ? vS(e) : vS(e, t);
      var i,
        o,
        n = [],
        r = nS(e);
      for (o = 0; o < r; o++) o in e && gS(n, e[o]);
      for (
        hS(
          n,
          (function (t) {
...
var kS = zo("Array").sort,
  _S = ht,
  xS = kS,
  ES = Array.prototype,
  OS = function (t) {
    var e = t.sort;
    return t === ES || (_S(ES, t) && e === ES.sort) ? xS : e;
  },
  CS = o(OS),
  SS = Dt,
  TS = $t,
    ...
    return function (e, i, o, n) {
      ...
      if (o < 2)
        for (;;) {
          ...
          if (((h += d), t ? h < 0 : a <= h))
            throw new IS("Reduce of empty array with no initial value");
        }
      for (; t ? h >= 0 : a > h; h += d) h in s && (n = i(n, s[h], h, r));
      return n;
    };
  },
  BS = { left: DS(!1), right: DS(!0) },
  FS = "process" === k(r.process),
  zS = BS.left;
Mi(
  {
    target: "Array",
    proto: !0,
    forced: (!FS && gt > 79 && gt < 83) || !Hf("reduce"),
  },
  {
    reduce: function (t) {
      var e = arguments.length;
      return zS(this, t, e, e > 1 ? arguments[1] : void 0);
    },
  }
);
var NS = zo("Array").reduce,
  AS = ht,
  RS = NS,
  jS = Array.prototype,
  LS = function (t) {
    var e = t.reduce;
    return t === jS || (AS(jS, t) && e === jS.reduce) ? RS : e;
  },
  HS = o(LS);
function WS(t) {
  var e = (function () {
...
var VS = (function () {
  ...
  YS = zd.every;
Mi(
  { target: "Array", proto: !0, forced: !Hf("every") },
  {
    every: function (t) {
...
var XS = zo("Array").every,
  KS = ht,
  GS = XS,
  $S = Array.prototype,
  ZS = function (t) {
    var e = t.every;
    return t === $S || (KS($S, t) && e === $S.every) ? GS : e;
  },
  QS = o(ZS);
function JS(t, e) {
  var i = (void 0 !== cf && ph(t)) || t["@@iterator"];
        ...
        for (
          var u,
            ...
            g = function () {
              ...
              if (
                (Qf(
                  (t = lv((n = u.edges)).call(n, function (t) {
                    return (
                      t.connected &&
                      t.to !== t.from &&
                      t[i] !== u &&
          ...
          value: function (t) {
            ...
            return (function t(o) {
              ...
              if (e.childrenReference[o]) {
                ...
                if (r.length > 0)
                  for (var s = 0; s < r.length; s++) n = Math.max(n, t(r[s]));
              }
              return (i[o] = n), n;
            })(t);
          },
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            for (var n = 0; n < i.length; n++)
              for (var r = 0; r < o.length; r++) if (i[n] == o[r]) return !0;
            return !1;
          },
        },
        {
    ...
    return (
      wu(t, [
          ...
          value: function (t, e) {
            if (void 0 !== t) {
              ...
              if (
                ...
                Zm(this.options, t, "hierarchical"),
              ...
              if (!0 === o)
                return (
                  this.body.emitter.emit("refresh"), Am(e, this.optionsBackup)
                );
            }
            return e;
          },
        },
        {
          ...
          value: function (t) {
            (this.initialRandomSeed = t),
              (this._rng = xm(this.initialRandomSeed));
          },
        },
        {
                ...
                void 0 !== o.type && "dynamic" !== o.type && (i = o.type),
                  (this.optionsBackup.edges = {
                    smooth: {
                      ...
                      forceDirection:
                        void 0 !== o.forceDirection && o.forceDirection,
                    },
                  }),
                  (t.edges.smooth = {
                    enabled: void 0 === o.enabled || o.enabled,
              ...
              if (e < 0.5 * t.length) {
                ...
                for (var h = 0; h < t.length; h++) {
                  ...
                  !1 === d.predefinedPosition &&
                    ((d.x += 70 * (0.5 - this._rng())),
                    (d.y += 70 * (0.5 - this._rng())));
                }
                this._declusterAll(),
        ...
        },
        {
          ...
          value: function () {
            for (
              var t = yO.getRangeCore(this.body.nodes, this.body.nodeIndices),
                e = yO.findCenter(t),
                i = 0;
            ...
            if (
              ...
              if (!0 === o) {
                ...
                "hubsize" === n
                  ...
                  : "custom" === n && this._determineLevelsCustomCallback();
              }
              for (var r in this.body.nodes)
                Object.prototype.hasOwnProperty.call(this.body.nodes, r) &&
          ...
          value: function () {
            var t = this,
              ...
              r = function e(i, o) {
                if (
                  !o[i.id] &&
                  ((o[i.id] = !0), t.hierarchical.childrenReference[i.id])
                ) {
                  var n = t.hierarchical.childrenReference[i.id];
                  if (n.length > 0)
                    for (var r = 0; r < n.length; r++) e(t.body.nodes[n[r]], o);
                }
              },
              s = function (e) {
                var i =
                ...
                for (var a in e)
                  if (Object.prototype.hasOwnProperty.call(e, a)) {
                    var h = t.body.nodes[a],
                      ...
                      c = df(t._getSpaceAroundNode(h, e), 2),
                      u = c[0],
                      f = c[1];
                    (o = Math.min(u, o)),
                      (n = Math.min(f, n)),
              ...
              h = function (i, o) {
                var n =
                  ...
                  h = t.direction.getPosition(o),
                  d = Math.abs(h - a),
                  l = t.options.hierarchical.nodeSpacing;
                if (d > l) {
                  var c = {},
                    u = {};
                  r(i, c), r(o, u);
                  ...
                  if (Math.abs(g - y) > l) {
                    ...
                    b < -m + l && (b = -m + l),
                      b < 0 &&
                        (t._shiftBlock(o.id, b),
                        (e = !0),
                        !0 === n && t._centerParent(o));
                  }
                }
              },
              d = function (o, n) {
                ...
                var g = function (e, i) {
                  ...
                  m = function (e, i) {
                    for (
                      var o = t.direction.getPosition(n), r = {}, s = 0;
                      s < e;
                      s++
                    ) {
                      var a = g(o, i),
                      ...
                      if (
                        void 0 !==
                        r[(o -= Math.max(-40, Math.min(40, Math.round(a / h))))]
                      )
                        break;
                      r[o] = s;
                    }
                ...
                !(function (o) {
                  ...
                  (function (i) {
                    var o = t.direction.getPosition(n),
                      r = df(t._getSpaceAroundNode(n), 2),
                      s = r[0],
                      a = r[1],
                      h = i - o,
                      d = o;
                    h > 0
                      ? (d = Math.min(
                          o + (a - t.options.hierarchical.nodeSpacing),
                          i
                        ))
                      : h < 0 &&
                        (d = Math.max(
                          o - (s - t.options.hierarchical.nodeSpacing),
                          i
                        )),
                      d !== o && (t.direction.setPosition(n, d), (e = !0));
                  })((b = m(o, h)));
              };
              ...
              !0 === this.options.hierarchical.parentCentralization &&
                (function () {
                  ...
                  for (var i = 0; i < e.length; i++)
                    for (
                      var o = e[i],
                        n = t.hierarchical.distributionOrdering[o],
                        r = 0;
                      r < n.length;
                      r++
                    )
            ...
            if (void 0 !== o) {
              ...
              if (0 !== n) {
                ...
                if ((!0 === i && void 0 === e[d.id]) || !1 === i)
                  a = r - this.direction.getPosition(d);
              }
              if (n != s.length - 1) {
                var l = s[n + 1];
              ...
              for (
                ...
                if (void 0 !== r) {
                  var s = this._getCenterPosition(r),
                    ...
                    h = df(this._getSpaceAroundNode(n), 2),
                    d = h[0],
                    l = h[1],
                    c = a - s;
                  ((c < 0 &&
                    Math.abs(c) < l - this.options.hierarchical.nodeSpacing) ||
                    (c > 0 &&
                      Math.abs(c) <
                        d - this.options.hierarchical.nodeSpacing)) &&
                    this.direction.setPosition(n, s);
                }
              }
          },
        },
          ...
          value: function (t, e) {
            ...
            if (void 0 !== o) {
              for (var n = [], r = 0; r < o.length; r++)
                n.push(this.body.nodes[o[r]]);
              CS((i = this.direction)).call(i, n);
          ...
          value: function (t, e, i) {
            if (this.hierarchical.isTree) {
              if (void 0 !== this.lastNodeOnLevel[e]) {
                var o = this.direction.getPosition(
        ...
        },
        {
          ...
          value: function () {
            var t = this,
              e = {};
            Lm(this.body.nodeIndices, function (i) {
            ...
            for (
              var t = this,
                ...
                o = function () {
                  var o = i[n];
                  if (0 === o) return 1;
                  Lm(t.body.nodeIndices, function (i) {
        ...
        },
        {
          ...
          value: function () {
            ...
            this._crawlNetwork(function (e, i, o) {
              ...
              var r =
                (yO.cloneOptions(e, "node"),
                yO.cloneOptions(i, "node"),
                void yO.cloneOptions(o, "edge"));
        ...
        },
        {
          ...
          value: function () {
            var t,
              e = this,
              i = HS((t = this.body.nodeIndices)).call(
                t,
                function (t, i) {
              ...
              ? (this.hierarchical.levels = (function (t) {
                  return iT(
                    function (e) {
                      var i, o;
                      return QS(
                        (i = lv((o = e.edges)).call(o, function (e) {
                          return t.has(e.toId);
                        }))
                      ).call(i, function (t) {
                        return t.from === e;
              ...
              n = function i(n, r) {
                if (void 0 === o[n.id]) {
                  ...
                  for (var a = t._getActiveEdges(n), h = 0; h < a.length; h++) {
                    var d = a[h];
                    !0 === d.connected &&
                      ((s = d.toId == n.id ? d.from : d.to),
                      n.id != s.id && (e(n, s, d), i(s, r)));
                  }
                }
              };
            if (void 0 === i)
              ...
              (function t(e, o) {
                ...
                if (void 0 !== n)
                  for (var r = 0; r < n.length; r++) {
                    var s = n[r];
                    if (void 0 !== e[s])
                      return { foundParent: s, withChild: o };
                    var a = t(e, s);
        ...
        },
        {
          ...
          value: function () {
            ...
            this.direction = t ? new qS(this) : new US(this);
          },
        },
        {
...
var aT = (function () {
    function t(e, i, o, n) {
      ...
      vh(this, t),
        ...
        this.body.emitter.on(
          "_dataChanged",
          Wo((r = this._restore)).call(r, this)
        ),
        this.body.emitter.on(
          "_resetData",
          Wo((s = this._restore)).call(s, this)
        );
    }
    return (
      wu(t, [
            ...
            void 0 !== e &&
              ...
              void 0 !== t &&
                ("boolean" == typeof t
                  ...
                  : ((this.options.enabled = !0), Am(this.options, t)),
            ...
            if (
              ...
              !1 !== this.options.addNode &&
                ...
                this._bindElementEvents(
                  this.closeDiv,
                  Wo((t = this.toggleEditMode)).call(t, this)
                ),
                this._temporaryBindEvent(
                  "select",
                  Wo((e = this.showManipulatorToolbar)).call(e, this)
                );
            }
            this.body.emitter.emit("_redraw");
          },
          ...
          value: function () {
            ...
            if (
              ...
              (this.manipulationDOM = {}),
                ...
                this._bindElementEvents(
                  this.closeDiv,
                  Wo((e = this.toggleEditMode)).call(e, this)
                );
            }
            this._temporaryBindEvent(
              "click",
              Wo((t = this._performAddNode)).call(t, this)
            );
          },
        },
        {
          ...
          value: function () {
            ...
            if (
              ...
              (this.manipulationDOM = {}),
                ...
                this._bindElementEvents(
                  this.closeDiv,
                  Wo((r = this.toggleEditMode)).call(r, this)
                );
            }
            this._temporaryBindUI(
              "onTouch",
              Wo((t = this._handleConnect)).call(t, this)
            ),
              this._temporaryBindUI(
                "onDragEnd",
                Wo((e = this._finishConnect)).call(e, this)
              ),
              this._temporaryBindUI(
                "onDrag",
                Wo((i = this._dragControlNode)).call(i, this)
              ),
              this._temporaryBindUI(
                "onRelease",
                Wo((o = this._finishConnect)).call(o, this)
              ),
              this._temporaryBindUI(
                "onDragStart",
                Wo((n = this._dragStartEdge)).call(n, this)
              ),
        ...
        },
        {
          ...
          value: function () {
            if (
              ...
              "object" !== gu(this.options.editEdge) ||
              ...
              if (
                ...
                this.temporaryIds.nodes.push(a.id),
                  ...
                  this._temporaryBindUI(
                    "onTouch",
                    Wo((i = this._controlNodeTouch)).call(i, this)
                  ),
                  this._temporaryBindUI("onTap", function () {}),
                  this._temporaryBindUI("onHold", function () {}),
                  this._temporaryBindUI(
                    "onDragStart",
                    Wo((o = this._controlNodeDragStart)).call(o, this)
                  ),
                  this._temporaryBindUI(
                    "onDrag",
                    Wo((n = this._controlNodeDrag)).call(n, this)
                  ),
                  this._temporaryBindUI(
                    "onDragEnd",
                    Wo((r = this._controlNodeDragEnd)).call(r, this)
                  ),
        ...
        },
        {
          ...
          value: function () {
            ...
            if (e.length > 0) {
              for (var n = 0; n < e.length; n++)
                if (!0 === this.body.nodes[e[n]].isCluster)
                  return void alert(
              ...
              "function" == typeof this.options.deleteNode &&
                (o = this.options.deleteNode);
            } else
              i.length > 0 &&
                "function" == typeof this.options.deleteEdge &&
                (o = this.options.deleteEdge);
        ...
        },
        {
          ...
          value: function (t, e) {
            var i = Am({}, this.options.controlNodeStyle);
            (i.id = "targetNode" + gO()),
              (i.hidden = !1),
              (i.physics = !1),
              (i.x = t),
            ...
            return (
              (o.shape.boundingBox = { left: t, right: t, top: e, bottom: e }),
              o
            );
          },
        },
        {
          ...
          value: function () {
            var t;
            this._clean(), (this.manipulationDOM = {}), Pm(this.editModeDiv);
        ...
        },
        {
          ...
          value: function () {
            var t,
              e,
              i = rT(Pp((t = this._domEventListenerCleanupQueue)).call(t, 0));
            try {
              for (i.s(); !(e = i.n()).done; ) {
                (0, e.value)();
              }
        ...
        },
        {
          ...
          value: function (t) {
            ...
            this.manipulationDiv.appendChild(i),
              this._bindElementEvents(
                i,
                Wo((e = this.addNodeMode)).call(e, this)
              );
          },
        },
        {
          ...
          value: function (t) {
            ...
            this.manipulationDiv.appendChild(i),
              this._bindElementEvents(
                i,
                Wo((e = this.addEdgeMode)).call(e, this)
              );
          },
        },
        {
          ...
          value: function (t) {
            ...
            this.manipulationDiv.appendChild(i),
              this._bindElementEvents(i, Wo((e = this.editNode)).call(e, this));
          },
        },
        {
          ...
          value: function (t) {
            ...
            this.manipulationDiv.appendChild(i),
              this._bindElementEvents(
                i,
                Wo((e = this.editEdgeMode)).call(e, this)
              );
          },
        },
        {
          ...
          value: function (t) {
            ...
            this.manipulationDiv.appendChild(o),
              this._bindElementEvents(
                o,
                Wo((e = this.deleteSelected)).call(e, this)
              );
          },
        },
        {
            ...
            if (void 0 === this.body.eventListeners[t])
              throw new Error(
                "This UI function does not exist. Typo? You tried: " +
                  t +
                  " possible are: " +
                  Gv(zf(this.body.eventListeners))
              );
        ...
        },
        {
          ...
          value: function () {
            for (var t = 0; t < this.temporaryIds.edges.length; t++) {
              ...
              var i,
                o = Vv((e = this.body.edgeIndices)).call(
                  e,
            ...
            for (var n = 0; n < this.temporaryIds.nodes.length; n++) {
              ...
              var s,
                a = Vv((r = this.body.nodeIndices)).call(
                  r,
                  this.temporaryIds.nodes[n]
                );
        ...
        },
        {
          ...
          value: function (t) {
            this.selectionHandler.unselectAll(),
              ...
              (this.lastTouch.translation = wo({}, this.body.view.translation));
          },
        },
        {
          ...
          value: function () {
            ...
            !0 === r
              ...
              : !0 === s &&
                ((this.selectedControlNode = o), (n.edgeType.to = o)),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (void 0 !== this.selectedControlNode) {
              this.selectionHandler.unselectAll();
              for (
                var n = this.selectionHandler._getAllNodesOverlappingWith(i),
                  r = void 0,
                  s = n.length - 1;
                s >= 0;
                s--
              )
                if (n[s] !== this.selectedControlNode.id) {
              ...
              if (void 0 !== r && void 0 !== this.selectedControlNode)
                if (!0 === r.isCluster)
                  ...
                  this.selectedControlNode.id === a.id
                    ? this._performEditEdge(r.id, o.to.id)
                    : this._performEditEdge(o.from.id, r.id);
                }
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (
              ("object" === gu(n) && (n = n.editWithoutDrag),
              "function" == typeof n)
            ) {
              if (2 !== n.length)
                throw new Error(
              ...
              n(o, function (t) {
                null == t || "editEdge" !== i.inMode
                  ? (i.body.edges[o.id].updateEdgeType(),
  ...
  pT = {
    borderWidth: { number: lT },
    borderWidthSelected: { number: lT, undefined: "undefined" },
    brokenImage: { string: hT, undefined: "undefined" },
    chosen: {
      label: { boolean: dT, function: "function" },
      node: { boolean: dT, function: "function" },
      __type__: { object: uT, boolean: dT },
    },
    color: {
      border: { string: hT },
    ...
    opacity: { number: lT, undefined: "undefined" },
    fixed: {
      x: { boolean: dT },
      y: { boolean: dT },
      __type__: { object: uT, boolean: dT },
    ...
    font: {
      ...
      face: { string: hT },
      background: { string: hT },
      strokeWidth: { number: lT },
      strokeColor: { string: hT },
      vadjust: { number: lT },
      multi: { boolean: dT, string: hT },
      bold: {
        color: { string: hT },
        size: { number: lT },
        face: { string: hT },
    ...
    group: { string: hT, number: lT, undefined: "undefined" },
    heightConstraint: {
      minimum: { number: lT },
      valign: { string: hT },
      __type__: { object: uT, boolean: dT, number: lT },
    },
    hidden: { boolean: dT },
    icon: {
      face: { string: hT },
      ...
      size: { number: lT },
      color: { string: hT },
      weight: { string: hT, number: lT },
      __type__: { object: uT },
    },
    id: { string: hT, number: lT },
    image: {
      selected: { string: hT, undefined: "undefined" },
      unselected: { string: hT, undefined: "undefined" },
      __type__: { object: uT, string: hT },
    },
    imagePadding: {
      top: { number: lT },
      ...
      bottom: { number: lT },
      left: { number: lT },
      __type__: { object: uT, number: lT },
    },
    label: { string: hT, undefined: "undefined" },
    labelHighlightBold: { boolean: dT },
    level: { number: lT, undefined: "undefined" },
    margin: {
      top: { number: lT },
      right: { number: lT },
      bottom: { number: lT },
    ...
    scaling: {
      ...
      label: {
        ...
        min: { number: lT },
        max: { number: lT },
        maxVisible: { number: lT },
        drawThreshold: { number: lT },
        __type__: { object: uT, boolean: dT },
      },
    ...
    shapeProperties: {
      borderDashes: { boolean: dT, array: cT },
      borderRadius: { number: lT },
      interpolation: { boolean: dT },
      useImageSize: { boolean: dT },
      useBorderWithImage: { boolean: dT },
      coordinateOrigin: { string: ["center", "top-left"] },
      __type__: { object: uT },
    },
    size: { number: lT },
    title: { string: hT, dom: "dom", undefined: "undefined" },
    value: { number: lT, undefined: "undefined" },
    widthConstraint: {
      minimum: { number: lT },
      maximum: { number: lT },
      __type__: { object: uT, boolean: dT, number: lT },
  ...
  vT = {
    configure: {
      enabled: { boolean: dT },
      filter: { boolean: dT, string: hT, array: cT, function: "function" },
      container: { dom: "dom" },
      showButton: { boolean: dT },
      __type__: {
        object: uT,
        boolean: dT,
        string: hT,
    ...
    edges: {
      arrows: {
        to: {
          enabled: { boolean: dT },
          scaleFactor: { number: lT },
          type: { string: fT },
          imageHeight: { number: lT },
          imageWidth: { number: lT },
          src: { string: hT },
          __type__: { object: uT, boolean: dT },
        },
        middle: {
        ...
        __type__: { string: ["from", "to", "middle"], object: uT },
      },
      endPointOffset: {
        from: { number: lT },
        to: { number: lT },
      ...
      arrowStrikethrough: { boolean: dT },
      background: {
        enabled: { boolean: dT },
        color: { string: hT },
        size: { number: lT },
        dashes: { boolean: dT, array: cT },
        __type__: { object: uT, boolean: dT },
      },
      chosen: {
        label: { boolean: dT, function: "function" },
        edge: { boolean: dT, function: "function" },
        __type__: { object: uT, boolean: dT },
      },
      color: {
        color: { string: hT },
        highlight: { string: hT },
        hover: { string: hT },
        inherit: { string: ["from", "to", "both"], boolean: dT },
        opacity: { number: lT },
        __type__: { object: uT, string: hT },
      },
      dashes: { boolean: dT, array: cT },
      ...
      hidden: { boolean: dT },
      hoverWidth: { function: "function", number: lT },
      label: { string: hT, undefined: "undefined" },
      labelHighlightBold: { boolean: dT },
      length: { number: lT, undefined: "undefined" },
      physics: { boolean: dT },
      scaling: {
        min: { number: lT },
        max: { number: lT },
      ...
      selectionWidth: { function: "function", number: lT },
      selfReferenceSize: { number: lT },
      selfReference: {
        size: { number: lT },
        angle: { number: lT },
        renderBehindTheNode: { boolean: dT },
        __type__: { object: uT },
      },
      shadow: {
        enabled: { boolean: dT },
      ...
      title: { string: hT, undefined: "undefined" },
      width: { number: lT },
      widthConstraint: {
        maximum: { number: lT },
        __type__: { object: uT, boolean: dT, number: lT },
    ...
    groups: {
      useDefaultGroups: { boolean: dT },
      __any__: pT,
      __type__: { object: uT },
    },
    interaction: {
      dragNodes: { boolean: dT },
      dragView: { boolean: dT },
      hideEdgesOnDrag: { boolean: dT },
      hideEdgesOnZoom: { boolean: dT },
      hideNodesOnDrag: { boolean: dT },
      hover: { boolean: dT },
      keyboard: {
        enabled: { boolean: dT },
        speed: {
        ...
        bindToWindow: { boolean: dT },
        autoFocus: { boolean: dT },
        __type__: { object: uT, boolean: dT },
      },
      multiselect: { boolean: dT },
      navigationButtons: { boolean: dT },
      selectable: { boolean: dT },
      selectConnectedEdges: { boolean: dT },
      hoverConnectedEdges: { boolean: dT },
      tooltipDelay: { number: lT },
      zoomView: { boolean: dT },
      zoomSpeed: { number: lT },
      __type__: { object: uT },
    },
    layout: {
      randomSeed: { undefined: "undefined", number: lT, string: hT },
      improvedLayout: { boolean: dT },
      clusterThreshold: { number: lT },
      hierarchical: {
        enabled: { boolean: dT },
        levelSeparation: { number: lT },
        nodeSpacing: { number: lT },
        treeSpacing: { number: lT },
        blockShifting: { boolean: dT },
        edgeMinimization: { boolean: dT },
        parentCentralization: { boolean: dT },
    ...
    manipulation: {
      enabled: { boolean: dT },
      initiallyActive: { boolean: dT },
      addNode: { boolean: dT, function: "function" },
      addEdge: { boolean: dT, function: "function" },
      editNode: { function: "function" },
      editEdge: {
        editWithoutDrag: { function: "function" },
        __type__: { object: uT, boolean: dT, function: "function" },
      },
      deleteNode: { boolean: dT, function: "function" },
      deleteEdge: { boolean: dT, function: "function" },
      controlNodeStyle: pT,
      __type__: { object: uT, boolean: dT },
    },
    nodes: pT,
    physics: {
      ...
      barnesHut: {
        theta: { number: lT },
        gravitationalConstant: { number: lT },
        centralGravity: { number: lT },
        springLength: { number: lT },
        springConstant: { number: lT },
        damping: { number: lT },
        avoidOverlap: { number: lT },
        __type__: { object: uT },
      },
      forceAtlas2Based: {
        theta: { number: lT },
      ...
      maxVelocity: { number: lT },
      minVelocity: { number: lT },
      solver: {
        string: [
          "barnesHut",
          "repulsion",
      ...
      stabilization: {
        enabled: { boolean: dT },
        iterations: { number: lT },
        updateInterval: { number: lT },
        onlyDynamicEdges: { boolean: dT },
        fit: { boolean: dT },
        __type__: { object: uT, boolean: dT },
      },
      timestep: { number: lT },
      adaptiveTimestep: { boolean: dT },
      wind: { x: { number: lT }, y: { number: lT }, __type__: { object: uT } },
      __type__: { object: uT, boolean: dT },
    },
    autoResize: { boolean: dT },
    clickToUse: { boolean: dT },
    locale: { string: hT },
    locales: { __any__: { any: "any" }, __type__: { object: uT } },
    height: { string: hT },
    width: { string: hT },
    __type__: { object: uT },
  },
  ...
  yT = function (t, e, i) {
    ...
    return !(
      !Qp(t).call(t, "physics") ||
      !Qp((o = gT.physics.solver)).call(o, e) ||
      i.physics.solver === e ||
      "wind" === e
    );
  },
          ...
          value: function (t, e, i) {
            ...
            for (var h = 0; h < i.length; h++) {
              ...
              !0 === d.connected &&
                void 0 !== o[d.fromId] &&
                void 0 !== o[d.toId] &&
                ((o[d.fromId][d.toId] = 1), (o[d.toId][d.fromId] = 1));
            }
            for (var l = e.length, c = 0; c < l; c++)
              for (var u = e[c], f = o[u], p = 0; p < l - 1; p++)
                for (var v = e[p], g = o[v], y = p + 1; y < l; y++) {
                  var m = e[y],
                    b = o[m],
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            for (
              ...
              for (
                a = u[0], s = u[1], h = u[2], d = u[3], l = s, c = 0;
                l > 1 && c < 5;
            ...
            for (
              ...
              if (f !== t) {
                var p = n[f].x,
                  ...
                  y = c[f],
                  m =
                    1 / Math.pow(Math.pow(h - p, 2) + Math.pow(d - v, 2), 1.5);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            for (var o = 0; o < e.length; o++) {
              this.L_matrix[e[o]] = {};
              for (var n = 0; n < e.length; n++)
                this.L_matrix[e[o]][e[n]] = i * t[e[o]][e[n]];
            }
          },
        },
        {
          ...
          value: function (t) {
            ...
            for (var o = 0; o < e.length; o++) {
              this.K_matrix[e[o]] = {};
              for (var n = 0; n < e.length; n++)
                this.K_matrix[e[o]][e[n]] = i * Math.pow(t[e[o]][e[n]], -2);
            }
          },
        },
        {
          ...
          value: function () {
            ...
            for (var o = 0; o < t.length; o++) {
              for (
                var n = t[o], r = e[n].x, s = e[n].y, a = 0, h = 0, d = o;
                d < t.length;
                d++
              ) {
                var l = t[d];
                if (l !== n) {
                  ...
                  (this.E_matrix[n][d] = [
                    this.K_matrix[n][l] *
                      (r - c - this.L_matrix[n][l] * (r - c) * f),
                    this.K_matrix[n][l] *
                      (s - u - this.L_matrix[n][l] * (s - u) * f),
                  ]),
...
function kT(t, e, i) {
  ...
  (this.options = {}),
    (this.defaultOptions = { locale: "en", locales: Xb, clickToUse: !1 }),
    wo(this.options, this.defaultOptions),
    (this.body = {
      container: t,
      nodes: {},
    ...
    this.bindEventListeners(),
    (this.images = new Gb(function () {
      return a.body.emitter.emit("_requestRedraw");
    })),
    (this.groups = new xk()),
    (this.canvas = new OO(this.body)),
    (this.selectionHandler = new WC(this.body, this.canvas)),
    (this.interactionHandler = new IO(
      this.body,
      this.canvas,
      this.selectionHandler
    )),
    (this.view = new CO(this.body, this.canvas)),
    (this.renderer = new kO(this.body, this.canvas)),
    (this.physics = new lO(this.body)),
    (this.layoutEngine = new nT(this.body)),
    (this.clustering = new wO(this.body)),
    (this.manipulation = new aT(
      this.body,
      this.canvas,
      this.selectionHandler,
      this.interactionHandler
    )),
    (this.nodesHandler = new nE(
      this.body,
      this.images,
      this.groups,
      this.layoutEngine
    )),
    (this.edgesHandler = new JE(this.body, this.images, this.groups)),
    (this.body.modules.kamadaKawai = new wT(this.body, 150, 0.05)),
...
$o(kT.prototype),
  (kT.prototype.setOptions = function (t) {
    ...
    if ((null === t && (t = void 0), void 0 !== t)) {
      ...
      if (
        (zm(["locale", "locales", "clickToUse"], this.options, t),
        void 0 !== t.locale &&
          (t.locale = (function (t, e) {
            try {
              var i = df(e.split(/[-_ /]/, 2), 2),
                o = i[0],
                n = i[1],
              ...
              if (r && s) {
                ...
                console.warn(
                  yf((a = "Unknown variant ".concat(s, " of language "))).call(
                    a,
                    r,
                    "."
                  )
        ...
        Am(i.nodes, this.nodesHandler.options),
          Am(i.edges, this.edgesHandler.options),
          Am(i.layout, this.layoutEngine.options),
          Am(i.interaction, this.selectionHandler.options),
          Am(i.interaction, this.renderer.options),
          Am(i.interaction, this.interactionHandler.options),
          Am(i.manipulation, this.manipulation.options),
          Am(i.physics, this.physics.options),
          Am(i.global, this.canvas.options),
          Am(i.global, this.options),
          this.configurator.setModuleOptions(i);
      }
      void 0 !== t.clickToUse
        ? !0 === t.clickToUse
          ? void 0 === this.activator &&
            ((this.activator = new db(this.canvas.frame)),
  ...
  (kT.prototype._updateVisibleIndices = function () {
    var t = this.body.nodes,
      e = this.body.edges;
    ...
    for (var o in e)
      if (Object.prototype.hasOwnProperty.call(e, o)) {
        var n = e[o],
          ...
          s = t[n.toId],
          a = void 0 !== r && void 0 !== s;
        !this.clustering._isClusteredEdge(o) &&
          !1 === n.options.hidden &&
          a &&
          !1 === r.options.hidden &&
          !1 === s.options.hidden &&
  ...
  (kT.prototype.bindEventListeners = function () {
    var t = this;
    this.body.emitter.on("_dataChanged", function () {
  ...
  (kT.prototype.setData = function (t) {
    if (
  ...
  (kT.prototype.destroy = function () {
    ...
    Pm(this.body.container);
  }),
  (kT.prototype._updateValueRange = function (t) {
    var e,
      i = void 0,
      o = void 0,
      n = 0;
    for (e in t)
      if (Object.prototype.hasOwnProperty.call(t, e)) {
        ...
        void 0 !== r &&
          ...
          (o = void 0 === o ? r : Math.max(r, o)),
          (n += r));
      }
    if (void 0 !== i && void 0 !== o)
      for (e in t)
        Object.prototype.hasOwnProperty.call(t, e) &&
          t[e].setValueRange(i, o, n);
  }),
  (kT.prototype.isActive = function () {
    return !this.activator || this.activator.active;
  }),
  (kT.prototype.setSize = function () {
    return this.canvas.setSize.apply(this.canvas, arguments);
  }),
  (kT.prototype.canvasToDOM = function () {
    return this.canvas.canvasToDOM.apply(this.canvas, arguments);
  }),
  (kT.prototype.DOMtoCanvas = function () {
    return this.canvas.DOMtoCanvas.apply(this.canvas, arguments);
  }),
  (kT.prototype.findNode = function () {
    return this.clustering.findNode.apply(this.clustering, arguments);
  }),
  (kT.prototype.isCluster = function () {
    return this.clustering.isCluster.apply(this.clustering, arguments);
  }),
  (kT.prototype.openCluster = function () {
    return this.clustering.openCluster.apply(this.clustering, arguments);
  }),
  (kT.prototype.cluster = function () {
    return this.clustering.cluster.apply(this.clustering, arguments);
  }),
  (kT.prototype.getNodesInCluster = function () {
    return this.clustering.getNodesInCluster.apply(this.clustering, arguments);
  }),
  (kT.prototype.clusterByConnection = function () {
    return this.clustering.clusterByConnection.apply(
      this.clustering,
      arguments
    );
  }),
  (kT.prototype.clusterByHubsize = function () {
    return this.clustering.clusterByHubsize.apply(this.clustering, arguments);
  }),
  (kT.prototype.updateClusteredNode = function () {
    return this.clustering.updateClusteredNode.apply(
      this.clustering,
      arguments
    );
  }),
  (kT.prototype.getClusteredEdges = function () {
    return this.clustering.getClusteredEdges.apply(this.clustering, arguments);
  }),
  (kT.prototype.getBaseEdge = function () {
    return this.clustering.getBaseEdge.apply(this.clustering, arguments);
  }),
  (kT.prototype.getBaseEdges = function () {
    return this.clustering.getBaseEdges.apply(this.clustering, arguments);
  }),
  (kT.prototype.updateEdge = function () {
    return this.clustering.updateEdge.apply(this.clustering, arguments);
  }),
  (kT.prototype.clusterOutliers = function () {
    return this.clustering.clusterOutliers.apply(this.clustering, arguments);
  }),
  (kT.prototype.getSeed = function () {
    return this.layoutEngine.getSeed.apply(this.layoutEngine, arguments);
  }),
  (kT.prototype.enableEditMode = function () {
    return this.manipulation.enableEditMode.apply(this.manipulation, arguments);
  }),
  (kT.prototype.disableEditMode = function () {
    return this.manipulation.disableEditMode.apply(
      this.manipulation,
      arguments
    );
  }),
  (kT.prototype.addNodeMode = function () {
    return this.manipulation.addNodeMode.apply(this.manipulation, arguments);
  }),
  (kT.prototype.editNode = function () {
    return this.manipulation.editNode.apply(this.manipulation, arguments);
  }),
  (kT.prototype.editNodeMode = function () {
    return (
  ...
  (kT.prototype.addEdgeMode = function () {
    return this.manipulation.addEdgeMode.apply(this.manipulation, arguments);
  }),
  (kT.prototype.editEdgeMode = function () {
    return this.manipulation.editEdgeMode.apply(this.manipulation, arguments);
  }),
  (kT.prototype.deleteSelected = function () {
    return this.manipulation.deleteSelected.apply(this.manipulation, arguments);
  }),
  (kT.prototype.getPositions = function () {
    return this.nodesHandler.getPositions.apply(this.nodesHandler, arguments);
  }),
  (kT.prototype.getPosition = function () {
    return this.nodesHandler.getPosition.apply(this.nodesHandler, arguments);
  }),
  (kT.prototype.storePositions = function () {
    return this.nodesHandler.storePositions.apply(this.nodesHandler, arguments);
  }),
  (kT.prototype.moveNode = function () {
    return this.nodesHandler.moveNode.apply(this.nodesHandler, arguments);
  }),
  (kT.prototype.getBoundingBox = function () {
    return this.nodesHandler.getBoundingBox.apply(this.nodesHandler, arguments);
  }),
  (kT.prototype.getConnectedNodes = function (t) {
    return void 0 !== this.body.nodes[t]
  ...
  (kT.prototype.getConnectedEdges = function () {
    return this.nodesHandler.getConnectedEdges.apply(
      this.nodesHandler,
      arguments
    );
  }),
  (kT.prototype.startSimulation = function () {
    return this.physics.startSimulation.apply(this.physics, arguments);
  }),
  (kT.prototype.stopSimulation = function () {
    return this.physics.stopSimulation.apply(this.physics, arguments);
  }),
  (kT.prototype.stabilize = function () {
  ...
  (kT.prototype.getEdgeAt = function () {
  ...
  (kT.prototype.selectNodes = function () {
    return this.selectionHandler.selectNodes.apply(
      this.selectionHandler,
      arguments
    );
  }),
  (kT.prototype.selectEdges = function () {
    return this.selectionHandler.selectEdges.apply(
      this.selectionHandler,
      arguments
    );
  }),
  (kT.prototype.unselectAll = function () {
    this.selectionHandler.unselectAll.apply(this.selectionHandler, arguments),
      this.selectionHandler.commitWithoutEmitting.apply(this.selectionHandler),
      this.redraw();
  }),
  (kT.prototype.redraw = function () {
    return this.renderer.redraw.apply(this.renderer, arguments);
  }),
  (kT.prototype.getScale = function () {
    return this.view.getScale.apply(this.view, arguments);
  }),
  (kT.prototype.getViewPosition = function () {
    return this.view.getViewPosition.apply(this.view, arguments);
  }),
  (kT.prototype.fit = function () {
    return this.view.fit.apply(this.view, arguments);
  }),
  (kT.prototype.moveTo = function () {
    return this.view.moveTo.apply(this.view, arguments);
  }),
  (kT.prototype.focus = function () {
    return this.view.focus.apply(this.view, arguments);
  }),
  (kT.prototype.releaseNode = function () {
    return this.view.releaseNode.apply(this.view, arguments);
  }),
  (kT.prototype.getOptionsFromConfigurator = function () {
    var t = {};
    return (
      this.configurator &&
...
export {
  kT as Network,
  Gb as NetworkImages,
  qb as networkDOTParser,
  Yb as networkGephiParser,
  mT as networkOptions,
  _T as parseDOTNetwork,
